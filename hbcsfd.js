...
AdTrack.cfg = {
    "auction": {"timeout": 4000},
    "hb": {"timeout": 1000, "domain": "pomo.csfd.cz"},
    "events": {"enabled": true, "flushTime": 1000, "flushInterval": 2000},
    "keywords": {"url": "https:\/\/kw.r2b2.cz\/keywords"},
    "accounts": {
        "appnexus": 8413,
        "pubmatic": 158361,
        "mgid": 225,
    ...
    "userId": {"enable": true, "loadLib": true},
    "appVersion": "4.123.4",
    "server": {"url": "trackad.cz"}
};/*! For license information please see bundle-hb.2f3865b6fb19065a1a14.js.LICENSE */
!function (t) {
    var e = {};
    ...
    if (Function.prototype.bind || (Function.prototype.bind = function (t) {
    ...
    }), window.AdTrack || (window.AdTrack = {}), window.AdTrack.units || (window.AdTrack.units = {}), window.AdTrack.static || (AdTrack.static = {}), window.AdTrack.JSON || (window.AdTrack.JSON = {
        parse: function (sJSON) {
            ...
            if ("object" == typeof e) {
                if (isArray(e)) {
                    for (var i = "[", n = 0; n < e.length; n++) i += (n ? ", " : "") + t(e[n]);
                    return i + "]"
                }
                if ("function" == typeof e.toJSON) return t(e.toJSON());
                if ("[object Object]" === toString.call(e)) {
                    var r = [];
                    for (var s in e) e.hasOwnProperty(s) && r.push(t(s) + ": " + t(e[s]));
                    return "{" + r.join(", ") + "}"
                }
            }
    ...
    AdTrack.startTime = AdTrack.startTime || (new Date).getTime(), AdTrack.placementQ = window.AdTrack.placementQ || (_units = {}, {
        push: function (t, e) {
        ...
        var i = Array.prototype.slice.call(arguments, 2), n = function () {
    ...
    AdTrack.Utils = AdTrack.Utils || ((s = {}).uri = function (t, e) {
        ...
        var r = null, o = ("adTrackJSONP" + Math.random()).replace(".", "");
        if (t = t + "&" + AdTrack.Utils.uri(e, o)) {
            ...
            c.setAttribute("src", t), r = c, c.onerror = function () {
                d("request-error"), a()
            }, document.getElementsByTagName("head")[0].appendChild(c), n && n > 0 && setTimeout((function () {
                d("request-timeouted")
            }), n)
        }
        ...
        return {
            doError: function (n, r, s) {
                null != s && "undefined" != s || (s = "low"), n = "[V-" + AdTrack.Config.getAppVersion() + "] " + n;
                var o = "//" + t + "/error.php?" + AdTrack.Utils.uri("m", n) + "&" + AdTrack.Utils.uri("s", s) + "&" + AdTrack.Utils.uri("u", e) + (i ? "&" + AdTrack.Utils.uri("p", 1) : "");
                r && "function" == typeof r.getNameForReporting && (o += "&" + AdTrack.Utils.uri("pl", r.getNameForReporting())), AdTrack.Utils.jsonp(o, "callback", (function (t) {
                }))
            }
        }
        ...
        return e && (t = s.replaceMacros(t, e)), t = (t = t.replace(/([0-9])/, "\\3$1 ")).replace(/[\/.:;]/g, (function (t, e, i) {
            return e > 0 && "\\" === i.charAt(e - 1) ? t : "\\" + t
        }))
    }, s.appendCss = function (t, e, i, n) {
        var r = document.createElement("style");
        if (t) {
            n && (e = s.replaceMacros(e, n)), i ? i.addElement(t, r) : t.appendChild(r);
            try {
                r.innerHTML = e
            } catch (t) {
        ...
        var r = e.childNodes;
        r.length > 0 && (s.styleize(r, n), Array.prototype.forEach.call(r, (function (t) {
            s.styleizeAll(t)
        })))
        ...
        Array.prototype.forEach.call(t, (function (t) {
            if ("function" == typeof t.hasAttribute && t.hasAttribute("style")) {
                ...
                if (i) {
                    ...
                    s.cssToStyle(e, "." + n + "{" + i + "}"), s.addClassName(t, n)
                }
        ...
        var e, i, n, r, s, o, a = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", d = 0, c = 0,
            h = "", l = [];
        if (!t) return t;
        do {
            e = 63 & (s = t.charCodeAt(d++) << 16 | t.charCodeAt(d++) << 8 | t.charCodeAt(d++)) >> 18, i = 63 & s >> 12, n = 63 & s >> 6, r = 63 & s, l[c++] = a.charAt(e) + a.charAt(i) + a.charAt(n) + a.charAt(r)
        } while (d < t.length);
        return h = l.join(""), ((o = t.length % 3) ? h.slice(0, o - 3) : h) + "===".slice(o || 3)
    }, s.getDeviceId = function (t) {
        if (t.cookiesEnabled) {
            var e = t.getCookie("hbttv-uuid");
            return e || (e = s.uuid(), t.setCookie("hbttv-uuid", e, 2678400)), e = "" !== e ? e : null
        }
        var i = null;
        if (window.navigator && window.screen) {
            var n = window.navigator, r = window.screen;
            i = n.mimeTypes.length, i += n.userAgent.replace(/\D+/g, ""), i += n.plugins.length, i += r.height || "", i += r.width || "", i += r.pixelDepth || ""
        }
        return AdTrack.Utils.b2a(i)
    }, s.getDGPMKey = function (t) {
        var e = {};
        t.params && !t.params.length && (e = t.params), t.ext && t.ext.dgpm && (e = t.ext.dgpm);
        var i = e.d || "", n = e.g || "", r = e.p || "", s = e.m ? "mobile" : "classic";
        if (i && n && r) return s + "_" + i + "_" + n + "_" + r
        ...
        var o = !1, a = t.bids;
        if (a && a.length > 0) for (var d = 0; d < a.length; d++) if (s.isBidOfPlacement(a[d], e, i, n, r)) {
            o = !0;
            break
        }
        return o
        ...
        var o = !1;
        if (t && t.length > 0) for (var a = 0; a < t.length; a++) if (s.isInPrebidAdUnit(t[a], e, i, n, r)) {
            o = !0;
            break
        }
        return o
        ...
        var t = navigator.language ? "language" : "userLanguage", e = navigator[t].split("-")[0];
        ...
        for (var i = "", n = 0; n < t; n++) i += Math.random().toString(36).substring(3, 4);
        return e ? e + i : i
        ...
        if (void 0 === i) try {
            ...
            e.appendChild(t), i = t.offsetHeight, e.removeChild(t)
        } catch (t) {
        }
        return i > 0 ? i : 96
        ...
        try {
            var e = s.windowTopAccess(), i = t.ownerDocument, n = i.defaultView || i.parentWindow,
            ...
            for (var o, a = {
                ...
                width: r.width,
                height: r.height
            }; n !== e;) o = n.frameElement.getBoundingClientRect(), a.left += o.left, a.right += o.left, a.top += o.top, a.bottom += o.top, a.x += o.left, a.y += o.top, n = n.parent;
            return a
        } catch (t) {
        }
        ...
        if (t && t.clientX && e && "function" == typeof e.getBoundingClientRect) {
            var r = e.getBoundingClientRect(), s = t.clientX, o = t.clientY;
            if (s >= r.left && s <= r.right && o >= r.top && o <= r.bottom) {
                var a = r.right - r.left, d = r.bottom - r.top;
                a && d && (i = (s - r.left) / a, n = (o - r.top) / d)
            }
        }
        return {x: Math.round(1e3 * i), y: Math.round(1e3 * n)}
        ...
        return e = e || !1, t = t.replace(/(https?:\/\/)?(www.)?/i, ""), e || (t = (t = t.split(".")).slice(t.length - 2).join(".")), -1 !== t.indexOf("/") ? t.split("/")[0] : t
        ...
        n.setAttribute("style", i), t.appendChild(n);
        try {
        ...
        var e = "", i = "";
        for (var n in t) t.hasOwnProperty(n) && (e += i + n + "=" + encodeURIComponent(t[n]), i = "&");
        return e
        ...
        var i = 4294967295 * Math.random() | 0, n = 4294967295 * Math.random() | 0, r = 4294967295 * Math.random() | 0,
        ...
        if (t && e && e.id) {
            var i = t.match(/\/\/cdn\.adnxs\.com\/v|\/\/cdn\.adnxs\-simple\.com\/v/), n = t.match("trk.js"),
                r = i && i.length && n && n.length;
            if ("<script" === t.substr(0, 7) && r) {
                var s = t.indexOf('src="') + 5, o = t.indexOf('"', s), a = t.substring(s, o);
                a = a.replace("%native_dom_id%", e.id);
                var d = document.createElement("script");
                e.parentNode.insertBefore(d, e), d.src = a
            }
        }
        ...
        try {
            if (!s.windowTopAccess() && t) {
                ...
                var i = t.unitID.d.split("."), n = t.settings.publisher.tag;
                if (n && i.length > 2 && (i[0] === n || "pomoMediaGroup" === n && ("pmg" === i[0] || "pomo" === i[0]))) return i.shift(), "https://" + i.join(".") + "/"
            }
        } catch (t) {
        }
        return e
    ...
    }, s), AdTrack._AdFormUtils = function () {
    }, AdTrack._AdFormUtils.prototype = {
        generateAdxUrl: function (t, e, i) {
            var n = {test: !0, url: !0, tid: !0, rp: !0, pv: !0, adxjs: !0, lat: !0, lon: !0}, r = [], s = [], o = !1;
            if (!Array.isArray(t)) return console.error("Placement id list should be an array.");
            for (var a = 0; a < t.length; a++) s.push("mid=" + t[a]), [1098653, 1098654, 1098656, 1098729, 1098727, 1098728].indexOf(Number(t[a])) > -1 && (o = !0);
            for (var d in e) if (e.hasOwnProperty(d) && Array.isArray(e[d])) {
                var c = e[d];
                for (var h in c) c.hasOwnProperty(h) && (n[d] ? r.push(d + "=" + encodeURIComponent(h)) : s.push(d + "=" + e[d]))
            } else n[d] ? r.push(d + "=" + encodeURIComponent(e[d])) : s.push(d + "=" + e[d]);
            return r.push(this.b2a(s.join("&")).replace(/=+$/, "")), o ? "//adx3.adform.net/adx/?rp=4&" + r.join("&") + (i ? "&callback=" + i : "") : "//adx.adform.net/adx/?rp=4&" + r.join("&") + (i ? "&callback=" + i : "")
        }, b2a: function (t) {
    ...
    AdTrack.ID = AdTrack.ID || (i = function (t, e, i, n) {
        this.d = t, this.g = e, this.p = i, this.m = n ? 1 : 0, this.type = n ? "mobile" : "classic", this.getName = function () {
        ...
        createIdDGPM: function (t, e, n, r) {
            return r = r ? 1 : 0, e = "string" == typeof e ? e : "", n = "string" == typeof n ? n : "", (t = "string" == typeof t ? t : "") && e && n ? new i(t, e, n, r) : null
        }, createIdDGPT: function (t, e, i, r) {
            var s = "mobile" === r ? 1 : 0;
            return n.createIdDGPM(t, e, i, s)
        }, createIdFromBid: function (t) {
            var e = {};
            return t.params && !t.params.length && (e = t.params), t.ext && t.ext.dgpm && (e = t.ext.dgpm), n.createIdDGPM(e.d, e.g, e.p, e.m)
        }
    })
}, function (t, e) {
    var i, n;
    AdTrack.DOM = AdTrack.DOM || function () {
        ...
        return e.getIframeDocument = function (t) {
            ...
            var s = function (e) {
                var i = 0, s = setInterval((function () {
                    if (i === r) {
                        var a = t;
                        return t = [], clearInterval(s), n(a), void o(a)
                    }
        ...
        this.revert = function () {
            ...
            var s = t.style.getPropertyValue(i), o = t.style.getPropertyPriority(i);
            void 0 !== r ? t.style.setProperty(i, n, r) : t.style.setProperty(i, n), e.push((function () {
                void 0 !== o ? t.style.setProperty(i, s, o) : t.style.setProperty(i, n)
            }))
        }, this.addElement = function (t, i, n) {
            n ? t.insertBefore(i, n) : t.appendChild(i), e.push((function () {
                try {
                    t.removeChild(i)
                } catch (t) {
                }
            ...
            r.setAttribute("style", "display: none !important;"), i.insertBefore(r, n), i.removeChild(n), e.push((function () {
                try {
                    i.insertBefore(n, r), i.removeChild(r)
                } catch (t) {
                }
            }))
        }
        ...
        var e = {}, i = {}, n = function (t, n) {
            t.id = e[n].substr(1), i[n] = t
        }, r = function (t) {
            e[t] = "#" + AdTrack.Utils.simpleStringGenerator(10, "c")
        };
        r("wrap"), r("element"), r("transformLayer");
        var s = t.document.createElement("div"), o = t.document.createElement("div");
        return s.appendChild(o), n(s, "wrap"), n(o, "transformLayer"), {
            getMacros: function () {
                return e
            }, getWrap: function () {
                return i.wrap
                ...
                i.element || (n(t, "element"), i.transformLayer.appendChild(t))
            }, destroy: function () {
                var t = i.wrap;
        ...
        register: function (t, e, i) {
            if (t && e) {
                var r = new n(i);
                return e.macros[t] = r.getMacros(), r
            }
        }
    })
}, function (t, e) {
    var i, n, r, s, o;
    AdTrack.Log = AdTrack.Log || (i = "true" === AdTrack.Utils.getParameterByName("adtrack-debug") || AdTrack.Utils.getLocalStorageItem("adtrack-debug"), n = {
        0: "17a2b8",
        1: "ffc107",
        2: "dc3545"
    }, r = [], s = function (t, e, i, n, r) {
        this.placement = t, this.module = e, this.msg = i, this.severity = n, this.time = r
    }, (o = {INFO: 0, WARNING: 1, ERROR: 2}).debugPlacement = function (t, e, o, a, d) {
        if (d = d || !0, i) {
            "number" == typeof a && n[a] || (a = 0);
            var c = new s(t, e, o, a, AdTrack.Utils.timeRelative());
            d ? function (t) {
                var e = document.getElementById("AdTrackDebugConsole"), i = n[t.severity] || n[0];
    ...
    AdTrack.Events = AdTrack.Events || (i = function (t) {
        var e = {}, i = !1, n = function (t) {
            return "string" == typeof t && (e[t] = {callbacks: [], triggered: !1, triggerOnce: !1}, !0)
        };
        !function (t) {
        ...
        var r = {
            registerEvent: function (t) {
                ...
                if (e[t]) {
                    ...
                    for (e[t].triggered = !0; e[t].callbacks.length > 0;) try {
    ...
    AdTrack.Ajax = AdTrack.Ajax || {
        request: function (t, e) {
            "string" == typeof t && (t = {url: t}), t.url = t.url || "", t.method = t.method || "get", t.data = t.data || {}, t.async = void 0 === t.async || t.async, !t.label || t.label;
            var i = [];
            return {
                host: {}, doError: function (n) {
                    this.host.error || (this.host.error = !0, this.ops.report && e && e.doError(t.label + " Ajax error: " + n)), this.failCallback ? (n = this.xhrType + " " + n, this.runFailCallback(n, !1)) : i.push(n)
                    ...
                    try {
                        ...
                        if (this.xhr) {
                            try {
                                this.xhr.ontimeout = t.ontimeout, this.xhr.onerror = t.onerror, this.xhr.onreadystatechange = function (n) {
                                    i.runAlwaysCallback();
                                    try {
                                        if (4 === i.xhr.readyState && i.xhr.status >= 200 && i.xhr.status < 300) {
                                            var r = i.xhr.responseText;
                                            if (r && !0 === t.json && "undefined" != typeof JSON) try {
                                                r = JSON.parse(r)
                                            } catch (t) {
                                                if (i.ops.report && e) {
                                            ...
                                            var o = 0;
                                            if (i.xhr.timeout && (o = i.timeStart + i.xhr.timeout - 5, i.host.timeouted = n.timeStamp > o), o > 1e5) i.doError("Request failed, cant detect TO (" + i.xhr.status + "): " + i.xhr.statusText); else if (i.host.timeouted) i.runFailCallback("Request timeouted", !0); else {
                                                var a = "Request failed (" + i.xhr.status + "): " + i.xhr.statusText;
                                                i.xhr.responseText && (a += "; Reason: (" + i.xhr.responseText + ")"), i.doError(a)
                                            }
                                        }
                                    } catch (t) {
    ...
    var i, n;
    AdTrack.EventStore = AdTrack.EventStore || (i = AdTrack.Config.eventsFlushInterval(), n = function (t) {
        var e = {}, n = {}, r = 0, s = function () {
            return !(r > 0)
        }, o = function () {
            var t = e;
            return e = {}, r = 0, t
        ...
        return AdTrack.Utils.addEvent(window, d, function () {
            ...
            addEvent: function (t, i, s) {
                if ("string" == typeof t) {
                    if (e[t] || (e[t] = []), e[t].push(i), r++, s) for (var o in s) s.hasOwnProperty(o) && (n[o] = s[o]);
                    !i || "click" !== i.e && "unfilled" !== i.e && "close" !== i.e || a()
                }
            }, flushStore: o, isEmpty: s
        }
    }, {
        create: function (t) {
            return new n(t)
        ...
        var t = {}, e = AdTrack.Config.eventsEnabled(), i = function (e) {
            t[e] || (t[e] = AdTrack.EventStore.create((function (t, i) {
                !function (t, e, i) {
                    ...
                    o.open("POST", n, !0), o.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
                    var a = AdTrack.JSON.stringify(e);
                    a = a.replace(/&/g, "%26"), o.send("events=" + a), o.addEventListener("load", (function (t) {
                    }))
                }(e, t, i)
            })))
            ...
            var h = function (i, d, h, l, u) {
                ...
                doClick: function (t, e, i, n, r, s, o, a, d) {
                    if (h(0, e, "click", {
                        ...
                        s: a ? a.name : null,
                        key: d
                    }), t.options.newwindow) ; else if (null !== o) try {
                        window.top.history.pushState && (AdTrack.BrowserFlags.isFirefox || AdTrack.BrowserFlags.isOldOpera) ? (window.top.history.pushState({}, document.title, window.top.location.href), window.top.location.assign(o)) : window.top.location.assign(o)
                    } catch (t) {
                        window.top.location.href = o
                    }
                }, doLoad: function (t, e, i, n, r) {
                    h(0, e, "load", {c: i, s: n ? n.name : null, key: r})
                }, doPassback: function (t, e, i, n) {
                    var r = {};
                    i && (r.r = i, r.c = n ? 1 : 0), h(0, e, "passback", r)
                }, doBidTimeout: function (t, e, i) {
                    h(0, e, "bid_timeout", {debug: i ? 1 : 0})
                }, doBidError: function (t, e, i) {
                    h(0, e, "bid_error", {debug: i ? 1 : 0})
                }, doBidTime: function (t, e, i, n) {
                    h(0, e, "bid_time", {failed: n ? 1 : 0}, i)
                }, doTimeout: function (t, e) {
                    h(0, e, "timeout", null)
                }, doBidResponse: function (t, e, i, n, r) {
                    h(0, e, "bid_response", i ? {p: i, w: n} : {w: n}, r)
                }, doBidRequest: function (t, e, i) {
                    h(0, e, "bid_request", {c: i})
                    ...
                    h(0, e, "impress", {coeff: n, s: i ? i.name : null, key: r})
                    ...
                    var e = {};
                    if (t) {
                        var i = AdTrack.Utils.isMobile(), n = AdTrack.Utils.screenDiagonal(screen.width, screen.height),
                            r = navigator.userAgent;
                        e = {ua: r = (r = r.replace(/"/g, "&quot;")).replace(/\\/g, "&bsol;"), m: i, s: n}
                    }
                    h(0, null, "pageview", e)
                }, doKeywords: function (t) {
                    h(0, null, "keywords", t)
                }, doViewability: function (t) {
                    h(0, null, "viewability", {t: t})
                }, doPbjCall: function (t, e) {
                    h(0, null, "pbjCall", {pbu: e ? 1 : 0}, t)
                }, doPbjAdUnits: function (t, e, i) {
                    h(0, null, "pbjAdUnits", {u: t ? 1 : 0, f: e ? 1 : 0}, i)
                }, doPbjInAuction: function (t) {
                    h(0, null, "pbjInAuction", {au: t})
                }, doPbjBidRequest: function (t, e, i) {
                    var n = "pbjBidRequest";
                    i && !0 === i && (n += "Debug"), h(0, null, n, {au: t}, e)
                }, doPbjTimeout: function (t, e, i) {
                    var n = "pbjTimeout";
                    i && !0 === i && (n += "Debug"), h(0, null, n, {au: t}, e)
                }, doPbjBidDone: function (t, e) {
                    h(0, null, "pbjBidDone", {au: t}, e)
                }, doPbjNoBid: function (t, e, i) {
                    var n = "pbjNoBid";
                    i && !0 === i && (n += "Debug"), h(0, null, n, {au: t}, e)
                }, doPbjBid: function (t, e, i, n, r, s) {
                    h(0, i, "pbjBid", {au: t, p: n, c: r, rest: s}, e)
                }, doPbjWin: function (t, e, i, n, r) {
                    h(0, i, "pbjWin", {au: t, p: n, c: r}, e)
                }, doPbjLoad: function (t, e, i, n, r) {
                    h(0, i, "pbjLoad", {au: t, p: n, c: r}, e)
                }, doProfiling: function (t, e) {
                    h(0, null, "profiling", t, e)
                }, doNTHBAuction: function (t, e, i, n) {
                    h(0, null, "nthbAuction", {t: t, s: e ? 1 : 0, c: i, p: n})
                }, doNTHBDisplay: function (t, e, i) {
                    h(0, null, "nthbDisplay", {t: t, o: e, p: i})
                }
            };
            return l
        }, r = function (n, r) {
            ...
            var o = function (i, o, a) {
                if (r) {
                    if (!1 === e) return;
                    var d = {t: AdTrack.Utils.time() - s, rt: a, e: i, v: o};
                    t[n].addEvent("prebid", d, {hbDomain: r})
                }
            }, a = {
                prebidInAuction: function (t, e) {
                    o("inAuction", {au: t, b: e})
                }, prebidBidRequest: function (t, e, i) {
                    o("bidRequest", {au: t, b: e}, i)
                }, prebidBidTimeout: function (t, e, i) {
                    o("bidTimeout", {au: t, b: e}, i)
                }, prebidBid: function (t, e, i, n, r, s) {
                    o("bid", {au: t, b: e, p: n, c: r, rest: s}, i)
                }, prebidWin: function (t, e, i, n, r) {
                    o("win", {au: t, b: e, p: n, c: r}, i)
                }, prebidLoad: function (t, e, i, n, r) {
                    o("load", {au: t, b: e, p: n, c: r}, i)
                }
            };
            return a
        }, s = function (n) {
            ...
            var s = function (i, s, o) {
                if (!1 !== e) {
                    var a = {t: AdTrack.Utils.time() - r, e: s, v: o};
                    t[n].addEvent(i, a)
                }
            }, o = {
                cmpTimeout: function (t) {
                    s("cmp", "timeout", {cmp: t ? 1 : 0})
                }, cmpSuccess: function (t, e, i) {
                    s("cmp", "success", {to: e ? 1 : 0, source: t, v: i})
                }
            };
            return o
        }, o = {
        ...
        var n = [], r = [], s = 0, o = 0, a = !1, d = !1, c = {
            getBids: function () {
                ...
                if (!d && t && t.getAuctionPrice()) {
                    if (!a && t.isValid() && (a = !0), n.length > 0) for (var e = 0; e < n.length; e++) {
                    ...
                    s++, o += t.getAuctionPrice()
                }
            }, getNext: function (t) {
                var s = n.shift();
                if (t) for (; s && !s.isValid();) s = n.shift();
                return s && (r.push(s), "function" == typeof i.doNTHBDisplay && i.doNTHBDisplay(e, r.length, s.getAuctionPrice())), s
            }, getId: function () {
                return t
            }, end: function () {
                d = !0, s && "function" == typeof i.doNTHBAuction && i.doNTHBAuction(e, a, s, o)
            }
        };
        return c
    }
    ...
    AdTrack.NTHB.Bid = function (t, e, i, n, r, s) {
        if (this.channel = t, this.wfChannel = e, this.price = n, this.index = i, n) {
            var o = n.isDeal();
            n.setFactor(o ? e.factorFixed : e.factor);
            var a = n.getPrice(), d = s ? r : e.floor;
            d = d || 0, this.valid = a && (a >= d || o || n.noFP)
        } else this.valid = !1;
    ...
    AdTrack.Dispatcher = function (t, e, i, n, r, s, o, a, d) {
        this.version = 13, this.settings = d || {}, this.gdpr = this.settings ? this.settings.gdpr : AdTrack.Config.isCMPEnabled(), this.cmpFallback = this.settings.cmpFallback ? this.settings.cmpFallback : AdTrack.Config.getCMPFallback(), "outstream" !== n && "outstream-premium" !== n || (r.renderer = "outstream"), this.time_start = AdTrack.Utils.time(), this.type = t, this.domain = e, this.group = i, this.position = n, this.unitID = AdTrack.ID.createIdDGPT(e, i, n, t), this.status = 0, this.pass = 0, this.t = 0, this.rendered = !1, this.events = [], this.debugMode = !1, this.debugTarget = "AdTrackDebugConsole", this.keywordOrigin = "online", this.processedChannels = [], this.deviceId = null, this.viewability = null, "track.us.org" != o && "http://track.us.org" != o || (o = "trackad.cz"), this.server = o || "trackad.cz", this.aaproxy = a, this.keywordLogUrl = AdTrack.Config.getKeywordsUrl();
        var c = "online";
        if (r && r.options.environment && (c = r.options.environment), this.environment = c, this.reporting = this.getReporting(c), this.errorReporting = AdTrack.Utils.errorReporting(this.server, AdTrack.url), this.pbjValidation = this.createPbjReportingValidation(), this.evPageView(!1), this.channelMap = [], this.keywordsModule = new AdTrack.KeywordsModule(this), this.jsonpScript = {}, this.cookiesEnabled = !0, this.setCookie("AdTrack-cookies", 1, 1), this.cookiesEnabled = !!this.getCookie("AdTrack-cookies"), this.evAdRequest(), this.isHidden()) this.evUnfilledImp("capping"); else if (this.settings.dummyAds && this.settings.dummyAdsPath && (AdTrack.Libs.isDeployed("adtrack-dummy-js") || (this.dummyAds = AdTrack.Libs.deploy("adtrack-dummy-js", "//" + this.server + "/" + this.settings.dummyAdsPath, !!r.options.noAsync))), r) if (this.definition = r, this.isHB = !!r.options.hb, r.options.noAsync) this.tryToRun(r); else if (this.isHB) try {
            this.tryToRun(r), setTimeout(function () {
                AdTrack.placementQ.execute(this.unitID)
            }.bind(this), 1)
        } catch (t) {
            this.doError("Error during run placement - " + t.message)
        } else setTimeout(function () {
            this.tryToRun(r), AdTrack.placementQ.execute(this.unitID)
        }.bind(this), 1); else this.getDefinition()
        ...
        if ("string" == typeof t && !libs[t]) {
            libs[t] = {onload: [], onerror: [], loaded: !1};
            var n = function () {
                libs[t].loaded = !0, _runCallbackQueue(libs[t].onload)
            };
            if (i) {
                var r = "AdTrack" + Math.round(1e8 * Math.random());
                window[r] = n, document.write("<script src='" + e + "'><\/script>"), document.write("<script>window['" + r + "'](); <\/script>")
            } else {
                var s = document.createElement("script");
                s.src = e, s.onload = n, s.onerror = function () {
        ...
        r.markEventAsTriggerOnce("fastLookUpEnded"), r.markEventAsTriggerOnce("slowLookUpEnded");
        var s = function (t) {
            ...
            var a = AdTrack.Timer.create(i, (function (i) {
                if (t = s(e)) return a.stop(), void r.trigger(o);
                1e3 * i > n && (a.stop(), r.trigger(o))
            }));
            return a
        }, a = function (e) {
            return function () {
            ...
            fastLookUp: function (e, n) {
                r.addCallback("fastLookUpEnded", a(n)), (t = t || s(e)) ? r.trigger("fastLookUpEnded") : i || (i = o(e, 50, 500, "fastLookUpEnded")).start()
            }, slowLookUp: function (e, i) {
                r.addCallback("slowLookUpEnded", a(i)), (t = t || s(e)) ? r.trigger("slowLookUpEnded") : n || (n = o(e, 500, 2e3, "slowLookUpEnded")).start()
            }
        };
        return d.stopLookUp = function (o) {
            (t = t || s(o)) || AdTrack.Prebid.error("Cant find AdUnits '" + e + "'"), i && i.stop(), n && n.stop(), r.trigger("fastLookUpEnded"), r.trigger("slowLookUpEnded")
        }, d
    }(), AdTrack.Viewability = (_Viewability = function (t) {
        var e = t, i = e.ownerDocument, n = i.defaultView || i.parentWindow, r = AdTrack.Utils.windowTopAccess(), s = 0,
            o = 0, a = [], d = null, c = function (t) {
                s = t, function () {
                    for (var t = a.length - 1; t >= 0; t--) {
                        var i = a[t];
                        i.time <= s && !i.removed && (i.interval > 0 ? i.end <= s ? (i.removed = !0, a.splice(t, 1)[0].callback(e, o, s)) : (i.time += i.interval, i.callback(e, o, s)) : (i.removed = !0, a.splice(t, 1)[0].callback(e, o, s)))
                    }
                }()
            }, h = function () {
                (o = getVisiblePercentage(e)) >= .7 ? d.start() : d.stop()
            }, l = function (t) {
                t && t.getBoundingClientRect && (d = AdTrack.Timer.create(500, c), AdTrack.Utils.addEvent(n, "resize", h), AdTrack.Utils.addEvent(n, "scroll", h), AdTrack.Utils.addEvent(n, "build", h), AdTrack.Utils.addEvent(n, "close", h), r && (AdTrack.Utils.addEvent(r, "resize", h), AdTrack.Utils.addEvent(r, "scroll", h)))
            };
        l(e);
        var u = function () {
            d && (AdTrack.Utils.removeEvent(n, "resize", h), AdTrack.Utils.removeEvent(n, "scroll", h), AdTrack.Utils.removeEvent(n, "build", h), AdTrack.Utils.removeEvent(n, "close", h), r && (AdTrack.Utils.removeEvent(r, "resize", h), AdTrack.Utils.removeEvent(r, "scroll", h)), d.stop(), d = null)
        };
        return {
            dispose: u, addCallback: function (t, e, i, n) {
                e = parseInt(e), e = isNaN(e) ? 0 : e, i = parseInt(i), i = isNaN(i) ? 0 : i, n = parseInt(n), n = isNaN(n) ? 0 : n, "function" == typeof t && a.push({
                    time: e,
                    callback: t,
                    removed: !1,
                    interval: i,
                ...
                u(), i = (e = t).ownerDocument, n = i.defaultView || i.parentWindow, l(e)
            }
        }
    }, getVisiblePercentage = function (t) {
        try {
            var e = AdTrack.Utils.getCrossFrameRect(t), i = t.ownerDocument,
                n = AdTrack.Utils.windowTopAccess() || i.defaultView || i.parentWindow;
            if (!e || !n) return 0
        } catch (t) {
            return 0
        }
        var r = e.right - e.left, s = e.bottom - e.top, o = AdTrack.Utils.getViewportRealWidth(n),
            a = AdTrack.Utils.getViewportRealHeight(n), d = Math.max(0, Math.min(e.right, o) - Math.max(e.left, 0)),
    ...
    }), AdTrack.Price = (__currencies = {USD: 22.203, EUR: 25.89, CZK: 1}, _Price = function (t, e, i, n) {
        t = isNaN(t) ? -1 : t, this.originalPrice = t, this.currency = e, this.dealId = i || null, this.isDealFlag = !!i, this.noFP = n, this.price = t, this.factor = null, this.getCurrency = function () {
        ...
        USD: "USD", EUR: "EUR", CZK: "CZK", create: function (t, e, i, n) {
            return new _Price(t, e, i, n)
        }, setCurrencySettings: function (t) {
            if (t) for (var e in __currencies) __currencies.hasOwnProperty(e) && t.hasOwnProperty(e) && !isNaN(parseFloat(t[e])) && (__currencies[e] = parseFloat(t[e]))
        }
        ...
        this.track = t, this.method = e, this.channels = i, this.skippedChannels = n || {}, this.errorThreshold = 4e3
    }, AdTrack.Tier.prototype = {
        getChannel: function (t, e) {
            var i = e.chd;
            i.textAd = !1;
            var n, r = e.floor, s = 0;
            if (e.floor && e.factor && (s = e.floor / e.factor, e.bfc && (s *= e.bfc)), i.bidFloor = s, e.styles && e.styles.other && (i.balanced = !0), "r2b2" !== i.tag) for (var o in i.keyCounts = {}, i.keys) i.keys.hasOwnProperty(o) && (i.keyCounts[i.keys[o]] = o);
            if ("sklik" == i.tag || "sklik-banner" == i.tag) return new AdTrack.SklikChannel(this.track, t, i);
            if ("sklik-hb" == i.tag) return (n = new AdTrack.SklikHBChannel(this.track, t, i)).setFloorPrice({
                value: r,
            ...
            var n = function (t, e, i) {
                this.track.evBidRequest(t, e, i), function (t, e) {
                    e.pending = !0;
                    var i = function (t, e) {
            ...
            try {
                if (t.options.dfpVignette = !1, this.callback = e, this.definition = t, "split" == this.method) {
                    for (var r = 0, s = [], o = 0; o < this.channels.length; o++) {
                        ...
                        this.skippedChannels[o] ? s[o] = [1, 0] : (s[o] = [r, r + a], r += a)
                    }
                    if (0 == r) return this.track.passback(this.definition, null), null;
                    for (var d = Math.random() * r, c = 0, h = 0; h < s.length; h++) if (d >= s[h][0] && d < s[h][1]) {
                        c = h;
                        break
                    }
                    this.track.t = c;
                    var l = this.track.getChannelCount(this.channels[c].chd.keys);
                    this.channels[c].chd && "google-dfp-vgn" === this.channels[c].chd.tag ? (t.options.dfpVignette = !0, n(t, this.channels[c].chd, l)) : this.track.renderer.on("ready", function () {
                    ...
                    this.track.lastNTHBTier++, this.track.nthb = AdTrack.NTHB(this.hbId, this.track.lastNTHBTier, this.track.reporting), this.track.hbAuctionTimeouted && this.forceEvaluation(), t.options.noAsync ? this.hbTimer = null : this.hbTimer = setTimeout(function () {
                        this.evalHB(!0)
                    ...
                    var g = function (e) {
                        return function () {
                            try {
                                ...
                                n(t, this.channels[e].chd, i), this.requestStarts[e] = AdTrack.Utils.time(), this.hbChannels[e] = this.getChannel(t, this.channels[e]), this.hbChannels[e].state = "send_bid";
                                var s = function () {
                                    this.hbChannels[e].bid(function (t, i) {
                                        try {
                                            ...
                                            this.hbResponses + this.hbSkipped == this.channels.length && (this.hbTimer && clearTimeout(this.hbTimer), this.evalHB(!1))
                                        } catch (t) {
                                            this.track.doError("Error processing bid response - " + t.message)
                                        }
                                    }.bind(this), r)
                                }.bind(this), o = this.hbChannels[e].chd.delay;
                                o ? setTimeout(s, o) : s()
                            } catch (t) {
                                var a = "";
                                this.channels && this.channels[e] && this.channels[e].chd && this.channels[e].chd.tag && (a = this.channels[e].chd.tag), this.track.isHB ? AdTrack.Prebid.error("Error while running bid (" + a + ") - " + t.message) : this.track.doError("Error while running bid (" + a + ") - " + t.message)
                            }
                        }
                    };
                    for (o = 0; o < this.channels.length; o++) if (this.skippedChannels[o]) this.hbSkipped++; else {
                        var m = g(o).bind(this);
            ...
            var i = e.product ? e.product.count : null, n = e.normal ? e.normal.count : null, r = e.product || null,
                s = e.normal || null, o = null;
            if (i === n) o = s; else if (null !== n && null === i) o = s; else if (null === n && null !== i) o = r; else {
            ...
            try {
                ...
                for (var e = -1, i = -1, n = !1, r = 0; r < this.hbChannels.length; r++) {
                    ...
                    if (s) {
                        var o = null, a = 0, d = !1, c = !1, h = "", l = null, u = this.channels[r].floor;
                        s.price && (c = s.price.isDeal(), d = s.price.noFP, s.price.setFactor(c ? this.channels[r].factorFixed : this.channels[r].factor), o = s.price.getPrice(), a = s.price.getOriginalPrice(), h = s.price.getCurrency(), l = s.price.getFactor(), "DID-811-92131" == s.price.getDealId() && this.track.doError("Deal ID (DID-811-92131) received from " + s.chd.tag + "#" + s.chd.flag + " has auction price  " + o + " " + h + " due factor " + l, "debug"));
                        try {
                            null !== o && AdTrack.Utils.isPremiumAdform(s.chd) && o < .99 * u && !c && !d && this.track.doError("Premium bid under FP")
                        } catch (t) {
                        }
                        if (this.track.isNTHB && (u = this.minFP), s.chd.dealPriority && c && (!n || n && o > e)) {
                            e = o, i = r, n = !0;
                            continue
                        }
                        if (!n && null !== o && (o >= u || c || d) && o > e) e = o, i = r; else {
                            var p = "Channel (" + s.chd.tag + "#" + s.chd.flag + ")  with price " + o + " CZK, factor " + l + ",  (=" + a + " " + h + "), isDeal:" + c + " has been excluded from auction due: ";
                            if (n && !s.chd.dealPriority) p += "Deal was prioritized."; else if (null === o) p = null; else if (o < u && !c) p += "Price " + o + " CZK is under the floor price which is " + u + " CZK"; else if (o <= e && null !== e) if (this.hbChannels[i] && this.hbChannels[i].price) {
                            ...
                            } else p += "winner bidder has undefined price";
                ...
                for (var g = 0; g < this.hbChannels.length; g++) {
                    ...
                    if (m && m.state && "response_return" === m.state) {
                        var k = i === g ? 1 : 0, v = m.price ? m.price.getPrice() : null;
                        this.track.evBidResponse(null, m.chd, v, k, m.responseTime)
                    }
                }
                for (var b = 0; b < this.hbChannels.length; b++) b !== i && this.hbChannels[b] && this.track.evPassback(this.definition, this.hbChannels[b].chd);
                if (-1 != i) {
                    this.track.t = i;
                    var y = this.hbChannels[i], A = y.price ? y.price.getPrice() : null;
                    this.track.renderer.on("ready", function () {
                        var t = this.track.nthb.getNext(!0), e = this.track.nthb.getBids(),
                            i = this.track.nthb.getBidCount(), n = this.track.nthb.getDisplayed(), r = t.getChannel();
                        if (this.track.isNTHB && e.length < i - 1 && this.track.doError("NTHB - missed bid, count: " + i + "(" + e.length + ")"), r !== y) try {
                            var s = -1, o = t, a = "";
                            t.getAuctionPrice() < A && (a += "nthb<;"), e.forEach((function (t, e) {
                                t.getChannel() === y && (s = e);
                                var i = o.getAuctionPrice(), n = t.getAuctionPrice();
                                n <= 0 && (a += "p0:" + e + ";"), n > i && (a += "f:" + (e - 1) + "-" + e + ";"), o = t
                            }));
                            var d = r.chd.tag + r.chd.flag, c = y.chd.tag + y.chd.flag, h = r.price.getPrice(),
                                l = y.price.getPrice(), u = r.price.isDeal() + "-" + y.price.isDeal();
                            t.getAuctionPrice() !== h && (a += "inconsistent"), this.track.doError("NTHB - highest bid differs, tag: " + (d !== c) + ", price: " + (h !== l) + ", deals: " + u + ", index: " + s + ", count: " + n.length + ", timeout: " + this.hbTimeouted + (a ? ", errors: " + a : ""))
                        } catch (t) {
                            this.track.doError("NTHB - highest bid differs - error: " + t.message)
                        }
                    }.bind(this)), this.track.isHB ? this.track.setHBCallback(y.price, y, function () {
                        this.callback(y, this.channels[i].styles)
                    }.bind(this)) : this.callback(y, this.channels[i].styles)
                } else this.track.nthb = null, this.track.passback(this.definition, null);
                var T = this.track;
                if (T.isHB) {
        ...
        getDefinition: function () {
            var url = "";
            url = this.aaproxy ? this.aaproxy + "?" : "//" + this.server + "/get/" + encodeURIComponent(this.domain) + "/" + encodeURIComponent(this.group) + "/" + encodeURIComponent(this.position) + "/" + ("mobile" == this.type ? "mobile" : "classic"), url += "?" + AdTrack.Utils.uri("ext[dpi]", AdTrack.Utils.getDPI()) + "&", AdTrack.BrowserFlags.isPhone && (270 == window.orientation || 90 == window.orientation || -90 == window.orientation) ? url += AdTrack.Utils.uri("ext[screenWidth]", screen.height) + "&" + AdTrack.Utils.uri("ext[screenHeight]", screen.width) : url += AdTrack.Utils.uri("ext[screenWidth]", screen.width) + "&" + AdTrack.Utils.uri("ext[screenHeight]", screen.height), url += "&" + AdTrack.Utils.uri("ext[mobile]", AdTrack.Utils.isMobile() ? 1 : 0), AdTrack.BrowserFlags.isOldIE && (url += "&" + AdTrack.Utils.uri("ext[isOldIE]", 1)), AdTrack.BrowserFlags.isIE && (url += "&" + AdTrack.Utils.uri("ext[isIE]", 1)), AdTrack.BrowserFlags.isOldOpera && (url += "&" + AdTrack.Utils.uri("ext[isOldOpera]", 1)), AdTrack.BrowserFlags.isFirefox && (url += "&" + AdTrack.Utils.uri("ext[isFirefox]", 1)), AdTrack.BrowserFlags.isPhone && (url += "&" + AdTrack.Utils.uri("ext[isPhone]", 1)), AdTrack.BrowserFlags.isOldAndroid && (url += "&" + AdTrack.Utils.uri("ext[isOldAndroid]", 1)), this.settings.isPreview && (url += "&" + AdTrack.Utils.uri("preview", 1)), this.settings.publisher && this.settings.publisher.pbid && (url += "&" + AdTrack.Utils.uri("pbid", this.settings.publisher.pbid)), this.jsonp(url, "dclbk", function (definition) {
                if (definition) if ("request-error" !== definition && "request-timeouted" !== definition) this.definition = definition, definition.options.noAsync ? this.doError("Syncronous not supported for late rendering") : this.tryToRun(definition); else {
            ...
            this.showEvent = this.createEvent("build"), this.closeEvent = this.createEvent("close")
        }, tryToRun: function (definition) {
            var _startPlacement = function () {
                this.start(definition)
            }.bind(this), _passbackPlacement = function () {
            ...
            if (definition.options.customMultipleAds && (AdTrack.static[this.unitID] || (AdTrack.static[this.unitID] = 0), AdTrack.static[this.unitID]++, definition.options.dom.multipleAdsCounter = AdTrack.static[this.unitID]), !definition.options.mobileOnly || AdTrack.Utils.isMobile(definition.options.checkScreenSize, definition.options.screenSizeThreshold)) if (definition.options.desktopOnly && AdTrack.Utils.isMobile(definition.options.checkScreenSize, definition.options.screenSizeThreshold)) _passbackPlacement(); else {
                if (definition.options.maxScreenSize && AdTrack.Utils.screenDiagonal(screen.width, screen.height) > definition.options.maxScreenSize) return this.evUnfilledImp("screenSize"), void _passbackPlacement();
                this.unitID && -1 !== this.unitID.getName().search("hp.prosvet.cz_generic_branding") && (definition.options.preRunCondition = "(function () {if(AdTrack.Utils.isMobile()){definition.options.noAsync=false; return false;} return true;})();"), this.unitID && -1 !== this.unitID.getName().search("lidovky.cz_hb") && (definition.options.preRunCondition = "(function (w) {return w >= 1000;})(Math.max(document.documentElement.clientWidth, window.innerWidth || 0))");
                try {
                ...
                if (definition.options.hb && definition.options.hb.onlyPrebid && definition.options.hb.prebidAdUnitsPath && !definition.options.noAsync) {
                    var d = this.domain, g = this.group, p = this.position, m = "mobile" === this.type ? 1 : 0;
            ...
            try {
                this.evAdStart(), definition.macros = {}, this.definition = definition, this.pass = 0, definition.options.publisher && "mafra" === definition.options.publisher.tag && ("undefined" == typeof Ads && (window.Ads = {}), Ads.adserver = "sas", definition.options.noAsync = !1, definition.options.compound = !1, !definition.options.publisher.pbid && definition.waterfall.passback && this.doError("Missing parameter pbid"));
                var cswl = definition.options.customCsyncWhiteList, csbl = definition.options.customCsyncBlackList;
                cswl && (definition.options.customCsyncWhiteList = "string" == typeof cswl ? cswl.split(",") : null), csbl && "string" == typeof csbl && (definition.options.customCsyncBlackList = "string" == typeof csbl ? csbl.split(",") : null), AdTrack.Price.setCurrencySettings(definition.currencies), this.isHB = !!definition.options.hb, this.isNTHB = !!this.getOption("nthb");
                var multiImp = !!this.getOption("multiImp");
                if (this.useRenderProxy = multiImp || this.isNTHB, this.multi = multiImp || this.isNTHB ? {
                    load: 0,
                    pb: 0,
                    stop: !1
                } : null, this.cycleTime = this.getOption("cycleTime") || 60, this.skip = {}, this.isHB && this.evPbjCall(AdTrack.Utils.time() - AdTrack.startTime), this.window = window, definition.options.topFrame) try {
                ...
                if (this.initEvents(), this.placementViewability && (this.placementViewability.dispose(), this.placementViewability = null), this.renderer = new AdTrack.BaseRenderer(this, definition, this.window, this.transforms, this.errorReporting), this.renderer.on("ready", this.evDisplayRequest.bind(this)), definition.options.compound) if (definition.options.noAsync) {
                    var cid = this.type + "_" + this.domain + "_" + this.group + "_" + this.position;
                    if (AdTrack.units[cid]) if (1 == AdTrack.units[cid].status) ; else if (2 == AdTrack.units[cid].status) {
                        var ch = null;
                    ...
                    } else this.doError("Unexpected status " + AdTrack.units[cid].status + " in compound ad "); else this.runWaterfall(definition)
                } else this.doError("Compound ads cannot be rendered in asynchronous mode"); else AdTrack.UserID ? AdTrack.UserID.waitForModule(function () {
            ...
            try {
                var e = {channel: null, style: null};
                if (this.wfHasLoad = !1, this.lastNTHBTier = 0, this.isHB) if (this.definition.options.noAsync) this.doError("HB not supported for synchronous placements."); else {
                    this.definition.options.hb.mappingId = this.definition.options.hb.mappingId || this.unitID.getName(), this.auctionTimeout = this.definition.options.hb.auctionTimeout || this.definition.options.hbAuctionTimeout || AdTrack.Config.getHBTimeout() || 2e3, AdTrack.hb.useTimeout(this.auctionTimeout);
                    var i = this.unitID.getName(), n = this.definition.options.hb.mappingId,
                        r = this.definition.options.hb.group, s = !1;
                    this.definition.options.hb.mappingId === this.unitID.getName() && (s = !0, r && this.doError("Groups cant be used for DGPM mapping."));
                    var o = this.definition.options.hb.targeting, a = this.definition.options.hb.targeting.setTargeting,
                        d = "branding" == t.renderer;
                    n && o ? (AdTrack.hb.addPlacement(i, n, r, o, d, a, s), s ? this.openTier(t, this.pass, e) : setTimeout(function () {
            ...
            var n = e.chd;
            this.chdMax = n;
            var r = this.definition.options.hb.currency || "USD", s = t ? t.getPrice(r) : 0,
                o = t ? t.getDealId() : null, a = {};
            e.bidResponse && (this.definition.options.hb.sendPrebidDimension || this.definition.options.customSendPrebidDimension) && (a.sendDimension = !0), e.bidResponse && (this.definition.options.hb.prebidVideo || this.definition.options.customPrebidVideo) && (a.video = !0), this.HBCallback = i, AdTrack.hb.bidResponse(s, r, this.unitID.getName(), this.definition.options.hb.mappingId, this.definition.options.hb.group, o, e.bidResponse, a)
        }, checkForRefresh: function () {
            var t = this.getOption("disableRefreshOnClose"), e = this.getOption("googleNoRefresh"),
                i = this.getOption("refreshFixed") || this.getOption("refreshTime");
            if (e) {
                var n = this.getActualChannel();
                if (n && (-1 !== n.chd.tag.indexOf("google") || "adsense" === n.chd.tag)) return
            }
            if (!isNaN(i) && !this.refreshTimeout) {
                var r = 1e3 * i;
                this.refreshTimeout = setTimeout(function () {
                    clearTimeout(this.refreshTimeout), this.refreshTimeout = null, this.refreshPlacement()
                }.bind(this), r), t && this.renderer.on("close", function () {
            ...
            try {
                ...
                var t = "", e = this.getOption("refreshPlacement");
                t = e && "string" == typeof e ? "//" + this.server + "/get/" + e : "//" + this.server + "/get/" + this.unitID.getPath();
                var i = document.getElementById("adtrack-refresh");
                i || ((i = document.createElement("div")).setAttribute("id", "adtrack-refresh"), document.querySelector("body").appendChild(i)), i.innerHTML = "";
                var n = document.createElement("script");
                i.appendChild(n), n.charset = "UTF-8", n.src = t
            } catch (t) {
                this.doError("Error while refreshing - " + t.message)
            }
        }, displayAd: function (t, e) {
            if (this.debug("Main", "Display ad." + (t ? "  selector: " + t : "") + (e ? "  adUnit: " + e : ""), AdTrack.Log.INFO), "function" == typeof this.HBCallback && !this.isRendered()) {
                if (this.definition.options.dom && this.definition.options.dom.selectorForeign) {
                    if ("string" != typeof t) return void this.doError("Unable to display ad, selector not provided.");
                    this.definition.options.dom.selector = t
                }
                e && (this.definition.macros.adUnit = e), this.HBCallback()
            }
        }, show: function () {
            ...
            try {
                ...
                if ("idnes.cz" === this.domain && "interscroll" === definition.renderer) {
                    ...
                    if (viewport_w <= viewport_h) this.evProfiling("interscroller orientation - portrait"); else if (this.evProfiling("interscroller orientation - landscape"), definition.waterfall.passback) return void eval(definition.waterfall.passback)
                }
                this.renderer.init(function () {
                    try {
                        if (this.renderer.on("destroy", (function () {
                            "function" == typeof channel.destroy && channel.destroy()
                        })), channel.MTsupport) channel.render(null, styles, function (t) {
                            t ? (t.on("load", function () {
                                this.loaded(definition, channel.chd, t.getCount(), t.getStyle(), t.getPassedResponse(), !0), this.renderer.on("impress", function (e, i) {
                                    this.evImpress(definition, channel.chd, t.getStyle(), i)
                                }.bind(this))
                            }.bind(this)), t.on("click", function () {
                                this.evClick(definition, channel.chd, 0, 0, null, null, null, t.getStyle())
                            }.bind(this)), t.isPreloaded() && !definition.options.noAsync && t.on("error", function () {
                                this.passback(definition, channel.chd, t.getPassbackReason())
                            }.bind(this)), this.renderer.render(t)) : this.errorReporting.doError("Channel does not return mediatype.")
                        }.bind(this)); else {
                ...
                if (definition.waterfall.tiers.length <= pass) {
                    try {
                        if (this.multi && (this.multi.pb++, this.multi.load > 0)) {
                            if (passbackOption.channel && this.evPassback(definition, passbackOption.channel, passbackOption.reason), this.multi.pb < 3) {
                                var rerun = function () {
                        ...
                        if (this.evPlacementPassback(), this.isHB) {
                        ...
                        definition.options.noAsync && void 0 !== document.readyState && "loading" !== document.readyState && !window.postscribe && this.doError("Possible synchronous passback in async context", "high"), this.settings.publisher && "economia" === this.settings.publisher.tag && "loading" !== document.readyState && (passbackOption.reason = "noPassback"), passbackOption.channel && this.evPassback(definition, passbackOption.channel, passbackOption.reason), definition.waterfall.passback ? ("classic_zpravy.idnes.cz_rtb-premium-article_480x300" === this.unitID.getName() && this.evProfiling("dispatcher wf passback exists"), eval(definition.waterfall.passback)) : "classic_zpravy.idnes.cz_rtb-premium-article_480x300" === this.unitID.getName() && this.evProfiling("dispatcher wf passback not exists"), definition.options.onPassback && eval(definition.options.onPassback), passbackOption.channel && passbackOption.channel.passback && eval(passbackOption.channel.passback), this.status = 2, this.renderer.events.trigger("empty"), this.checkForRefresh()
                    } catch (t) {
                        this.doError("Error in placement passback - " + t.message), "classic_zpravy.idnes.cz_rtb-premium-article_480x300" === this.unitID.getName() && this.evProfiling("dispatcher passback error: " + t.message)
                    }
                    return !1
                }
                try {
            ...
            if (definition.aagun) {
                ...
                var ch = definition.aagun.channel, data = definition.aagun.data,
                    channel = tier.getChannel(definition, ch);
                return channel.data = data, this.render(definition, channel, ch.styles), !0
            }
        }, passback: function (t, e, i) {
            try {
                this.pass++;
                var n = {channel: e, reason: i};
            ...
            return {data: {style: t, width: e.width, height: e.height, chd: e}}
        }, loaded: function (t, e, i, n, r, s) {
            try {
                !n && t.style && (n = t.style);
                var o = null;
                if (n && (o = n.name), s || (this.renderer.loaded(this.artificialFormat(n, e)), this.definition.options.dom.noContainer || this.renderer.on("impress", function (i, r) {
                    this.evImpress(t, e, n, r)
                }.bind(this))), this.rendered = !0, this.wfHasLoad = !0, this.checkForRefresh(), this.shouldReturnDummyAd() || this.evLoad(t, e, i, n), this.multi && (this.multi.load++, this.skip[this.pass] || (this.skip[this.pass] = {}), this.skip[this.pass][this.t] = !0), this.status = 1, t.options.onLoad) new Function("response", "chd", "var l = " + t.options.onLoad + ".bind(this); l(response,chd)").bind(this)(r, e)
            } catch (t) {
            ...
            try {
                if (!this.getOption("preventPublisherManipulation")) {
                    var a = this.window;
                    if (a === window.top) this.container.setAttribute("data-adtrack-id", this.unitID.getName()); else {
                        for (; a.parent !== window.top;) a = a.parent;
            ...
            try {
                var d = this.getActualChannel(), c = "", h = {}, l = "";
                d.bidResponse && (l = d.bidResponse.getCreativeId() || ""), d.price && (h = {
                    cpm: d.price.getPrice(),
                    id: d.price.getDealId() || ""
                }), "function" == typeof d.report && (c = d.report()), this.settings.creativeLogId && this.settings.creativeLogId > 0 && "sklik" !== e.tag && "seznam-ssp" !== e.tag && AdTrack.Utils.reportCreative(this.server, this.settings.creativeLogId, e.tag, l, h.id || "", h.cpm || "", c), this.getCookie("adtrack_testlog") && this.settings.publisher && "mafra" === this.settings.publisher.tag ? "sklik" !== e.tag && "seznam-ssp" !== e.tag && AdTrack.Utils.reportCreative(this.server, 45, e.tag, l, h.id || "", h.cpm || "", c) : e.logs && e.logs.creative && AdTrack.Utils.reportCreative(this.server, e.logs.creative, e.tag, l, h.id || "", h.cpm || "", c), AdTrack.Ext.sendResponse(this.unitID, e.tag, e.flag, {
                    price: h,
                    response: c
                }, o)
            } catch (t) {
            ...
            if (this.settings.publisher && this.settings.publisher.id) {
                var i = [{asi: "r2b2.cz", sid: this.settings.publisher.id, hp: 1}];
                if (t) {
                    var n = "1.0,1";
                ...
                return {ver: "1.0", complete: 1, nodes: i}
            }
            ...
            return Array.prototype.forEach.call(t, function (t) {
                this.addEvent(t, "click", e), t.onclick = i ? "return true;" : "return false;"
            }.bind(this)), t
            ...
            this.viewability && this.viewability.dispose(), this.viewability = AdTrack.Viewability.create(t), this.viewability.addCallback(e), this.placementViewability || (this.placementViewability = AdTrack.Viewability.create(this.multi ? this.container : t), this.placementViewability.addCallback(function () {
                this.evViewability(0)
            }.bind(this)), this.placementViewability.addCallback(function (t, e, i) {
                this.evViewability(Math.round(i))
            }.bind(this), 10, 5, 45)), this.multi && this.multi.pb < 3 && !0 !== this.multi.stop && this.viewability.addCallback(function () {
                if (!0 !== this.multi.stop) if (this.isNTHB && this.nthb) {
                    var t = this.nthb.getNext();
                    if (t) {
                        var e = t.getChannel(), i = t.getStyles();
                        this.t = t.getIndex(), this.channelMap[this.pass] = e, this.render(this.definition, e, i)
                    } else this.nthb = null, this.passback(this.definition, null)
                } else this.pass = 0, this.runWaterfall(this.definition)
            ...
            (!t || t < 0) && (t = 0), "function" == typeof this.reporting.doClose && this.reporting.doClose(t)
            ...
            this.clickReported || (this.reporting.doClick(t, e, i, n, r, s, o, a, d), this.clickReported = !0)
        }, evImpress: function (t, e, i, n) {
            n = Math.round(100 * n) / 100;
            var r = this.getChannelKey(e, i);
            this.reporting.doImpress(t, e, i, n, r), this.multi && "classic_jizdnirady.cz_generic_750x100middle" === this.unitID.getName() && ("google" !== e.tag && "google-dfp" !== e.tag || (this.multi.stop = !0))
            ...
            null != e && (e.pending = !0), this.reporting.doBidRequest(t, e, i)
            ...
            null != e && (e.pending = !1), i ? this.reporting.doPassback(t, e, i, this.cookiesEnabled) : this.reporting.doPassback(t, e)
            ...
            "function" == typeof this.reporting.doPbjCall ? (this.pbjValidation.call(), this.reporting.doPbjCall(t, !!this.prebidUnit)) : this.doPbjError("Cant report, 'doPbjCall' is not a function.")
        }, evPbjAdUnits: function (t, e, i) {
            "function" == typeof this.reporting.doPbjAdUnits ? (this.pbjValidation.adUnits(), this.reporting.doPbjAdUnits(t, e, i)) : this.doPbjError("Cant report, 'doPbjAdUnits' is not a function.")
            ...
            "function" == typeof this.reporting.doPbjBid ? (this.pbjValidation.bid(), this.reporting.doPbjBid(t, e, s, i, n, r)) : this.doPbjError("Cant report, 'doPbjBid' is not a function.")
        }, evPbjWin: function (t, e, i, n) {
            var r = this.chdMax ? this.chdMax : null;
            "function" == typeof this.reporting.doPbjWin ? (this.pbjValidation.win(), this.reporting.doPbjWin(t, e, r, i, n)) : this.doPbjError("Cant report, 'doPbjWin' is not a function.")
        }, evPbjLoad: function (t, e, i, n) {
            var r = this.chdMax ? this.chdMax : null;
            "function" == typeof this.reporting.doPbjLoad ? (this.pbjValidation.load(), this.reporting.doPbjLoad(t, e, r, i, n)) : this.doPbjError("Cant report, 'doPbjLoad' is not a function.")
        }, log: function (t) {
        }, isBanner: function (t) {
            ...
            n = n || 0 === n ? n : this.settings.timeout ? this.settings.timeout : 5e3, AdTrack.Utils.jsonp(t, e, i, n)
        }, shouldCsync: function (t) {
            var e = this.definition.options.customCsyncWhiteList, i = this.definition.options.customCsyncBlackList;
            ...
            if (this.cookiesEnabled) {
                ...
                var s = {k: t, v: e, x: i}, o = "//" + this.server + "/cookie.php", a = new XMLHttpRequest;
                a.addEventListener("load", (function (t) {
                })), a.open("POST", o, !0), a.setRequestHeader("Content-Type", "application/x-www-form-urlencoded"), a.send("cookie=" + AdTrack.JSON.stringify(s))
            }
        }, getCookie: function (t) {
            if (this.cookiesEnabled) return AdTrack.Utils.readCookie(t);
            var e = "//" + this.server + "/cookie.php?" + AdTrack.Utils.uri("k", t), i = new XMLHttpRequest;
            return i.open("GET", e, !1), i.send(), 200 === i.status ? i.responseText : ""
        }, addImp: function (t) {
            var e = this.getCookie("AdTrack-imp-" + this.domain + "-" + this.type + "-" + this.group + "-" + this.position);
            return e ? e++ : e = 1, this.setCookie("AdTrack-imp-" + this.domain + "-" + this.type + "-" + this.group + "-" + this.position, e, t), e
        }, setHide: function (t) {
            ...
            return this.deviceId || (this.deviceId = AdTrack.Utils.getDeviceId(this)), this.deviceId
    ...
    AdTrack.PWTWrap = AdTrack.PWTWrap || {
        ...
        if (-1 === t.location.hostname.indexOf("pravda.sk") && -1 === t.location.hostname.indexOf("kurzy.cz") && -1 === t.location.href.indexOf("r2b2-test-userid")) return null;
        var e = function () {
            var t = [], e = null, i = !1, n = !1, r = [], s = !1, o = null, a = null, d = {
                intentIqId: {atype: 1, source: "intentiq.com"},
                pubcid: {atype: 1, source: "pubcid.org"},
                tdid: {atype: 1, source: "adserver.org"},
                id5id: {atype: 1, source: "id5-sync.com"},
                parrableId: {atype: 1, source: "parrable.com"},
                idl_env: {atype: 1, source: "liveramp.com"},
                lipb: {atype: 1, source: "liveintent.com"},
                britepoolid: {atype: 1, source: "britepool.com"},
                lotamePanoramaId: {atype: 1, source: "crwdcntrl.net"},
                criteoId: {atype: 1, source: "criteo.com"},
                merkleId: {atype: 1, source: "merkleinc.com"},
                netId: {atype: 1, source: "netid.de"},
                sharedid: {atype: 1, source: "sharedid.org"},
                IDP: {atype: 1, source: "zeotap.com"},
                haloId: {atype: 1, source: "audigent.com"},
                quantcastId: {atype: 1, source: "quantcast.com"}
            }, c = function () {
                ...
                if (e && "function" == typeof e.getUserIds) {
                    s = !0;
                    var i = e.getUserIds();
                    AdTrack.Utils.setCookieFirstParty("AdTrack-PWT", JSON.stringify(i), 14400), t(i)
                }
            }, l = function () {
                ("done" !== e || "done" === e && n) && (e = "done", clearInterval(o), clearTimeout(a))
            }, u = function (e, i, n) {
                t = e, n, l(), i()
            }, p = function (r) {
                if (!!t && Array.isArray(t) && t.length > 0) r(); else {
                    var d = function (t) {
                        u(t, r, "script"), "done" !== e && setTimeout((function () {
                            h(d)
                        }), 100)
                    }, p = function () {
                        s || h(d)
                    }, f = AdTrack.Utils.readCookie("AdTrack-PWT");
                    if (f && (u(JSON.parse(f), r, "cookie"), "done" === e && setTimeout(p, 5e3)), !o && "done" !== e) {
                        o = setInterval(p, 100), a = setTimeout((function () {
                            l(), n = !0
                        }), 5e3);
                        var g = setTimeout((function () {
                            "done" !== e && (i = !0, c()), clearTimeout(g)
                        }), 200)
                    }
                }
            }, f = {
                getUserIdsConfig: function () {
                    ...
                    return e.forEach(e => {
                        ...
                        var n = d[e], r = AdTrack.UserID.createEidObject(t[e], n.source, n.atype);
                    ...
                    let n = {};
                    if (n.source = e, "string" == typeof t) {
                        const e = {id: t, atype: i};
                        return n.uids = [e], n
                    }
            ...
            return f.init(AdTrack.Config.getUserID()), f
        };
        if (t.AdTrack.UserID && "function" == typeof t.AdTrack.UserID.fn) try {
            t.AdTrack.UserID.fn()
        } catch (i) {
            t.AdTrack.UserID = e()
        } else t.AdTrack.UserID = e();
    ...
    !function (r, s) {
        "use strict";
        var o = "model", a = "name", d = "type", c = "vendor", h = "version", l = "mobile", u = "tablet", p = {
            extend: function (t, e) {
                var i = {};
            ...
            rgx: function (t, e) {
                for (var i, n, r, s, o, a, d = 0; d < e.length && !o;) {
                    var c = e[d], h = e[d + 1];
                    for (i = n = 0; i < c.length && !o;) if (o = c[i++].exec(t)) for (r = 0; r < h.length; r++) a = o[++n], "object" == typeof (s = h[r]) && s.length > 0 ? 2 == s.length ? "function" == typeof s[1] ? this[s[0]] = s[1].call(this, a) : this[s[0]] = s[1] : 3 == s.length ? "function" != typeof s[1] || s[1].exec && s[1].test ? this[s[0]] = a ? a.replace(s[1], s[2]) : void 0 : this[s[0]] = a ? s[1].call(this, a, s[2]) : void 0 : 4 == s.length && (this[s[0]] = a ? s[3].call(this, a.replace(s[1], s[2])) : void 0) : this[s] = a || void 0;
                    d += 2
                }
            }, str: function (t, e) {
                for (var i in e) if ("object" == typeof e[i] && e[i].length > 0) {
                    for (var n = 0; n < e[i].length; n++) if (p.has(e[i][n], t)) return "?" === i ? void 0 : i
            ...
            return this.getBrowser = function () {
                ...
                return f.rgx.call(t, i, n.browser), t.major = p.major(t.version), t
        ...
        k.VERSION = "0.7.20", k.BROWSER = {
            ...
            MAJOR: "major",
            VERSION: h
        }, k.CPU = {ARCHITECTURE: "architecture"}, k.DEVICE = {
            MODEL: o,
            VENDOR: c,
            TYPE: d,
            CONSOLE: "console",
            ...
            WEARABLE: "wearable",
            EMBEDDED: "embedded"
        }, k.ENGINE = {NAME: a, VERSION: h}, k.OS = {
            NAME: a,
            VERSION: h
        }, void 0 !== e ? (void 0 !== t && t.exports && (e = t.exports = k), e.UAParser = k) : void 0 === (n = function () {
            return k
        ...
        if (void 0 !== v && !v.ua) {
            ...
            v.ua = b.getResult(), v.ua.get = function () {
                ...
                b.setUA(t);
                var e = b.getResult();
                for (var i in e) v.ua[i] = e[i]
            }
        }
    }("object" == typeof window ? window : this)
}, function (t, e) {
    AdTrack.Chain = function () {
        var t = {}, e = null, i = this, n = {}, r = function (e, i) {
            if (t[e]) {
                for (var r = [], s = 0; f = t[e][s]; s++) f !== i && r.push(f);
                t[e] = r
            }
            return n
        }, s = function (o, a, d) {
            d || (d = 0);
            var c = null;
            return o[d] && (c = o[d]), "object" == typeof c && null !== c ? c[a](e, (function (t) {
                e = t, s.call(i, o, a, ++d)
            })) : function (e, i) {
                if (t[e]) for (var n = 0; f = t[e][n]; n++) f(i), r(e, f)
            }("done", e), n
        };
        return n = {
            run: s, on: function (e, i) {
                return t[e] || (t[e] = []), t[e].push(i), n
            }, off: r
        }
    ...
    AdTrack.WordExtractor = function (t) {
        ...
        log: function () {
            ...
            for (var t = this.dom.getElementsByTagName("h1"), e = [], i = 0; i < t.length; i++) {
                var n = t[i].innerHTML;
                n = this.replaceChar(n), e = this.splitWords(n).concat(e)
            }
            return e
            ...
            if (null == t) return [];
            for (var e = t.split(" "), i = [], n = new RegExp(/[a-záčďéěíňóřšťůúýž]+/g), r = 0; r < e.length; r++) if ("" != e[r]) {
                if (null == (t = e[r].toLowerCase().match(n)) || "undefined" == t) continue;
                i = i.concat(t)
            }
            return i
    ...
    AdTrack.KeywordsModule.PageExtractor = function (t) {
        ...
        getKeywords: function (t, e) {
            if (null == this.keywords || void 0 === this.keywords) {
                var i = this.extractKeywords(), n = 0, r = {};
                for (var s in i) if (i.hasOwnProperty(s)) {
                    if ((n += i[s].length) > 1e3) break;
                    r[i[s]] = "online"
                }
                this.keywords = r
            }
    ...
    AdTrack.KeywordsModule.UserAgentExtractor = function (t) {
        ...
        getKeywords: function (t, e) {
            ...
            if (e && -1 !== e && void 0 !== AdTrack.UAParser) {
                ...
                i.setUA(e);
                var n = i.getDevice();
                n.vendor && (t[n.vendor] = "ua_device_vendor"), n.model && (t[n.model] = "ua_device_model")
            }
            return t
        }, mergeKeywords: function (t, e) {
            var i = {};
    ...
    AdTrack.BaseRenderer = function (t, e, i, n, r) {
        this.track = t, this.definition = e, this.window = i, this.document = i.document, this.transforms = n, this.errorReporting = r, this.styles = AdTrack.Styles.create(e.macros, n, i), this.renderer = null, this.container = null, this.wrap = null, this.insertion = null, this.initialized = !1, this.events = AdTrack.Events.create(["destroy", "ready", "empty", "impress", "expand", "collapse", "close"]), this.events.markEventAsTriggerOnce("destroy"), this.events.markEventAsTriggerOnce("ready"), this.events.markEventAsTriggerOnce("empty"), this.events.markEventAsTriggerOnce("impress"), this.events.markEventAsTriggerOnce("expand"), this.events.markEventAsTriggerOnce("collapse")
        ...
        close: function () {
            ...
            this.onLoadAdjust(), this.renderer.transitionObject = this.createTransitionObject(t), this.renderer.loaded(t), this.loadStyles(t), this.renderer.measureImpress(this.getContainer(), function (t, e) {
                this.events.trigger("impress", [t, e])
            }.bind(this)), this.track._dispatchShow()
        }, updateSize: function (t) {
            "function" == typeof this.renderer.updateSize && this.renderer.updateSize(t)
        }, loadStyles: function (t) {
            var e = t.data.style, i = this.definition;
            ...
            this.initialized ? this.definition.options.dfpVignette ? t() : this.on("ready", t) : (this.initialized = !0, this.getRenderer(), this.tryInsertion(function () {
                if (this.domAdjust(), this.renderer) {
                    this.containerId = "C_" + Math.floor(1e5 * Math.random()), this.container.setAttribute("data-adtrack-container", this.containerId), this.definition.macros.container = "[data-adtrack-container=" + this.containerId + "]", this.track.container = this.container, this.wrap = this.container, this.renderer.isReadyToShow(this.container) || this.definition.options.noAsync ? (this.events.trigger("ready"), t()) : this.definition.options.dfpVignette ? t() : this.on("ready", t)
                } else t()
            }.bind(this)))
        }, render: function (t) {
            var e = function (e) {
            ...
            t.isRenderedExternally() ? (t.on("load", function () {
                ...
                this.renderer.hide(), this.track._dispatchClose(), this.track.evClose()
            ...
            var e = this.window.document.readyState, i = !!this.definition.options.noAsync;
            if ("complete" == e || "ready" == e || !AdTrack.BrowserFlags.isOldIE && "interactive" == e) this.container = this.getInsertion(this.definition, !0), this.container && t(); else if (this.container = this.getInsertion(this.definition, i), this.container) t(); else if (!i) {
                var n = this.document.addEventListener ? "DOMContentLoaded" : "readystatechange", r = function () {
                    AdTrack.Utils.removeEvent(this.document, n, r), this.container = this.getInsertion(this.definition, !0), this.container && t()
                }.bind(this);
            ...
            if (this.definition.options && this.definition.options.dom) {
                ...
                if (this.insertion || (this.insertion = new AdTrack.Insertion(this.document, this.transforms, i, this.errorReporting)), "container" === i.method) return this.insertion.container();
            ...
            var e = t.data.style, i = this.track.getOption("transitionStart", e),
                n = this.track.getOption("transitionMid", e), r = this.track.getOption("transitionEnd", e),
                s = i && -1 !== ("" + i).indexOf("animation"), o = i, a = n, d = r, c = function (t) {
            ...
            return {
                hasTransition: function () {
                    ...
                    o = o || t.start, a = a || t.mid, d = d || t.end
                }
            }
        }
            ...
            container: function () {
                ...
                if (r) {
                    ...
                    if (i.before) {
                        ...
                        if (o) return e.addElement(o.parentNode, s, o), s;
                        if (i.allowFallbackLast) return e.addElement(r, s), s;
                        n && n.doError("Unable to find b selector " + i.before)
                    } else {
                        if (!i.after) return e.addElement(r, s), s;
                        var a = r.querySelector(i.after);
                        if (a) return e.addElement(a.parentNode, s, a.nextSibling), s;
                        if (i.allowFallbackLast) return e.addElement(r, s), s;
                        n && n.doError("Unable to find a selector " + i.after)
                    }
                } else n && n.doError("Unable to find s selector " + i.container)
            }, smartInsert: function () {
                var r, s, o = t.querySelectorAll(i.selector), a = i.insertion || "near-fold", d = -1;
                if (o.length > 0 && a) {
                    var c = t.createElement("div"), h = Math.ceil((o.length - 1) / 2);
                    if ("middle" === a) d = h; else if ("near-fold" === a) for (var l = 0; l < o.length; l++) {
                        var u = o[l], p = AdTrack.Utils.getViewportRealHeight(window),
                    ...
                    } else if ("floatfix" === a) for (var g = o[0].parentNode.childNodes, m = !1, k = 0; k < o.length; k++) {
                        for (var v = o[k].getBoundingClientRect(), b = !1, y = 0; y < g.length; y++) if ("function" == typeof g[y].getBoundingClientRect && o[k] !== g[y]) {
                            var A = g[y].getBoundingClientRect();
                            if (r = v, !((s = A).left > r.right || s.right < r.left || s.top > r.bottom || s.bottom < r.top)) {
                                b = !0;
                                break
                            }
                        }
                    ...
                    return d < 0 && (d = h), e.addElement(o[d].parentNode, c, o[d].nextSibling), c
                }
                n && n.doError("Unable to find selector '" + i.selector + "' or incorrect insertion provided.")
            }, fuzzy: function () {
                var r = t.querySelector(i.selector);
                if (r) {
                    for (var s = i.fuzzyParentize ? i.fuzzyParentize : 0, o = 0; o < s && r.parentNode && (!i.fuzzyParentizeAtMostClass || i.fuzzyParentizeAtMostClass != r.parentNode.className) && (!i.fuzzyParentizeAtMostId || i.fuzzyParentizeAtMostId != r.parentNode.id); o++) r = r.parentNode;
                    var a = t.createElement("div"), d = r, c = i.fuzzyInject ? i.fuzzyInject : 0;
                    for (o = 0; o < c; o++) e.addElement(r.parentNode, a, d.nextSibling), d = a, a = t.createElement("div");
                    if (i.fuzzyClass && AdTrack.Utils.addClassName(a, i.fuzzyClass), i.fuzzyId && a.setAttribute("id", i.fuzzyId), i.fuzzyStyle) {
                        var h = "d" + Math.round(1e5 * Math.random()), l = t.createElement("style");
                        e.addElement(t.getElementsByTagName("head")[0], l), AdTrack.Utils.cssToStyle(l, "." + h + "{" + i.fuzzyStyle + "}"), AdTrack.Utils.addClassName(a, h)
                    }
                    return e.addElement(r.parentNode, a, d.nextSibling), a
                }
                n && n.doError("Unable to find c selector " + i.selector)
            }
        };
        ...
        return s.addCss = function (t, e) {
            ...
            if (t) for (var i = 0; i < o.length; i++) {
                var n = o[i];
                e ? e.addElement(t, n) : t.appendChild(n)
            }
        }, s
    }, {
        DEFAULT: 0, DEFINITION: 1, STYLE: 2, TRANSITION: 3, create: function (t, e, n) {
            return new i(t, e, n)
        }
    })
}, function (t, e) {
    AdTrack.FlexiRenderer = function (t, e, i, n) {
        this.track = t, this.definition = e, this.transforms = i, this.events = n, this.container = null, this.rp = this.track.useRenderProxy ? new AdTrack.RenderProxy(this.track) : null
        ...
        isReadyToShow: function (t) {
            return !this.definition.options.control || (this.definition.options.control.show && (this.track.window[this.definition.options.control.show] = function () {
                this.open(), this.events.trigger("ready")
            }.bind(this)), this.definition.options.control.hide && (this.track.window[this.definition.options.control.hide] = function () {
                this.close()
            }.bind(this)), this.animator = new AdTrack.Animator({duration: .3, fps: 60}, function (e) {
                t.style.display = e > 0 ? "block" : "none", t.style.opacity = e
            }.bind(this)), !1)
        }, getContainer: function () {
            return this.rp && !this.currentProxy && this.track.doError("Proxy not rendered yet, cant provide container. "), this.rp ? this.currentProxy : this.container
        }, createContainer: function (t) {
            if (!this.container) if (this.definition.options.position) {
                var e = this.track.document.createElement("div");
                t.style.position = "relative", this.transforms.addElement(t, e), this.container = e
            ...
            if (this.definition.options.position) {
                ...
                this.definition.options.position.left && (e.style.left = this.definition.options.position.left), this.definition.options.position.right && (e.style.right = this.definition.options.position.right), this.definition.options.position.top && (e.style.top = this.definition.options.position.top), this.definition.options.position.bottom && (e.style.bottom = this.definition.options.position.bottom), this.definition.options.position.width && (e.style.width = this.definition.options.position.width), this.definition.options.position.height && (e.style.height = this.definition.options.position.height), e.style.position = "absolute"
            }
            ...
            this.animator.backward(), this.definition.options.hideDelay && this.track.setHide(this.definition.options.hideDelay)
        }
    }
}, function (t, e) {
    AdTrack.RenderProxy = function (t) {
        var e = null, i = null, n = null, r = {};
        return r.getProxyContainer = function (i) {
            var r;
            return e = i, n && e.removeChild(n), (r = t.document.createElement("div")).setAttribute("style", "visibility: hidden !important;position: fixed !important;top: 0 !important;left: 0 !important;z-index: -10000 !important;width: 0 !important;height: 0 !important;overflow: visible !important;"), r.setAttribute("id", "proxy" + Math.floor(1e8 * Math.random())), e.appendChild(r), n = r
        }, r.render = function () {
            if (n) {
                ...
                }(e, n), t ? (n.setAttribute("style", ""), i = n) : (!function (t, e) {
                    var i = e.childNodes;
                    if (i) for (var n = i.length - 1; n >= 0; n--) t.appendChild(i[n])
                }(e, n), e.removeChild(n), i = e), n = null
            }
            return i
        }, r
    }
    ...
    AdTrack.OutstreamRenderer = function (t, e, i, n) {
        this.track = t, this.definition = e, this.transforms = i, this.events = n, this.container = null, this.element = null, this.expanded = !1, this.collapsing = !1, this.height = 0, this.expandTime = 350, this.fps = 60, e.options && (this.maxWidth = e.options.width, this.maxHeight = e.options.height), this.isLoaded = !1, this.impressListener = null
    }, AdTrack.OutstreamRenderer.prototype = {
        isReadyToShow: function (t) {
            var e = function () {
                var e = t.getBoundingClientRect().top, i = AdTrack.Utils.getViewportRealHeight(this.track.window);
                return e > 0 && e <= i / 2
            }.bind(this);
            return this.impressListener = function () {
                e() && (this.events.trigger("ready"), this.track.removeEvent(window, "resize", this.impressListener), this.track.removeEvent(window, "scroll", this.impressListener), this.track.removeEvent(window, "build", this.impressListener), this.impressListener = null)
            }.bind(this), this.track.addEvent(window, "resize", this.impressListener), this.track.addEvent(window, "scroll", this.impressListener), this.track.addEvent(window, "build", this.impressListener), e()
        }, getContainer: function () {
            return this.container
        }, createContainer: function (t) {
            return this.container || (this.container = t), this.container
        }, expand: function () {
            var t = this.element;
            t.style.height = 0, t.style.display = "block", this.height = 0;
            var e = this._getSettings(this.expandHeight), i = function () {
                this.height >= this.expandHeight ? this.events.trigger("expand") : (t.style.height = (this.height += e.step) + "px", this.collapsing || setTimeout(i.bind(this), e.interval))
            }.bind(this);
            i(), this.expanded = !0
        }, collapse: function () {
            var t = this.element;
            if (this.height > 0 && this.expanded) {
                ...
                i()
            } else this.track.doError("Unable to collapse, expanded: " + this.expanded + ", height: " + this.height)
        }, _getSettings: function (t) {
            var e = 1e3 / this.fps, i = t / (this.expandTime / e);
            return {interval: Math.floor(e), step: Math.floor(i)}
        }, loaded: function (format) {
            this.isLoaded = !0, "function" == typeof format.getElement && (this.element = format.getElement() || this.container), this.maxWidth && (this.container.style.maxWidth = this.maxWidth + "px");
            var rect = this.container.getBoundingClientRect(), w = rect.right - rect.left;
            this.expandHeight = w / (16 / 9), this.maxHeight > 0 && this.maxHeight < this.expandHeight && (this.expandHeight = this.maxHeight), format.on("end", function () {
                this.hide()
            }.bind(this)), this.show(), this.events.addCallback("collapse", function () {
                var collapse = this.definition.options.outstreamCollapse;
                collapse && eval(collapse), this.destroy()
            ...
            this.impressListener && (this.track.removeEvent(window, "resize", this.impressListener), this.track.removeEvent(window, "scroll", this.impressListener), this.track.removeEvent(window, "build", this.impressListener), this.impressListener = null), this.events.trigger("destroy")
        }, show: function () {
            this.expand()
        }, hide: function () {
            this.collapse()
    ...
    AdTrack.GenericAd = function (t, e) {
        ...
        var t = this.ad.getProductDescription(), e = this.ad.getProductPrice(), i = e && -1 === t.indexOf(e);
        ...
        AdTrack.GenericAd.call(this, t, e)
    }, AdTrack.MgidAd.prototype = Object.create(AdTrack.GenericAd.prototype), AdTrack.MgidAd.prototype.constructor = AdTrack.MgidAd, AdTrack.AppnexusAd = function (t, e) {
        AdTrack.GenericAd.call(this, t, e)
    }, AdTrack.AppnexusAd.prototype = Object.create(AdTrack.GenericAd.prototype), AdTrack.AppnexusAd.prototype.constructor = AdTrack.AppnexusAd
}, function (t, e) {
    AdTrack.TextChannel = function (t, e, i) {
        ...
        renderAds: function (t, e) {
            ...
            if ((n = i.options.nativeOptions ? i.options.nativeOptions : n) && (this.validator.setTextMaxLength(n.maxTextLength), this.validator.setTitleMaxLength(n.maxTitleLength), this.validator.setDescriptionMaxLength(n.maxDescLength)), i && i.options && i.options.wrap && i.options.ad) {
                var r;
                for (t.innerHTML = i.options.wrap, r = 0; r < e.getWrapPartsCount(); r++) {
                ...
                for (r = 0; r < Math.min(i.count, e.getAdsCount()); r++) {
                    var a = e.getAd(r);
                    if (a) {
                        var d = this.definition.cls.ad.replace("*", r), c = this.track.getNS(t, d);
                        if (o.length > 0) {
                            var h = this.track.document.createElement("div");
                            o[0].appendChild(h), this.renderAd(h, a, r, i)
                        }
                        c.length > 0 && (this.renderAd(c[0], a, r, i), this.track.clearClass(c, d))
                    }
                }
                this.track.clearClass(o, this.definition.cls.ads), "fuzzyAfter" == this.definition.options.dom.method && this.definition.options.dom.fuzzyStyleize && AdTrack.Utils.styleizeAll(this.track.document, t, this.track.transforms), this.renderGenericAdChoices(t, a), this.renderShop(t, e.getShop(), i), this.renderPromo(t, e.getAdChoices()), this.renderCloser(t), this.renderSlider(t), this.renderDate(t)
            } else this.track.doError("Invalid template for text ad " + this.track.domain + " / " + this.track.group + " / " + this.track.position + " / " + i + " (" + this.track.type + ")")
        }, adClick: function (t, e, i, n, r, s) {
            s = s || [];
            var o, a, d;
            this.track.setOnclick(t, (o = e, a = i, d = n, function (t) {
                var e = AdTrack.Utils.getEventRelativePos(t, this.track.renderer.getContainer());
                t = t || this.track.window.event, this.track.evClick(this.definition, this.chd, e.x, e.y, o, a, d, r), s.forEach((function (t) {
                    (new Image).src = t
                })), this.definition.options.newwindow || (t.preventDefault ? t.preventDefault() : t.returnValue = !1)
            }).bind(this), this.definition.options.newwindow), this.definition.options.hideHref ? this.track.setAttribute(t, "href", "") : this.track.setAttribute(t, "href", n);
            try {
            ...
            for (o.innerHTML = s; o.firstChild;) t.appendChild(o.firstChild);
            var a = new AdTrack.Evaluator,
                d = this.definition.options.nativeOptions ? this.definition.options.nativeOptions : null;
            (d = n.options.nativeOptions ? n.options.nativeOptions : d) && (a.setImgWidth(d.imgWidth), a.setImageHeight(d.imgHeight), a.setTextLength(d.textLength), a.setTitleLength(d.titleLength), a.setDescriptionLength(d.descLength)), r.setEvaluator(a), this.renderGenericAdPart(t, e), this.renderAdPart(t, r, i, n), this.setUpZoomInFeature(t)
            ...
            var i = e.getHeadline(), n = e.getDescription(), r = new AdTrack.TextObj(i, n);
            this.validator.validateTextLengths(r);
            var s = r.getTitle(), o = r.getDescription();
            this.renderValidatedText(t, s, r.getOriginalTitle(), this.definition.cls.headline), this.renderValidatedText(t, o, r.getOriginalDescription(), this.definition.cls.description)
            ...
            }.bind(this)), this.track.clearClass(this.track.setText(i, e.getAdChoices()), this.definition.cls.adChoices), this.definition.options.hideAdChoices && e.adChoicesOptional() && this.track.setAttribute(i, "style", "display: none;")
        }, renderAdPart: function (t, e, i, n) {
            if (AdTrack.TextAd.prototype.isPrototypeOf(e)) {
                this.renderAdScreenshots(e, t, n), this.renderText(e.getText(), t), this.renderClickUrl(e.getClickUrl(), t, i, n, e.getClickTrackers()), this.renderVisibleUrl(e.getVisibleUrl(), t), this.renderAdUrl(e.getAdUrl(), t), this.renderCta(e.getCta(), t), this.renderFavicon(e.getFavicon(), t);
                var r = "sklik" == this.chd.tag || "sklik-hb" == this.chd.tag || "seznam-ssp" == this.chd.tag || "seznam-ssp-hb" == this.chd.tag,
                    s = "mgid-hb-native" == this.chd.tag, o = "xandr-native" == this.chd.tag;
                (r || s || o) && this.renderCompanyName(e.getCompanyName(), t), r && (this.renderLongHeadline(e.getLongHeadline(), t), this.renderLogo(e.getLogoUrl(), t), this.renderSquareLogo(e.getSquareLogoUrl(), t))
            } else AdTrack.ProductAd.prototype.isPrototypeOf(e) ? (this.renderAdScreenshots(e, t, n), this.renderClickUrl(e.getClickUrl(), t, i, n), this.renderProductTemplate(e.getProductName(), e.getProductPrice(), t), this.renderProductName(e.getProductName(), t), this.renderProductDescription(e.getProductDescription(), t), this.renderProductPrice(e.getProductPrice(), t), this.renderProductLastPrice(e.getProductLastPrice(), t), this.renderProductDiscount(e.getProductDiscount(), t), this.renderAdditionalInfo(e.getAdditionalInfo(), t), this.renderProductManufacturer(e.getProductManufacturer(), t), this.renderProductCategory(e.getProductCategory(), t), this.renderFavicon(e.getFavicon(), t)) : this.track.doError("Unsupported ad part.")
        }, setUpZoomInFeature: function (t) {
            this.track.clearClass(this.track.setZoomin(this.track.getNS(t, "AdTrack-zoomin-opacity"), "opacity"), "AdTrack-zoomin-opacity"), this.track.clearClass(this.track.setZoomin(this.track.getNS(t, "AdTrack-zoomin-scale"), "scale"), "AdTrack-zoomin-scale")
        }, renderValidatedText: function (t, e, i, n) {
            var r = this.track.getNS(t, n);
            this.track.setText(r, e.replace("...", "&#8230;")), e.length < i.length && this.track.setAttribute(r, "title", i.replace("&nbsp;", " ")), this.track.clearClass(r, n)
            ...
            if (t) {
                this.validator.validateTextLengths(t);
                var i = t.getTitle(), n = t.getDescription(), r = t.getWhole();
                this.renderValidatedText(e, i, t.getOriginalTitle(), this.definition.cls.creative1), this.renderValidatedText(e, n, t.getOriginalDescription(), this.definition.cls.creative23), this.renderValidatedText(e, r, t.getWholeOriginal(), this.definition.cls.creative123)
            } else this.track.doError("No text provided for " + this.chd.tag + " / " + this.track.domain + " / " + this.track.group + " / " + this.track.position + " (" + this.track.type + ")")
        }, renderAdScreenshots: function (t, e, i) {
            if (t && "function" == typeof t.getScreenshot) for (var n = [this.definition.cls.screenshothq, this.definition.cls.imageUrl, this.definition.cls.screenshot], r = 0; r < n.length; r++) {
                ...
                if (s.length > 0) {
                    t.getScreenshot(n[r] != this.definition.cls.screenshot, function (t, e) {
                        ...
                        n ? (i && i.options && i.options.backgroundImage ? this.track.setAttribute(t, "style", "background-image: url('" + n.url + "');") : (this.track.setAttribute(t, "src", n.url), n.onError && (s = this.track.setAttribute(t, "onerror", n.onError))), this.track.clearClass(t, e)) : this.track.doError("Screenshot not provided for cls " + e + ", " + this.track.domain + " / " + this.track.group + " / " + this.track.position + " (" + this.track.type + ")")
                    }), this, s, n[r]))
                }
            } else this.track.doError("Screenshots cant be retrieved " + this.track.domain + " / " + this.track.group + " / " + this.track.position + " (" + this.track.type + ")")
            ...
            this.definition.options.faviconFallback && (i = this.track.setAttribute(i, "onerror", "this.src='" + this.definition.options.faviconFallback + "'")), this.track.clearClass(this.track.setAttribute(i, "src", t), this.definition.cls.favicon)
        }, renderClickUrl: function (t, e, i, n, r) {
            var s = {a: "image", b: "title", c: "text", d: "banner", e: "ad", f: "url", g: "cta"};
            for (var o in s) {
                var a = s[o], d = this.definition.cls.clickUrl.replace("*", a), c = this.track.getNS(e, d);
                this.adClick(c, i, a, t, n, r), this.track.clearClass(c, d)
            }
            ...
            t = this.definition.options.hideHref ? "#" : t, this.track.clearClass(this.track.setAttribute(this.track.getNS(e, this.definition.cls.adUrl), "href", t), this.definition.cls.adUrl)
            ...
            this.adClick(n, 0, "cta", t, i), this.track.clearClass(n, this.definition.cls.shopUrl)
        }, renderPromo: function (t, e) {
            if (e) {
                var i = this.track.getNS(t, this.definition.cls.promoIcon);
                this.track.setAttribute(i, "src", e.getPromoIcon()), this.track.setAttribute(i, "title", "Reklama"), this.track.clearClass(i, this.definition.cls.promoIcon), this.track.clearClass(this.track.setText(this.track.getNS(t, this.definition.cls.promoTitle), e.getPromoText()), this.definition.cls.promoTitle), this.track.clearClass(this.track.setAttribute(this.track.setAttribute(this.track.getNS(t, this.definition.cls.promoClick), "href", e.getPromoClickUrl()), "target", "_top"), this.definition.cls.promoClick)
            } else this.track.doError("Ad choices not provided" + this.track.domain + " / " + this.track.group + " / " + this.track.position + " (" + this.track.type + ")")
        }, renderCloser: function (t) {
            this.closeHandle = function (t) {
                this.track.renderer.close && ((t = t || this.track.window.event).preventDefault ? t.preventDefault() : t.returnValue = !1, this.track.renderer.close())
            }.bind(this), this.track.clearClass(this.track.setText(this.track.getNS(t, this.definition.cls.closeTitle), "Zavřít reklamu"), this.definition.cls.closeTitle), this.track.clearClass(this.track.setOnclick(this.track.getNS(t, this.definition.cls.closeClick), this.closeHandle), this.definition.cls.closeClick)
        }, renderSlider: function (t) {
            this.track.getNS(t, "AdTrack-slider-wrapper").length > 0 && AdTrack.Slider.create(t)
        }, renderDate: function (t) {
            var e, i, n, r, s, o, a, d, c = (n = new Date, s = function (t) {
                var e = n.getMonth() + 1;
                return t && e < 10 ? "0" + e : "" + e
            }, o = function (t) {
                ...
                h: a(!0, !0),
                H: a(!0, !1),
                i: (i = n.getMinutes(), i < 10 ? "0" + i : "" + i),
                s: (e = n.getSeconds(), e < 10 ? "0" + e : "" + e)
            }, {
            ...
            }.bind(this)), this.track.clearClass(h, this.definition.cls.date)
        }
    }
}, function (t, e) {
    AdTrack.TextAd = function () {
        this.texts = [], this.screenshots = new AdTrack.ImageCollection, this.adUrl = "", this.clickUrl = "", this.visibleUrl = "", this.clickTrackers = [], this.longHeadline = "", this.companyName = "", this.logoUrl = "", this.squareLogoUrl = "", this.cta = "", this.favicon = "", this.evaluator = null
        ...
        this.screenshots = new AdTrack.ImageCollection, this.name = "", this.description = "", this.price = "", this.lastPrice = "", this.discount = "", this.manufacturer = "", this.category = "", this.additionalInfo = "", this.clickUrl = "", this.favicon = "", this.evaluator = null
        ...
        isPositiveInt: function (t) {
            ...
            var i = t.replace(/[&][a-zA-Z]*[;]/g, " ").length, n = [];
            if (t && "string" == typeof t && this.isPositiveInt(e) && i > e) {
                for (var r = (t = function (t) {
                    for (var e = new RegExp(/[&][a-zA-Z]*[;]/g), i = e.exec(t); null != i;) {
                        n.push({index: i.index, value: i[0]});
                        var r = i[0];
                        t = t.replace(new RegExp(r), " "), i = (e = new RegExp(/[&][a-zA-Z]*[;]/g)).exec(t)
                    }
                    return t
                }(t)).slice(0, e - 3); r.match(/\.$/);) r = r.slice(0, r.length - 1);
                return (r = function (t) {
            ...
            if (this.maxl > 0) {
                ...
                e.length <= t.titleLength() + n ? (t.setTitle(e.length <= t.titleLength() ? e + "..." : t.getTitle() + "..."), t.clearDescription()) : (e = (e = e.replace(t.getTitle(), "")).slice(n, e.length), t.setDescription(e + "..."))
        ...
        isPositiveInt: function (t) {
            ...
            if (t && t.length > 0) {
                for (var i = function (t, e, i) {
                    var n = e / i, r = Math.abs(t.getRatio() - n);
            ...
            if (t && t.length > 0) {
                for (var e = function (t, e, i) {
                    var n, r, s = 0;
                    return e < 0 && i < 0 && (e = 30, i = 80), e > 0 && t.titleLength() > 0 && (s += (n = t.titleLength() / e) > 1 ? Math.pow(n, 6) : Math.pow(1 / n, 2)), i > 0 && t.descriptionLength() > 0 && (s += (r = t.descriptionLength() / i) > 1 ? Math.pow(r, 4) : Math.pow(1 / r, 2)), n && r ? s : Number.POSITIVE_INFINITY
                }, i = -1, n = Number.POSITIVE_INFINITY, r = 0; r < t.length; r++) {
                    var s;
                    this.ol > 0 ? (o = t[r], a = this.ol, d = void 0, s = (d = a - (o.titleLength() + o.descriptionLength() + 3)) < 0 ? Math.pow(Math.abs(d), 1.35) : d) : s = e(t[r], this.otl, this.odl), s < n && (n = s, i = r)
                }
                return t[-1 != i ? i : 0]
            }
            var o, a, d;
        ...
        if (this.maxZoomInPercentage = 50, this.url = t, this.onError = n, this.width = e, this.height = i, this.onload = r, 0 == e && 0 == i) {
            var s = new Image;
            s.onload = function (t) {
        ...
        then: function (t) {
            ...
            this.ready = !1, this.screenshots.push(new AdTrack.ScreenshotObj(t, e, i, n, function () {
    ...
    AdTrack.AdformHelper = function (t, e, i) {
        ...
        BANNER: 1, VAST: 2, OUTDOOR: 4, onBidRequest: function () {
            ...
            var r = function (r) {
                var s = r;
                r = r[0];
                var o = null, a = this.getAdData(r, i);
                if (a) {
                    var d = !1;
                    if (i === this.BANNER && (d = AdTrack.Utils.isBlackListedAds(a)), !1 !== d) return this.track.doError("Blocked Adform creative from " + d, "info"), this.chd.logs && this.chd.logs.blocked_creative && AdTrack.Utils.reportCreative(this.track.server, this.chd.logs.blocked_creative, this.chd.tag, r.win_crid || "", r.deal_id || "", r.win_bid, a), null;
                    this.response = r;
                    var c = this.noFPBNs.some((function (t) {
                        return t == r.win_crid
                    }));
                    r.win_cur === this.chd.currency ? (o = AdTrack.Price.create(r.win_bid, this.chd.currency, r.deal_id, c), "DID-811-92131" == r.deal_id && this.track.doError("Deal ID (DID-811-92131) received directly from AdForm channel with price " + r.win_bid + " " + r.win_cur, "debug"), t.setCreativeId(r.win_crid), t.setPrice(o), t.setWidth(r.width), t.setHeight(r.height), this.prebidVideo && (t.setVideoVastXML(a), t.setVideoImpUrl(this.getVideoImpUrl(e)))) : this.track.doError("Channel " + this.chd.tag + " responsed with wrong currency: " + r.win_cur + " instead of: " + this.chd.currency)
                }
                n && n(o, s), this.onBidRequest()
            }.bind(this);
            if ("457593" != e && "610175" != e || this.track.settings.ip && "84.242.121.62" === this.track.settings.ip) {
                var s = this.generateAdxUrl(e, i), o = this;
                AdTrack.Ajax.request({
                    label: "Adform bid",
                    url: s,
                    method: "",
                    ...
                    e ? o.track.evBidTimeout(o.definition, o.chd) : o.track.evBidError(o.definition, o.chd), this.error && o.track.definition.options.hb, n && n(null, null)
                })).send()
            } else r([{}])
            ...
            if (n && (i.mkw = n), "hbbtv" === this.track.environment) {
                var r = this.track.getDeviceId();
                r && (i.adid = r)
            }
            AdTrack.url && ("string" == typeof this.chd.flag && -1 !== this.chd.flag.indexOf("premium") || 1 == this.chd.unmaskedDomain) && (i.url = AdTrack.url), this.chd.currency && (i.rcur = this.chd.currency), this.chd.bidFloor && (i.minp = this.chd.bidFloor);
            var s = this.adformUtils.generateAdxUrl([t], i), o = {};
            if (AdTrack.CMP && (o = AdTrack.CMP.getConsentData("never", !1)), o && (this.track.evBidConsent(this.definition, this.chd), s += (o.gdprApplies ? "&gdpr=true" : "") + (o.consentString ? "&gdpr_consent=" + o.consentString : "")), AdTrack.UserID) {
                var a = {}, d = AdTrack.UserID.getAllUserIdsAsEids();
                d && (a = function (t) {
                    return t.reduce((t, e) => {
                        const i = e.source;
                        return t[i] = t[i] || {}, e.uids.forEach(e => {
                            const n = e.id + "";
                            t[i][n] = t[i][n] || [], t[i][n].push(e.atype)
                        }), t
                    }, {})
                }(d)), a && a !== {} && (s += "&eids=" + encodeURIComponent(AdTrack.Utils.b2a(JSON.stringify(a))))
            }
            return s
            ...
            if (t && t.response) {
                if ("banner" === t.response && e === this.BANNER) return t.banner;
    ...
    AdTrack.RubiconCSync = AdTrack.RubiconCSync || (i = !1, function () {
        if (!i) {
            var t = "https://eus.rubiconproject.com/usync.html", e = null;
            if (AdTrack.CMP && (e = AdTrack.CMP.getConsentData("never", !1)), e) {
    ...
    AdTrack.AdformNAHBChannel = function (t, e, i) {
        this.track = t, this.definition = e, this.chd = i, this.delayTime = 800, this.adformUtils = new AdTrack._AdFormUtils, this.helper = new AdTrack.AdformHelper(t, e, i), this.bidResponse = new AdTrack.Bid
        ...
        report: function () {
            ...
            if (this.data) this.processData(t, this.data, e ? e.normal : null); else {
                ...
                if (i) {
                    var n = function (i) {
                        ...
                        if (n && n.outdoor && n.outdoor.imp) {
                            ...
                            this.ajaxGet(s, {Accept: "text/plain"}, function (n) {
                                var s = n.target.responseText, o = {bn: r, data: i[0].outdoor, data2: s};
            ...
            r.setPromoClickUrl(this.chd.url), r.setPromoText(this.chd.title), r.setOptional(!0), n.addAdChoices(r);
            var s, o = new AdTrack.TextAd;
            for (s = 0; s < e.texts.length; s++) o.addText(e.texts[s].title, e.texts[s].desc);
            for (s = 0; s < e.images.length; s++) {
                var a = e.images[s], d = new Image;
                d.src = a, o.addScreenshot(a, d.width, d.height, a)
            }
            var c = !0 === this.definition.test ? "#" : e.url;
            o.setClickUrl(c), o.setVisibleUrl(""), o.setCta("Navštívit stránku"), o.setFavicon(""), o.done(), n.addAd(new AdTrack.AdformAd(n, o)), new AdTrack.TextChannel(this.track, this.definition, this.chd).renderAds(t, n)
        }, templateR2B2: function (t, e) {
            var i, n, r, s = e || [];
            if (t.nadpis && t.popisek1 && t.popisek2) return i = t.nadpis, n = t.popisek ? t.popisek : t.popisek1 + " " + t.popisek2, s.push({
                title: i,
                description: n
            }), s;
            for (r in e = {}, t) if (t.hasOwnProperty(r) && r.match(/(nadpis|popisek)_[0-9]*$/)) {
                var o = r.split("_")[1], a = r.split("_")[0];
                e[o] = e[o] ? e[o] : {}, e[o][a] = t[r]
            }
            for (r in e) e.hasOwnProperty(r) && (i = e[r].nadpis ? e[r].nadpis : t.nadpis ? t.nadpis : null, n = e[r].popisek ? e[r].popisek : t.popisek ? t.popisek : null, i && n && s.push({
                title: i,
                description: n
            }));
            return s
            ...
            var i, n, r = e || [], s = [], o = [];
            for (var a in t) t.hasOwnProperty(a) && a.match(/title_(short|medium|long)$/) && "" != t[a] && s.push(t[a]), t.hasOwnProperty(a) && a.match(/description_(short|medium|long)$/) && "" != t[a] && o.push(t[a]);
            for (var d = 0; d < s.length; d++) {
                i = s[d];
                for (var c = 0; c < o.length; c++) n = o[c], r.push({title: i, description: n})
            }
            return r
            ...
            this.count = 1, this.adData = {data: t.data, data2: s, baseUrl: r, images: n};
            var o = new AdTrack.AdSet;
            o.setStyle(i);
            var a = new AdTrack.AdChoices;
            a.setPromoClickUrl(this.chd.url), a.setPromoText(this.chd.title), a.setOptional(!0), o.addAdChoices(a);
            var d = new AdTrack.TextAd, c = [];
            ...
            for (var u = 0; u < n.length; u++) {
                var p = r + n[u].file, f = new Image;
                f.src = p, d.addScreenshot(p, f.width, f.height, p)
            }
            var g = s.ctaPopisek ? s.ctaPopisek : "Navštívit stránku", m = s.viditelnaURL ? s.viditelnaURL : "",
                k = s.landingPage ? s.landingPage : "", v = !0 === this.definition.test ? k : t.data.clk;
            d.setClickUrl(v), d.setVisibleUrl(m), d.setAdUrl(k), d.setCta(g), d.setFavicon(""), d.done(), o.addAd(new AdTrack.AdformAd(o, d)), new AdTrack.TextChannel(this.track, this.definition, this.chd).renderAds(e, o);
            var b = this.track.window.document.createElement("img");
            return b.setAttribute("src", t.data.imp), b.setAttribute("style", "width: 0px; height: 0px; border-style: none; display: none;"), e.appendChild(b), !0
        }, ajaxGet: function (t, e, i) {
            e || (e = {});
            var n = new XMLHttpRequest;
            for (var r in n.open("GET", t, !0), e) e.hasOwnProperty(r) && n.setRequestHeader(r, e[r]);
            return n.addEventListener("load", "function" == typeof i ? i : function () {
            }), n.onerror = function () {
                this.track.passback(this.definition, this.chd)
            }.bind(this), n.ontimeout = function () {
                this.track.passback(this.definition, this.chd)
            }.bind(this), n.timeout = this.delayTime, n.send(), n
    ...
    AdTrack.KeyValTargeting = function () {
        var t = {}, e = function (t, e) {
            ...
            for (var n in t.customTargeting) if (t.customTargeting.hasOwnProperty(n)) try {
                var r = t.customTargeting[n];
                if ("object" == typeof r) {
                    if (!r.type || !r.val) continue;
                ...
                s && (t[s] || ("adform" === s ? t[s] = (r = !1, {
                    init: function () {
                        ...
                        window.adformtag = window.adformtag || [], adformtag.push((function () {
                            adformtag.setPrice(r.unitId, n), adformtag.setCustomData(r.unitId, r.adIdKey, t), e(r.adIdKey, t), i(r, n, (function (t, i) {
                                adformtag.setTargeting(r.unitId, t, i), e(t, i)
                            }))
                        }))
                    }
                }) : "dfp" === s ? t[s] = function () {
                    ...
                    return {
                        init: function () {
                            ...
                            var s;
                            (AdTrack.Log.debug("AdServer", "DFP set targeting", AdTrack.Log.INFO), window.googletag = window.googletag || {}, googletag.cmd = googletag.cmd || [], "function" == typeof window.googletag.pubads && "function" == typeof window.googletag.pubads().getSlots) && (window.googletag.pubads().getSlots().forEach((function (o) {
                                r.unitId !== o.getAdUnitPath() && r.unitId !== o.getSlotElementId() || (s = !0, AdTrack.Log.debug("AdServer", "DFP targeting slot: " + r.unitId, AdTrack.Log.INFO), o.setTargeting(r.adIdKey, t), e(r.adIdKey, t), i(r, n, (function (t, i) {
                                    o.setTargeting(t, i), e(t, i)
                                })))
    ...
    AdTrack.hb = AdTrack.hb || (i = AdTrack.KeyValTargeting(), n = !1, r = !1, s = {}, o = [], a = 4e3, d = !0, c = 0, h = 0, l = {}, u = function (t, e) {
        Math.floor(1e5 * Math.random());
        var i = !1, n = t, r = AdTrack.Utils.time(), s = e, o = null, a = {
            call: function () {
                clearTimeout(o), i = !0, n()
            }, reschedule: function (t) {
                if (s !== t && !i) {
                    clearTimeout(o);
                    var e = AdTrack.Utils.time() - r;
                    t <= e ? a.call() : (s = t - e, o = setTimeout((function () {
                        a.call()
                    }), s))
                }
            }
        ...
        e = e || m(t), s[t].length > 0 && (s[t].forEach((function (t) {
            t(e)
        })), s[t] = [])
    }, m = function (t) {
        if (!l[t]) return [];
        ...
        for (var r in e) if (e.hasOwnProperty(r)) {
            var s = 0, o = [];
            if (e[r].adID) e[r].price && (s = e[r].price, o.push(e[r])); else {
                var a = 0;
                for (var d in e[r]) e[r].hasOwnProperty(d) && e[r][d].adID && e[r][d].price && (a += e[r][d].price, o.push(e[r][d]));
                s = a
            }
            s > n && (n = s, i = o)
        }
        ...
        if (!r) {
            for (var t in AdTrack.Log.debug("HB", "Notify adserver", AdTrack.Log.INFO), r = !0, l) if (l.hasOwnProperty(t)) {
                var e = m(t);
                e.forEach((function (t) {
                    t.targeting && t.setTargeting && t.price > 0 && (AdTrack.Log.debug("HB", "Set targeting for " + t.adID + ", bid cpm: " + t.price, AdTrack.Log.INFO), i.setTargeting(t.adID, t.price, t.targeting))
                })), g(t, e, !1)
            }
            n && i.init(), d = !1
        }
        ...
        isRunning: function () {
            ...
            d && (n = null);
            var h = {adID: t, finished: !1, price: 0, targeting: r, isBranding: !!o, setTargeting: !!a, dgpmMapping: d},
                u = p(l, e);
            (n ? p(u, n) : u)[t] = h, s[e] || (s[e] = []), i && r && i.addServer(r), c++
        }, bidResponse: function (t, e, i, n, r, s, o, a) {
            if (l[n] && (!r || l[n][r])) {
                var d = (r ? l[n][r] : l[n])[i];
                d && (t || 0 === t) && (d.finished = !0, d.price = parseFloat(t), d.currency = e, d.dealId = s, d.response = o, d.options = a || {}, h++), d.dgpmMapping ? g(n, [d], !1) : f() && (AdTrack.Log.debug("HB", "Bids back: [" + h + ", " + c + "]", AdTrack.Log.INFO), k())
            }
        }, useAdServerInitialisation: function (t) {
            n = !0, t && t > 0 && setTimeout((function () {
                r || k()
            }), t)
            ...
            if ("function" == typeof e) {
                ...
                i || !AdTrack.Config.getHBDomain() ? "function" == typeof e && (l[t] || (l[t] = {}, s[t] || (s[t] = [])), f() || i && l[t][t] && l[t][t].finished ? e(m(t)) : (s[t].push(e), o.push(new u((function () {
                    !i || l[t][t] && l[t][t].finished ? g(t, m(t), !0) : AdTrack.call(t, "hbAuctionTimeout")
                }), a)))) : e([])
            }
        }, getCPM: function (t) {
            var e = m(t), i = 0;
            return e && e.length > 0 && (i = e[0].price), i
        }
    })
}, function (t, e) {
    !function () {
        ...
        f.que = f.que || [], AdTrack.Prebid = AdTrack.Prebid || (e = AdTrack.XhrReport.getPrebidReport(AdTrack.Config.getReportingUrl(), AdTrack.Config.getHBDomain()), i = null, r = function (t, e, i, r) {
            "Prebid" === t && i === AdTrack.Log.ERROR && n(e, r)
        }, s = {}, o = {}, a = function (t) {
            var e;
            return t && o[t] && (e = o[t].shift()), e || AdTrack.Utils.time()
        }, {
            error: n = function (t, e, n) {
                i || (i = AdTrack.Utils.errorReporting(AdTrack.Config.getReportingUrl(), AdTrack.url, !0)), i.doError(t, e, n)
                ...
                e && s[e] ? (s[e].done = !0, s[e].timeouted || AdTrack.call(e, "evPbjNoBid", t, a() - AdTrack.startTime)) : r("Prebid", "Cant log No Bid, key " + e + " is not registered", AdTrack.Log.ERROR)
            }, bidDone: function (t, e, i) {
                e && s[e] ? (s[e].done = !0, AdTrack.call(e, "evPbjBidDone", t, i)) : r("Prebid", "Cant finish bid, " + e + " is not registered", AdTrack.Log.ERROR)
            }, registerEvents: function () {
                f.que.push((function () {
                    f.onEvent("bidRequested", l), f.onEvent("bidResponse", c), f.onEvent("auctionEnd", h), f.onEvent("bidWon", d), f.onEvent("auctionInit", u), f.onEvent("bidTimeout", p)
                }))
            }, evBidRequested: l = function (t) {
                try {
                    var i = t.bidder || t.bidderCode, n = a("evBidRequested");
                    t.bids.forEach((function (t) {
                        ...
                        } else e.prebidBidRequest(r, i, n - AdTrack.startTime)
                    }))
                } catch (t) {
                ...
                try {
                    var i = t.bidder || t.bidderCode, n = t.adUnitCode || t.placementCode, o = a("evBidResponse");
                    if ("r2b2" === i) {
                        var d = AdTrack.Utils.getDGPMKey(t), c = t.ext && t.ext.start;
                        ...
                        var h = null;
                        t.responseTimestamp && t.requestTimestamp && (h = t.responseTimestamp - t.requestTimestamp), e.prebidBid(n, i, o - AdTrack.startTime, t.cpm, t.currency, h)
                    }
                } catch (t) {
                ...
                try {
                    ...
                    !function (t) {
                        for (var e in s) s.hasOwnProperty(e) && (s[e].done || (s[e].timeouted = !0, AdTrack.call(e, "evPbjTimeout", s[e].adUnit, t - AdTrack.startTime)))
                    }(t), f.getHighestCpmBids().forEach((function (i) {
                        var n = i.bidder || i.bidderCode, r = i.adUnitCode || i.placementCode;
                        if ("r2b2" === n) {
                            var s = AdTrack.Utils.getDGPMKey(i);
                            AdTrack.call(s, "evPbjWin", r, t - AdTrack.startTime, i.cpm, i.currency)
                        } else e.prebidWin(r, n, t - AdTrack.startTime, i.cpm, i.currency)
                    }))
                } catch (t) {
                ...
                try {
                    var i = t.bidder || t.bidderCode, n = t.adUnitCode || t.placementCode, s = a("evBidWon");
                    if ("r2b2" === i) {
                        var o = AdTrack.Utils.getDGPMKey(t);
                        AdTrack.call(o, "evPbjLoad", n, s - AdTrack.startTime, t.cpm, t.currency)
                    } else e.prebidLoad(n, i, s - AdTrack.startTime, t.cpm, t.currency)
                } catch (t) {
                    ...
                    i && i.length > 0 && i.forEach((function (t) {
                        if (t) {
                            ...
                            t.bids.forEach((function (t) {
                                ...
                                try {
                                    if (Array.isArray(n)) r("Prebid", "adUnitCode or placementCode in adunit config is array, instead of string", AdTrack.Log.ERROR); else if ("r2b2" === i) {
                                        var s = AdTrack.Utils.getDGPMKey(t);
                                        AdTrack.call(s, "evPbjInAuction", n)
                                    } else e.prebidInAuction(n, i)
                                } catch (t) {
                                }
                            }))
                        }
                ...
                console.log("HEEEEEEEEEEEEEEEEEEEEEEY BID TIMEOUT!!! ", t);
                try {
                    if (AdTrack.Prebid.timeouts) {
                        var i = a("evBidTimeout");
                        t.forEach((function (t) {
                            var n = t.adUnitCode || t.placementCode, r = t.bidder || t.bidderCode;
            ...
            t.AdTrack.PrebidAdapter && !t.AdTrack.PrebidAdapter.cmdQueue || (t.AdTrack.PrebidAdapter = function (e) {
                ...
                i.execute = function (t, e) {
                    o("Prebid", "Executed ad source, id: " + t, AdTrack.Log.INFO), "function" == typeof r[t] ? r[t](e) : o("Prebid", "Callback not found", AdTrack.Log.WARNING)
                ...
                var s = function (t) {
                    ...
                    var i = "", n = function (t) {
                        var e = null;
                        try {
                            if ("string" != typeof t) return o("Prebid", "[" + i + "] Provided selector is not a string", AdTrack.Log.ERROR), null;
                    ...
                    return {
                        url: "//", render: function (r) {
                            ...
                            var s = function (t) {
                                ...
                                var d = null;
                                return !(d = void 0 !== s && n(s) || n(r)) && r && (d = n("#google_ads_iframe_" + e + "_0__container__")), d
                            }(r);
                ...
                if (i.callBids = function (e, i, c, h, l, u) {
                    ...
                    try {
                        ...
                        var m = e.bids.length, k = 0;
                        e.bids.forEach((function (e) {
                            var n = AdTrack.Utils.getDGPMKey(e), s = a(e);
                            s || o("Prebid", "Unable to notify prebid - unit code not found", AdTrack.Log.ERROR), AdTrack.Prebid.bidCall(s, n), AdTrack.hb.getHighestBidForAdUnit(e.params, (function (a) {
                                try {
                                    if (AdTrack.Prebid.bidDone(s, n, AdTrack.Utils.time() - g), "function" == typeof l && l("r2b2"), a && a.length > 0) {
                                        var h = a[0];
                                        if (!h.adID) return void o("Prebid", "[" + n + "] Missing adID", AdTrack.Log.ERROR);
                                        if (h.price) {
                                            var u, p, v, b;
                                            if (v = b = 0, h.options && h.response) {
                                                if (h.options.sendDimension) {
                                                    var y = h.response.getDimension();
                                                    b = y.width, v = y.height
                                                }
                                                h.options.video && (u = h.response.getVideoVastXML(), p = h.response.getVideoImpUrl())
                                            }
                                            var A = "r2b2-prebid-" + e.bidId;
                                            r[A] = function (e) {
                                                try {
                                                    if (e !== t) o("Prebid", "[" + n + "] Ad source executed in different window.", AdTrack.Log.ERROR); else {
                                                        var i = t.document, r = i.querySelector("script#" + A),
                                                            a = i.createElement("div");
                                                        a.setAttribute("id", A + "-ad"), r.parentNode.insertBefore(a, r), AdTrack.call(n, "displayAd", "#" + A + "-ad", s)
                                                    }
                                                } catch (t) {
                                            ...
                                            u && p && (T.vastXml = u, T.vastImpUrl = p, T.mediaType = "video", T.renderer = null), f.que.push((function () {
                                                try {
                                                    var t = function (t, e) {
                                                        try {
                    ...
                    return {
                        supportedMediaTypes: ["banner", "video", "native"], onTimeout: function (t) {
                            t && t.forEach((function (t) {
                                if (t.params) {
                                    var e = a(t);
                                    t.params.forEach((function (t) {
                                        var i = AdTrack.Utils.getDGPMKey({params: t});
                    ...
                    c.length > 0 && c.forEach((function (t) {
                        "function" == typeof i[t.method] && (n[t.method] = t.time, AdTrack.Prebid.addTime(t.method, t.time), i[t.method].apply(i, t.args))
                    })), i.cmdQueue = null
                } else f.que.push((function () {
    ...
    AdTrack.MediaTypes = AdTrack.MediaTypes || {
        ...
        this.id = "adtrack-ad-" + Math.floor(1e4 * Math.random()), this.data = t || {}, this.preloaded = t.preload, this.debug = !!t.debug, this.externalRender = t.externalRender, this.passedResponse = null, this.errorReporting = e, this.errorStatus = !1, this.rendered = !1, this.passbackReason = "", this.events = AdTrack.Events.create(["load", "adLoad", "error", "close", "click", "end", "beforeRender"]), this.events.markEventAsTriggerOnce("load"), this.events.markEventAsTriggerOnce("adLoad"), this.events.markEventAsTriggerOnce("error"), this.events.markEventAsTriggerOnce("close"), this.events.markEventAsTriggerOnce("end")
        ...
        on: function (t, e) {
            ...
            if ("function" == typeof this.handleRender) {
                if (this.validate(), !this.errorStatus && !this.rendered) {
                    if (this.trigger("beforeRender", [t]), this.rendered = !0, this.data.wrapAd) {
                        var e = document.createElement("div");
                        t.appendChild(e), t = e
                    }
                    this.handleRender(t), this.loaded()
                }
            } else this.error("No handler for render")
        }, preload: function (t) {
            ...
            } else this.error("No handler for preload")
        }, validate: function () {
            ...
            if (!this.errorStatus) {
                ...
                })), this.data.jsTrackers && this.element) try {
            ...
            this.errorStatus = !0, t && this.errorReporting.doError(t), this.trigger("error")
        }, close: function () {
            this.trigger("close")
        }, destroy: function () {
        }
    ...
    AdTrack.MediaTypes.Banner = function (t, e) {
        ...
        return this.data.externalRender ? "content" === this.data.ad.type ? e = AdTrack.iframeCreator.factory.createIframeWithContent(t, 0, 0, window.location.href, this.data.ad.data, null) : "function" === this.data.ad.type && "function" == typeof this.data.ad.data && (e = document.createElement("div"), t.appendChild(e), e.style.width = "0px", e.style.height = "0px", this.data.ad.data(e)) : "content" === this.data.ad.type ? e = AdTrack.iframeCreator.factory.createIframeWithContent(t, this.data.width, this.data.height, window.location.href, this.data.ad.data, i, this.data.fluid) : "iframe" === this.data.ad.type ? e = AdTrack.iframeCreator.factory.createIframeFromHTML(t, this.data.ad.data, i) : "function" === this.data.ad.type && "function" == typeof this.data.ad.data ? (e = document.createElement("div"), t.appendChild(e), e.style.width = this.data.fluid ? "100%" : this.data.width + "px", e.style.height = this.data.fluid ? "auto" : this.data.height + "px", this.data.ad.data(e)) : this.error("Banner: ad type '" + this.data.ad.type + "' not supported."), null === e && this.error("Banner: Error while creating iframe"), this.element = e, e
    }, i.handlePreload = function (t) {
        var e = null, i = null, n = function () {
            ...
            r && function (t) {
                try {
                    ...
                    if (i.length > 0) for (var n = 0; n < i.length; n++) {
                        var r = i[n];
                        if (r.clientWidth > 1 || r.clientHeight > 1 || r.getAttribute("width") > 1 || r.getAttribute("height") > 1) return !0
                    }
    ...
    AdTrack.MediaTypes.Video = function (t, e) {
        ...
        if (this.data.externalRender) this.element = AdTrack.iframeCreator.factory.createIframeWithContent(t, this.data.width || 0, this.data.height || 0, window.location.href, this.data.ad.data, null), null === this.element && this.error("Video: Error while creating iframe"); else {
            ...
            }.bind(this)), i.on("start", function () {
                e = !0, this.events.trigger("load")
            }.bind(this)), i.on("skip", function () {
                this.close()
            }.bind(this)), i.on("error", function () {
                if (e) this.destroy(); else {
                    var t = i.getFrame();
                    t.parentNode.removeChild(t)
                }
                this.error()
            }.bind(this)), i.play(), this.player = i, this.element = i.getFrame()
        }
    }, i.handlePreload = function (t) {
        this.handleRender(t), this.data.preload.func && "function" == typeof this.data.preload.func && this.data.preload.func()
    }, i.destroy = function () {
        this.player.dispose()
    }
}, function (t, e) {
    ...
    AdTrack.MediaTypes.Native = function (t, e) {
        ...
        return t.ad ? (t.ad.type || this.error("Native: Undefined type"), t.ad.data || this.error("Native: Undefined data")) : this.error("Native: Undefined ad source"), t.count || this.error("Native: Missing count"), t.style || this.error("Native: Missing style"), t
    }, i.getElement = function () {
        return this.element
    }, i.handleRender = function (t) {
        this.element = t, "tcproxy" === this.data.ad.type ? this.data.ad.data.tc.renderAds(t, this.data.ad.data.adSet) : this.error("Native: ad type '" + this.data.ad.type + "' not supported.")
    }, i.handlePreload = function (t) {
        this.handleRender(t)
    }
}, function (t, e) {
    var i, n, r, s, o, a, d, c, h, l;
    AdTrack.Ext = AdTrack.Ext || (i = [], n = !1, r = [], s = {}, o = "true" === AdTrack.Utils.getParameterByName("adtrack-debug") || AdTrack.Utils.getLocalStorageItem("adtrack-debug"), a = function (t) {
        ...
        (d = new MessageChannel).port1.onmessage = function (t) {
            if ("adtrack" === t.data) {
                var e = t.ports[0];
                n = !0, r.push(e), i.forEach((function (t) {
                    e.postMessage(t)
                }))
            } else n && function (t) {
                var e = t.data.command, i = t.data.data;
                if ("highlight" === e) AdTrack.call(i.placement, e, i.hide); else if ("bid:getBidResponse" === e) {
                    ...
                    if (n) {
                        ...
                        try {
                            ...
                            r = o.response || o.response1 || null, s = o.bidResponse || null
                        } catch (t) {
                        }
                        a({
        ...
        if (n || h >= 3) clearInterval(l); else try {
            h++, c()
        } catch (t) {
        }
    }), 1e3), s.sendResponse = function (t, e, i, n, r) {
        t && e && n && a({
            command: "response",
            data: {placement: "" + t, channel: i ? e + "#" + i : e, response: n, style: r}
        })
    }, o && "function" == typeof AdTrack.Log.extensionDump && setInterval((function () {
        a({command: "adtrack-debug-dump", data: AdTrack.Log.extensionDump()})
    }), 1e3), s)
}, function (t, e) {
    ...
    !function () {
        ...
        var e = function () {
            var t = null, e = !1, i = null, n = null, r = null, s = !1, o = !1, a = [], d = !1, c = "", h = null,
                l = null, u = !1, p = AdTrack.XhrReport.getGenericReport(AdTrack.Config.getReportingUrl()),
                f = function () {
                    ...
                    if ("function" == typeof i) {
                        ...
                        i("getTCData", n = 2, s), u || (i("addEventListener", n, s), u = !0)
                    } else if ("function" == typeof e) d = !0, n = 1, e("getConsentData", null, t); else {
                        for (var o = window, a = null; !a;) {
                            try {
                                o.frames.__tcfapiLocator && (a = o, n = 2)
                            } catch (t) {
                            }
                            try {
                                o.frames.__cmpLocator && (a = o, n = 1)
                            } catch (t) {
                            }
                        ...
                        1 === n ? function (t, e, i) {
                            function n(t) {
                                var e, i, n,
                                    s = "string" == typeof t.data && (e = t.data, i = "cmpReturn", n = new RegExp(".*" + i + ".*"), "string" == typeof e && "string" == typeof i && n.test(e)) ? JSON.parse(t.data) : t.data;
                                if (s.__cmpReturn && s.__cmpReturn.callId) {
                                    var o = s.__cmpReturn;
                                    void 0 !== r[o.callId] && (r[o.callId](o.returnValue, o.success), delete r[o.callId])
                                }
                            }

                            window.__cmp = function (t, i, n) {
                                var s = Math.random() + "", o = {__cmpCall: {command: t, parameter: i, callId: s}};
                                r[s] = n, e.postMessage(o, "*")
                            }, window.addEventListener("message", n, !1), window.__cmp(t, null, (function (t) {
                                window.removeEventListener("message", n, !1), i(t)
                            }))
                            ...
                            function s(t) {
                                ...
                                i && "function" == typeof r[i.callId] && (r[i.callId](i.returnValue, i.success), delete r[i.callId])
                            }

                            window.__tcfapi = function (t, e, n, s) {
                                var o = Math.random() + "",
                                    a = {__tcfapiCall: {command: t, parameter: s, version: e, callId: o}};
                                r[o] = n, i.postMessage(a, "*")
                            }, window.addEventListener("message", s, !1), window.__tcfapi(t, e, (function (t) {
                                window.removeEventListener("message", s, !1), n(t)
                            }))
                        }("getTCData", n, a, t)
                    }
                }, m = function () {
                    ("done" !== i || "done" === i && o) && (i = "done", clearInterval(h), clearTimeout(l), t && p.cmpSuccess(c, s, r))
                }, k = function (t, i, n) {
                    b(t) ? (A(t), (e = y()) && (r = 1, c = n, m(), i())) : T("Invalid CMP format")
                }, v = function (i, n, s) {
                    b(i) ? (A(i), (e = y()) && ("iab" === s && AdTrack.Utils.setLocalStorageItem("AT-euconsent-v2", JSON.stringify(t)), r = 2, c = s, m(), n())) : T("Invalid CMP format")
                }, b = function (t) {
            ...
            return function (t) {
                if (y()) t(); else {
                    var e = function (r) {
                            1 === n ? k(r, t, "iab") : v(r, t, "iab"), "done" !== i && setTimeout((function () {
                                g(e)
                            }), 100)
                        }, r = function () {
                            d || g(e)
                        ...
                        u = AdTrack.Utils.readCookie("eupubconsent-v2"), p = null;
                    try {
                        p = JSON.parse(a)
                    } catch (t) {
                    }
                    if (a && p ? v(p, t, "cookie") : (c || u) && v({
                        gdprApplies: !0,
                        tcString: u || c
                    }, t, "cookie"), "done" === i && setTimeout(r, 5e3), !h && "done" !== i) {
                        h = setInterval(r, 100), l = setTimeout((function () {
                            m(), o = !0
                        }), 1e4);
                        var b = setTimeout((function () {
                            "done" !== i && (s = !0, f()), clearTimeout(b)
                        }), 1e3)
                    }
                }
            }(f), w
    ...
    AdTrack.Player = function (t, e, i, n, r) {
        this.fp = null, this.iframe = null, this.container = t, this.onload = [], this.playing = !1, this.init(t, e, i, n, r)
        ...
        getContainer: function () {
            ...
            try {
                ...
                this.iframe = a.element, this.iframe.contentWindow.addEventListener("load", function () {
    ...
    AdTrack.BrandingRenderer = function (t, e, i, n) {
        this.track = t, this.definition = e, this.transforms = i, this.events = n, this.container = null, this.brandingMinWidth = 1200, this.brandingMaxScroll = 160
    }, AdTrack.BrandingRenderer.prototype = {
        render: function (t, e) {
            if (this.animator = null, this.container = this.track.container, this.channel = t, "rubicon-banner-hb" !== this.channel.chd.tag) {
                this.container.style.width = "1px", this.container.style.height = "1px", this.container.style.overflow = "hidden";
                this.track.document.documentElement.scrollWidth, AdTrack.Utils.getViewportRealWidth(this.track.window)
            }
            ...
            var e = this.definition.options.noStacking, i = 0;
            if (this.definition.options.mainZIndex && (i = this.definition.options.mainZIndex), t.data.width) {
                ...
                try {
                    if (this.definition.options.main) {
                        ...
                        if (n) {
                            if (e || (this.transforms.styleElement(n, "position", "relative"), this.transforms.styleElement(n, "z-index", i)), this.definition.options.setZIndex) {
                                var r = this.definition.options.setZIndex;
                                for (var s in r) if (r.hasOwnProperty(s)) {
                                    var o = isNaN(s) ? s : r[s], a = isNaN(s) ? r[s] : i;
                                    if (o) {
                                        var d = this.track.document.querySelector(o);
                                        d && (this.transforms.styleElement(d, "z-index", a, "important"), "static" == this.getStyleProperty(d, "position") && this.positioningNotSet(d) && this.transforms.styleElement(d, "position", "relative"))
                                    }
                                }
                            }
                            this.definition.options.mainMarginTop && this.transforms.styleElement(n, "margin-top", this.definition.options.mainMarginTop + "px"), this.definition.options.mainForceWidth && (this.transforms.styleElement(n, "max-width", this.definition.options.mainForceWidth + "px"), this.transforms.styleElement(n, "margin-left", "auto"), this.transforms.styleElement(n, "margin-right", "auto")), this.transforms.styleElement(this.container, "display", "block")
                        } else this.track.doError("Unknown main branding selector " + this.definition.options.main)
                    }
                } catch (t) {
                    this.track.doError("Branding error (" + t + ")")
                }
            } else this.track.doError("Undefined width")
        }, isReadyToShow: function (t) {
            return !0
        }, measureImpress: function (t, e) {
            var i = this.track.window, n = i.document, r = function () {
                var s = void 0 !== i.pageXOffset, o = "CSS1Compat" === (n.compatMode || ""),
                    a = s ? i.pageYOffset : o ? n.documentElement.scrollTop : n.body.scrollTop;
                if (n.documentElement.clientWidth >= this.brandingMinWidth || a <= this.brandingMaxScroll) try {
                    var d = t.getBoundingClientRect();
                    if ("width" in d && !d.width) p = null; else var c = d.right - d.left, h = d.bottom - d.top,
                        l = AdTrack.Utils.getViewportRealWidth(i), u = AdTrack.Utils.getViewportRealHeight(i),
                        p = Math.max(0, Math.min(d.right, l) - Math.max(d.left, 0)) * Math.max(0, Math.min(d.bottom, u) - Math.max(d.top, 0)) / (c * h);
                    AdTrack.Utils.removeEvent(i, "resize", r), AdTrack.Utils.removeEvent(i, "scroll", r), e(t, p)
                } catch (t) {
                }
            }.bind(this);
            AdTrack.Utils.addEvent(i, "resize", r), AdTrack.Utils.addEvent(i, "scroll", r), r()
        }, getContainer: function () {
            return this.container
        }, createContainer: function (t) {
            return this.container || (this.container = t), this.container
            ...
            return this.track.window.getComputedStyle ? (e = e.replace(/([A-Z])/g, "-$1").toLowerCase(), this.track.window.getComputedStyle(t, null).getPropertyValue(e)) : t.style[e]
        }, positioningNotSet: function (t) {
            var e = this.getStyleProperty(t, "top"), i = this.getStyleProperty(t, "bottom"),
                n = this.getStyleProperty(t, "left"), r = this.getStyleProperty(t, "right");
            return !("auto" != e && "0px" != e || "auto" != i && "0px" != i || "auto" != n && "0px" != n || "auto" != r && "0px" != r)
        }
    }
}, function (t, e) {
    AdTrack.InterScrollRenderer = function (t, e, i, n) {
        this.track = t, this.definition = e, this.transforms = i, this.events = n, this.channel = null, this.container = null, this.channel = null, this.renderedChannel = null, this.isLoaded = !1, this.width = 0, this.height = 0, this.realWidth = 0, this.realHeight = 0, this.viewportWidth = 0, this.landscape = !1, this.c = null, this.wrap = null, this.clipper = null, this.banner = null, this.resizeListener = function () {
            this.isReadyToShow() && this.events.trigger("ready"), this.isLoaded && this.setUp()
        }.bind(this), AdTrack.BrowserFlags.isPhone ? this.track.addEvent(this.track.window, "orientationchange", this.resizeListener) : this.track.addEvent(this.track.window, "resize", this.resizeListener)
    }, AdTrack.InterScrollRenderer.prototype = {
        getContainer: function () {
            return this.container
        }, createContainer: function (t) {
            return this.container || (this.c = this.track.document.createElement("div"), this.wrap = this.track.document.createElement("div"), this.clipper = this.track.document.createElement("div"), this.banner = this.track.document.createElement("div"), this.adNoticeTop = this.track.document.createElement("div"), this.adNoticeBot = this.track.document.createElement("div"), this.c.appendChild(this.wrap), this.wrap.appendChild(this.adNoticeTop), this.wrap.appendChild(this.clipper), this.wrap.appendChild(this.adNoticeBot), this.clipper.appendChild(this.banner), t.appendChild(this.c), this.banner.style.display = "none", this.container = this.banner), this.container
            ...
            if (this.width && this.height) {
                var t = 720 == this.width && 1280 == this.height,
                    ...
                    i = AdTrack.Utils.getViewportRealHeight(this.track.window), n = e > i;
                if (this.viewportWidth === e && n === this.landscape) return;
                if (this.viewportWidth = e, this.landscape = n, e > i) return void this.hide();
                var r = e / this.width, s = i / this.height, o = Math.max(r, s);
                t || (o = Math.min(r, s)), this.realWidth = this.width * o, this.realHeight = this.height * o, this.show();
                var a = function (t, e) {
                        return (t - e) / 2
                    }, d = a(e, this.realWidth), c = a(i, this.realHeight),
                    h = (y = this.definition.options.interscrollerVerticalLimit, (y = parseInt(y, 10)) && !isNaN(y) ? y < 50 ? .5 : y > 100 ? 1 : .01 * y : 1),
                    l = this.definition.options.interscrollerHideAdNotice, u = 0, p = null;
                try {
                    p = this.c.getBoundingClientRect()
                } catch (t) {
                }
                p && (u = -p.left);
                var f = Math.round(.025 * i), g = Math.round(.65 * f), m = i * h;
                l || (m += 2 * f);
                var k = this.definition.options.interscrollerBackground ? this.definition.options.interscrollerBackground : "black";
                this.c.setAttribute("style", "display: block; width: auto; height: " + m + "px; position: relative; z-index: 0; "), this.wrap.setAttribute("style", "display: block; width: " + e + "px; height:" + m + "px; position: absolute; top: 0; left:" + u + "px; overflow: hidden; box-shadow: 0px 0 4px 0px; background: " + k + ";"), this.clipper.setAttribute("style", "display: block; width: 100%; height: 100%; position: absolute; top: 0; left: 0; overflow: hidden; clip-path: inset(0px); clip: rect(0px auto auto 0px);"), this.banner.setAttribute("style", "display: block; width: " + this.width + "px; height: " + this.height + "px; position: fixed; top: " + c + "px; left: " + d + "px; transform: translateZ(0px); max-width: initial; max-height: initial;"), this.adNoticeTop.setAttribute("style", "background: black; color: white; position: absolute; z-index: 4; top: 0px; left: 0px; right: 0px; width: auto; margin: 0px; display: block; padding: 0; text-align: center; text-transform: uppercase; font-style: normal; font-variant: normal; font-weight: normal; font-stretch: normal; font-size: " + g + "px; line-height: " + f + "px; font-family: Helvetica, Arial, sans-serif; box-shadow: black 0px 1px 10px;"), this.adNoticeBot.setAttribute("style", "background: black; color: white; position: absolute; z-index: 4; bottom: 0px; left: 0px; right: 0px; width: auto; margin: 0px; display: block; padding: 0; text-align: center; text-transform: uppercase; font-style: normal; font-variant: normal; font-weight: normal; font-stretch: normal; font-size: " + g + "px; line-height: " + f + "px; font-family: Helvetica, Arial, sans-serif; box-shadow: black 0px 1px 10px;");
                var v = this.definition.options.fixedShowAdNotice ? this.definition.options.fixedShowAdNotice : "Reklama";
                this.adNoticeTop.innerHTML = v, this.adNoticeBot.innerHTML = v, l && (this.adNoticeTop.style.display = "none", this.adNoticeBot.style.display = "none");
                var b = "scale(" + o + ")";
                this.banner.style.webkitTransform = b, this.banner.style.MozTransform = b, this.banner.style.msTransform = b, this.banner.style.OTransform = b, this.banner.style.transform = b, this.banner.style.transformOrigin = "left top"
            }
            var y
        }, measureImpress: function (t, e) {
            var i = function () {
                ...
                var r = n.top, s = AdTrack.Utils.getViewportRealHeight(this.track.window), o = 1 - Math.abs(r) / s;
                o >= .5 && (this.track.removeEvent(this.track.window, "resize", i), this.track.removeEvent(this.track.window, "scroll", i), this.track.removeEvent(this.track.window, "build", i), e(t, o))
            }.bind(this);
            this.track.addEvent(this.track.window, "resize", i), this.track.addEvent(this.track.window, "scroll", i), this.track.addEvent(this.track.window, "build", i)
        }, loaded: function (t) {
            ...
            n && r ? (this.width = n, this.height = r, this.setUp()) : this.track.doError("Undefined width or height")
        }, destroy: function () {
        }, show: function () {
            this.track.container.style.display = "block"
        }, hide: function () {
    ...
    AdTrack.Slider = AdTrack.Slider || (i = "AdTrack-slider-wrapper", n = "AdTrack-slider-items", r = "AdTrack-slider-item", s = "AdTrack-slider-next", o = "AdTrack-slider-prev", a = "AdTrack-slider-pick", d = "data-slider-size", c = "data-item-size", h = "data-slider-direction", l = "data-slider-start", u = "data-slider-autoslide", p = "data-slider-threshold", f = {
        horizontal: {point: "clientX"},
        vertical: {point: "clientY"}
    }, g = function (t) {
        var e, g, m = t.ownerDocument || document, k = t.querySelector("." + i),
            v = k ? k.querySelector("." + n) : null, b = v ? v.querySelectorAll("." + r) : [], y = b.length,
            A = t.querySelectorAll("." + s), T = t.querySelectorAll("." + o), w = t.querySelectorAll("." + a), x = 0,
            C = 300, S = .2, P = 0, U = null, E = "horizontal", I = "clientX", R = parseInt(k.getAttribute(l)),
            D = parseInt(k.getAttribute(p)), B = parseInt(k.getAttribute(u)), N = k.getAttribute(h);
        !isNaN(R) && R >= 0 && R < y && (x = R), !isNaN(D) && D > 0 && D < 100 && (S = .01 * D), !isNaN(B) && B > 0 && (P = 1e3 * B), f[N] && (E = N, I = f[N].point), Array.prototype.forEach.call(T, (function (t) {
        ...
        var _ = (e - (C = g)) / 2, z = !1, O = 0, M = 0, L = 0, j = 0, H = function (t) {
            !function (t) {
                w[t] && (w[t].setAttribute("class", "AdTrack-slider-pick AdTrack-slider-pick-active"), w[x] && t !== x && w[x].setAttribute("class", "AdTrack-slider-pick"))
            }(t), t < 0 && (t = 0), t >= y && (t = y - 1), x = t, M = -t * C, Z()
        }, F = function (t) {
            t = -t;
            var e = Math.floor(Math.abs(t / C)), i = t % C;
            (t < 0 && i < -S * C || t >= 0 && i > S * C) && (e += 1), H(t < 0 ? x - e : x + e)
        }, V = function (t) {
            t = t || window.event, z = !1, X(), G(), O = M, "touchstart" === t.type ? L = t.touches[0][I] : (L = t[I], m.addEventListener("mouseup", q), m.addEventListener("mousemove", W))
        }, q = function (t) {
            t = t || window.event;
            var e = M - O;
            z = Math.abs(e) > 5, K(), J(), e < -S * C ? F(e) : e > S * C ? F(e) : (M = O, Z()), m.removeEventListener("mouseup", q), m.removeEventListener("mousemove", W)
        }, W = function (t) {
            ...
            "horizontal" !== E && (t = "translate(0px," + M + "px)"), v.style.webkitTransform = t, v.style.MozTransform = t, v.style.msTransform = t, v.style.OTransform = t, v.style.transform = t
        };
        k && v && y > 0 && (function () {
            k.style.overflow = "hidden";
            var t = "horizontal" === E ? C * y + "px" : "100%", e = "vertical" === E ? C * y + "px" : "100%";
            v.style.display = "block", v.style.width = t, v.style.height = e, v.style.paddingLeft = _ + "px", v.style.paddingRight = _ + "px", v.style.boxSizing = "content-box", Array.prototype.forEach.call(b, (function (t) {
                var e = "horizontal" === E ? C + "px" : "100%", i = "vertical" === E ? C + "px" : "100%";
                t.style.display = "block", t.style.float = "left", t.style.margin = "0", t.style.padding = "0", t.style.width = e, t.style.height = i
            }))
        }(), v.addEventListener("mousedown", V), v.addEventListener("touchstart", V), v.addEventListener("touchend", q), v.addEventListener("touchmove", W), v.addEventListener("click", (function (t) {
            z && t.preventDefault(), z = !1
        })), H(x), J())
    }, {
        create: function (t) {
            return new g(t)
    ...
    function i(t, e, n, r, s) {
        ...
        return i.append(o), i.resolve(o) ? i.populate(o) : i.populate(o, document.domain), o
    }
    ...
    window.AdTrack || (window.AdTrack = {}), window.AdTrack.iframeCreator = i, i.append = function (t) {
        ...
        var s = (e || 0 === e) && (i || 0 === i), o = r ? "100%" : e, a = r ? "100%" : e + "px";
        s && (t.setAttribute("width", o), t.setAttribute("height", i)), t.setAttribute("style", "border:0; margin:auto; display:block; max-width: none; max-height: none; " + (s ? "width:" + a + "; height:" + i + "px;" : "")), t.setAttribute("frameborder", "0"), t.setAttribute("marginheight", "0"), t.setAttribute("marginwidth", "0"), t.setAttribute("scrolling", "no"), n && function (t, e, i) {
            var n = i || t.ownerDocument || window.document, r = t.tagName, s = null;
            s = setInterval((function () {
                var i = n.activeElement;
                i && i.tagName == r && i == t && (clearInterval(s), e())
            }), 100)
        }(t, n)
    }, {
        createIframeWithContent: function (t, e, r, s, o, a, d) {
            ...
            try {
                ...
                e = e.replace("<iframe", "<iframe id='" + r + "'"), t.innerHTML = e;
                var s = t.querySelector("#" + r);
                return n(s, null, null, i), s
            } catch (t) {
                return null
            }
        }
    ...
    AdTrack.Criteo = AdTrack.Criteo || function () {
        if (!window.criteo_pubtag || window.criteo_pubtag instanceof Array || !window.Criteo || !window.Criteo.RequestBids) {
            ...
            try {
                var storageKey = "adtrack-lib-criteo", storageExpireKey = storageKey + "-expire",
        ...
        return {
            buildContext: function (t) {
                var e = {url: AdTrack.url, integrationMode: void 0};
                "object" == typeof t && (e.consent = t);
                try {
                    e.debug = "1" === AdTrack.Utils.getParameterByName("pbt_debug"), e.noLog = "1" === AdTrack.Utils.getParameterByName("pbt_nolog")
                } catch (t) {
                }
                return e
            }, buildStandardCdbUrl: function () {
                var t = _getStoredItem("cto_bundle"), e = _getStoredItem("cto_idcpy"), i = _getStoredItem("cto_idfs"),
                    n = _getStoredItem("cto_sid"), r = "https://bidder.criteo.com/cdb";
                return r += "?ptv=79", r += "&profileId=207", r += t ? "&bundle=" + t : "", r += e ? "&idcpy=" + e : "", r += i ? "&idfs=" + i : "", r += n ? "&sid=" + n : "", r += _getStoredItem("cto_optout") ? "&optout=1" : "", r += "&cb=" + Math.floor(99999999999 * Math.random())
            }, buildCdbUrl: function (t) {
                var e = {amp: 1}, i = "https://bidder.criteo.com/cdb";
                ...
                if (e) {
                    var r = "", s = "", o = (e = "" + e).indexOf("-");
                    if (o < 0 ? isNaN(e) ? s = e : r = e : (r = e.substr(0, o), s = e.substr(o + 1), isNaN(r) && (r = "", s = e)), !r && !s) return null;
                    var a = {
                    ...
                    r ? a.zoneid = r : d.networkid = AdTrack.Config.getAccountId("criteo"), s && (a.publishersubid = s), n && (a.native = !0);
                    var c = {slots: [a], publisher: d, user: {}};
                    return AdTrack.UserID && (c.user.ext = {prebid_criteoid: AdTrack.UserID.getCriteoId()}), t.consent && (c.gdprConsent = {
    ...
    AdTrack.SeznamHelper = function (t, e, i) {
        this.track = t, this.definition = e, this.chd = i, !0 === this.definition.test && this.track.doError("Test environment for seznam ads is set"), this.impPixels = [], "seznam-ssp" == i.tag && (this.ssspTests(), "vignette" === this.track.definition.renderer || "fixed" === this.track.definition.renderer && this.fadeInTest())
    }, AdTrack.SeznamHelper.prototype = {
        getKeyBasedOnStyle: function (t, e) {
            var i, n = null, r = 0;
            return t && (t.product && (i = t.product.count ? t.product.count : 0), t.normal && (r = t.normal.count ? t.normal.count : 0), n = i || r ? this.track.getChannelKey(e, i > r ? t.product : t.normal) : this.track.getChannelKey(e, null)), n
            ...
            var i = t.length, n = Math.floor(Math.random() * i), r = "var" + (n + 1), s = /var\d/;
            this.chd.flag ? s.test(this.chd.flag) ? this.chd.flag = this.chd.flag.replace(s, r) : this.chd.flag += "-" + r : this.chd.flag = r, this.chd.keys[1] = t[n];
            var o = e[n];
            for (var a in o) o.hasOwnProperty(a) && (this.definition.options[a] = o[a])
        }, ssspTests: function () {
            ...
            if (this.chd.keys[1]) {
                var e = [[{
                    ...
                    closerFontSize: 18,
                    szVerticalPadding: 17
                }], [{closerFontSize: 18, szVerticalPadding: 17}, {
                    closerFontSize: 17,
                    szVerticalPadding: 17
                }, {closerFontSize: 15, szVerticalPadding: 15}, {
                    closerFontSize: 16.5,
                ...
                }, {closerPos: "right", closerIcon: 1, closerSizeCoeff: 1.8, closerTest: 1}], [{
                    maxHeight: .25,
                    closerFontSize: 18,
                    szVerticalPadding: 17
                }, {szMaxHeight: 1, closerFontSize: 18, szVerticalPadding: 17}], [{
                    szNoScale: 1,
                    closerFontSize: 18,
                    szVerticalPadding: 17
                }, {closerFontSize: 18, szVerticalPadding: 17}], [{
                    ...
                    "classic_tn.cz_generic_fixed": {test: 0, keys: [250373, 250388]},
                    "classic_pisnicky-akordy.cz_generic_fixed": {test: 0, keys: [250379, 250391]},
                    "classic_im.eurobydleni.cz_generic_fixed": {test: 0, keys: [250382, 250394]},
                    "classic_emimino.cz_generic_fixed": {test: 1, keys: [250313, 250322, 250331, 250340]},
                    "classic_im.hyperinzerce.cz_generic_fixed": {test: 1, keys: [250325, 250316, 250334, 250343]},
                    "classic_lidovky.cz_generic_fixed": {test: 1, keys: [250319, 250328, 250337, 250346]},
                    "classic_expres.cz_generic_fixed": {test: 2, keys: [250295, 250307]},
                    "classic_databazeknih.cz_generic_fixed": {test: 2, keys: [250301, 250304]},
                    "classic_novaplus.cz_generic_fixed": {test: 2, keys: [250298, 250310]},
                    "classic_drbna.cz_generic_fixed": {test: 3, keys: [250349, 250361]},
                    "classic_abradio.cz_generic_fixed": {test: 3, keys: [250352, 250364]},
                    "classic_homeincube.cz_generic_fixed": {test: 3, keys: [250358, 250367]},
                    "classic_bezrealitky.cz_generic_fixed": {test: 4, keys: [250403, 250412]},
                    "classic_mafra.onlajny.com_generic_fixed": {test: 4, keys: [250406, 250415]},
                    "classic_meteocentrum.cz_generic_fixed": {test: 4, keys: [250409, 250418]},
                    "classic_im.fdb.cz_generic_fixed": {test: 5, keys: [255328, 255331, 255343]},
                    "classic_tydenikpolicie.cz_generic_fixed": {test: 5, keys: [255325, 255334, 255346]},
                    "classic_im.drevostavitel.cz_generic_fixed": {test: 5, keys: [255364, 255337, 255349]},
                    "classic_idnes.cz_homepage_fixed": {test: 6, keys: [208336, 241964, 257059]},
                    "classic_idnes.cz_generic_fixed": {test: 6, keys: [208426, 241967, 257062]},
                    "classic_rajce.net_generic_fixed": {test: 7, keys: [256708, 256699]},
                    "mobile_ocko.tv_generic_fixed": {test: 7, keys: [256714, 256705]},
                    "mobile_mafra.skodahome.cz_generic_fixed": {test: 7, keys: [256711, 256702]}
                };
                for (var n in i) if (i.hasOwnProperty(n) && t === n) {
                    var r = i[n], s = -1;
                ...
                if (-1 !== t.indexOf("idnes.cz") && -1 !== t.indexOf("fixed") && "classic_idnes.cz_homepage_fixed" !== t && "classic_idnes.cz_generic_fixed" !== t && "classic_reality.idnes.cz_generic_fixed" !== t) {
                    var d = e[6][1];
                    for (var c in d) o.hasOwnProperty(c) && (this.definition.options[c] = d[c])
                }
            }
        }, vignetteTest: function () {
            var t = this.track.unitID.getName(), e = null;
            this.chd.keys[1] && ("mobile_parlamentnilisty.cz_generic_vignette" === t && 220542 == this.chd.keys[1] ? e = [249608, 220542] : "mobile_drbna.cz_generic_vignette" === t && 181746 == this.chd.keys[1] && (e = [249611, 181746]), e && this.applyTest(e, [{szTest: 1}, {}]))
        }, reopenTest: function () {
            var t = null;
            "classic_podnikatel.cz_article_fixed" === this.track.unitID.getName() && (t = [63959, 227386, 227391]), t && this.chd.keys[1] && this.applyTest(t, [{customReopen: 1}, {
                customReopen: 1,
                customReopenRight: 1
            }, {customReopen: 0}])
        }, fadeInTest: function () {
            ...
            var t = this.track.unitID.getName(), e = null;
            this.chd.keys[1] && ("classic_autoweb.cz_generic_fixed" === t && 63967 == this.chd.keys[1] ? e = [249035, 63967] : "classic_vitalia.cz_article_fixed" === t && 89458 == this.chd.keys[1] && (e = [249335, 89458]), e && this.applyTest(e, [{szTest: 1}, {}]))
        }, capping: function () {
            if (this.definition.options.customSeznamCappingLimit && this.definition.options.customSeznamCappingDelay) {
                ...
                (s = s ? ++s : 1) > t - 1 ? this.track.setCookie(r, 1, i) : this.track.setCookie(r, 1, e), this.track.setCookie(n, s, i)
            }
            ...
            try {
                t.forEach((function (t) {
                    var i = {11: "title", 12: "data", 1: "img", 2: "img"}[t.id],
                        n = {11: "title", 12: "description", 1: "image", 2: "imageSquare"}[t.id], r = t[i];
                    r && (e[n] = r.text || r.value || {url: r.url, width: r.w, height: r.h})
                }))
            } catch (t) {
            }
            return e
            ...
            var r = new AdTrack.AdChoices;
            r.setPromoClickUrl(this.chd.url), r.setPromoText(this.chd.title), r.setOptional(!0), n.addAdChoices(r);
            var s = new AdTrack.TextAd, o = this.parseAssets(t.assets), a = t.link, d = o.image, c = o.imageSquare;
            s.addText(o.title, o.description), d && s.addScreenshot(d.url, d.width, d.height, d.url), c && s.addScreenshot(c.url, c.width, c.height, c.url);
            var h = !0 === this.definition.test ? "#" : a.url;
            s.setClickUrl(h), s.setCta("Navštívit stránku"), s.done(), n.addAd(new AdTrack.AppnexusAd(n, s)), new AdTrack.TextChannel(this.track, this.definition, this.chd).renderAds(e, n);
            for (var l = 0; l < t.imptrackers.length; l++) AdTrack.Utils.firePixel(t.imptrackers[l]);
            if (t.jstracker) {
                var u = this.track.document.createElement("div");
                u.style.display = "none", e.appendChild(u);
            ...
            if (s || (s = "n/a"), t.length > 0) try {
                if (this.isBanner(t)) {
                    this.ssspDebug("SSSP renderAds processResult - banner");
                    var o = {count: i.count, name: "banner", options: {width: i.width, height: i.height}};
                    this.renderBanner(t[0], e, o, n, r)
                } else {
                    this.ssspDebug("SSSP renderAds processResult - other");
                    var a, d, c = t.length;
                    for (d = 0; d < t.length; d++) "SHOP" == t[d].adType && (a = t[d], c--);
                    var h = new AdTrack.AdSet;
                    h.setStyle(i);
                    var l = new AdTrack.AdChoices;
                    for (l.setPromoClickUrl(this.chd.url ? this.chd.url : "https://napoveda.sklik.cz/cz/co-je-reklama-sklik.html"), l.setPromoText(this.chd.title), l.setOptional(!0), h.addAdChoices(l), d = 0; d < t.length; d++) {
                        var u = t[d];
                        if (u.cta = "Navštívit stránku", u && u.eventTrackers && u.eventTrackers.impress && (this.impPixels = this.impPixels.concat(u.eventTrackers.impress)), "DRTG" != u.adType && "COMBINED" != u.adType && "BANNER" != u.adType || this.definition.options.customOverrideSeznamClick && (u.clickUrl = "//" + this.track.server + "/clk.php?url=" + encodeURIComponent(u.clickUrl)), "DRTG" == u.adType) h.addAd(new AdTrack.SklikProductAd(h, this.createProductAd(u, a, i))); else if ("DYNAMIC_BANNER" == u.adType) h.addAd(new AdTrack.SklikProductAd(h, this.createProductAd(u, a, i))); else if ("TXT" == u.adType) h.addAd(new AdTrack.SklikAd(h, this.createTextAdOld(u))); else if ("COMBINED" == u.adType) h.addAd(new AdTrack.SklikAd(h, this.createTextAdCombined(u))); else if ("SHOP" == u.adType) h.addShop(this.createShop(u)); else {
                            if (!u.adType || !u.headline1) return this.track.doError("Corrupt " + s + " ad. " + JSON.stringify(t)), void r("ads-structure");
                            h.addAd(new AdTrack.SklikAd(h, this.createTextAd(u)))
                        }
                    }
                    new AdTrack.TextChannel(this.track, this.definition, this.chd).renderAds(e, h), n(c)
                }
            } catch (t) {
                this.track.doError("Sklik processing failed due to: " + t.message), r("exception")
            } else r("ads-empty")
        }, createTextAdCombined: function (t) {
            var e = new AdTrack.TextAd, i = t.adImageUrl + "?fl=res%2C600%2C%2C1|jpg%2C90",
                ...
                o = this.track.rhtmlspecialchars(t.description).trim(), a = this.track.rhtmlspecialchars(t.cta),
            ...
            return s || this.track.doError("Long headline not included. (" + this.chd.tag + ")"), e.addScreenshot(i, 600, 314, i), e.addScreenshot(n, 600, 600, n), e.addText(r, o), e.setLongHeadline(s), e.setCompanyName(t.companyName), e.setLogoUrl(t.adLogoUrl), e.setSquareLogoUrl(t.adSquareLogoUrl), e.setClickUrl(c), e.setVisibleUrl(t.visibleUrl), e.setAdUrl(t.adUrl), e.setCta(a), e.setFavicon(d), e.done(), e
            ...
            var e = new AdTrack.TextAd,
                ...
                r = (encodeURIComponent(t.adUrl), this.track.rhtmlspecialchars(t.headline1).trim()),
                s = this.track.rhtmlspecialchars(t.headline2).trim(),
                o = this.track.rhtmlspecialchars(t.description).trim(), a = this.track.rhtmlspecialchars(t.cta),
                d = "//fimg-resp.seznam.cz/?spec=fav16x16&url=" + encodeURIComponent(t.adUrl),
                c = !0 === this.definition.test ? t.adUrl ? t.adUrl : this.track.noquerystring("//seznam.cz") : t.clickUrl;
            if (0 !== t.adImageUrl.length) {
                i = t.adImageUrl + "?fl=res%2C160%2C110%2C3|jpg%2C90", n = t.adImageUrl + "?fl=res%2C560%2C260%2C3|jpg%2C90";
                var h = t.adImageUrl + "?fl=res%2C600%2C%2C1|jpg%2C90";
                e.addScreenshot(i, 160, 110, i), e.addScreenshot(n, 560, 260, n), e.addScreenshot(h, 600, 314, h)
            } else e.addScreenshot(i, 160, 110, i), e.addScreenshot(n, 280, 130, n);
            return e.addText(r, o), s && (0 !== t.adImageUrl.length || e.addText(r + " - " + s, o)), e.setClickUrl(c), e.setVisibleUrl(t.visibleUrl), e.setAdUrl(t.adUrl), e.setCta(a), e.setFavicon(d), e.done(), e
        }, createTextAdOld: function (t) {
            var e = new AdTrack.TextAd,
                i = "//fimg-resp.seznam.cz/?spec=ft100x75&fast&url=" + encodeURIComponent(t.adUrl),
                n = "//fimg-resp.seznam.cz/?spec=ft280x130&fast&url=" + encodeURIComponent(t.adUrl),
                r = (encodeURIComponent(t.adUrl), this.track.rhtmlspecialchars(t.creative1).trim()),
                s = this.track.rhtmlspecialchars(t.creative2).trim(),
                o = this.track.rhtmlspecialchars(t.creative3).trim(), a = this.track.rhtmlspecialchars(t.cta),
                d = "//fimg-resp.seznam.cz/?spec=fav16x16&url=" + encodeURIComponent(t.adUrl),
                c = !0 === this.definition.test ? t.adUrl ? t.adUrl : this.track.noquerystring("//seznam.cz") : t.clickUrl;
            return e.addScreenshot(i, 100, 75, i), e.addScreenshot(n, 280, 130, n), e.addText(r, s + " " + o), e.setClickUrl(c), e.setVisibleUrl(t.visibleUrl), e.setAdUrl(t.adUrl), e.setCta(a), e.setFavicon(d), e.done(), e
        }, createProductAd: function (t, e, i) {
            var n = new AdTrack.ProductAd, r = i.options.imageWidth || this.definition.options.imageWidth || null,
                s = i.options.imageHeight || this.definition.options.imageHeight || null;
            r && s || (r = 220, s = 120);
            var o = t.imageUrl + "?w=" + r + "&h=" + s + "&m=rp", a = t.imageUrl + "?w=220&h=120&m=rp";
            i && i.options && i.options.backgroundImage && (o = t.imageUrl, a = t.imageUrl);
            var d = e && e.cleanShopUrl ? "https://fimg-resp.seznam.cz/?spec=fav16x16&url=" + encodeURIComponent(e.cleanShopUrl) : "",
                c = !0 === this.definition.test ? t.adUrl ? t.adUrl : this.track.noquerystring("//seznam.cz") : t.clickUrl,
                h = t.price;
            return h.match(/[0-9]$/) && (h += "&nbsp;Kč"), h = h.replace(/[ ]+/g, "&nbsp;"), n.addScreenshot(o, r, s, a), n.setProductName(t.title), n.setProductPrice(h), n.setProductLastPrice(t.lastPrice), n.setProductDiscount(t.discount), n.setAdditionalInfo(t.additionalInfo), n.setProductManufacturer(t.manufacturer), n.setProductCategory(t.category), n.setClickUrl(c), n.setFavicon(d), n.done(), n
        }, createShop: function (t) {
            var e = new AdTrack.Shop, i = t.cleanShopUrl, n = i.split("//");
            return n.length > 1 ? e.setCleanShopUrl(n[1]) : e.setCleanShopUrl(i), e.setShopName(t.shopName), e.setShopSlogan(t.shopSlogan), e.setShopUrl(t.shopUrl), e.setShopLogo(t.shopLogoUrl), e.setLogoutUrl(""), e
            ...
            o.style.textAlign = "center", o.style.fontSize = "0";
            var a = this.track.document.createElement("div");
            a.style.display = "inline-block", a.style.position = "relative", a.style.margin = "auto", o.appendChild(a), e.appendChild(o);
            var d = this.track.document.createElement("a");
            this.definition.options.hideHref ? d.href = "#" : d.href = s, a.appendChild(d);
            var c, h, l, u = this.track.document.createElement("img");
            if (u.src = t.bannerUrl, u.style.width = "auto", u.style.height = "auto", u.style.border = "solid 1px #d0d0d0", d.appendChild(u), d.onclick = (c = 0, h = "banner", l = s, function (t) {
                var e = AdTrack.Utils.getEventRelativePos(t, this.track.renderer.getContainer());
                this.track.evClick(this.definition, this.chd, e.x, e.y, c, h, l, i), this.definition.options.newwindow || (t.preventDefault ? t.preventDefault() : t.returnValue = !1)
            }).bind(this), this.ssspDebug("SSSP renderBanner - after append"), this.definition.options.newwindow ? d.setAttribute("target", "_blank") : d.setAttribute("target", "_top"), !this.definition.options.noBannerPromo && ("sklik" == this.chd.tag || "sklik-banner" == this.chd.tag)) {
                var p = this.track.document.createElement("a");
                p.style.position = "absolute", p.style.bottom = "0px", p.style.right = "0px", p.style.background = "transparent", p.href = this.chd.url;
                var f = this.track.document.createElement("img");
                f.alt = f.title = this.chd.title, f.style.width = "auto", f.style.height = "auto", p.appendChild(f);
                var g = function () {
                    f.src = "//c.imedia.cz/img/banner-packa.png"
                };
                p.onmouseover = function () {
                    f.src = "//c.imedia.cz/img/banner-logo.png"
                }, p.onmouseout = g, g(), a.appendChild(p)
            }
            var m = this, k = function (t, e) {
                this.ssspDebug("SSSP renderAds processResult - banner load");
                try {
                    t && t.options && (t.options.width = e.width, t.options.height = e.height)
                } catch (t) {
                    return void r("exception-banner")
                }
                n(1, t)
            }.bind(this);
            u.complete ? (m.ssspDebug("SSSP renderBanner - banner complete"), k(i, u)) : (m.ssspDebug("SSSP renderBanner - banner wait"), u.onload = function (t) {
                m.ssspDebug("SSSP renderBanner - banner onload"), k(i, t.target)
            }, u.onerror = function () {
                m.ssspDebug("SSSP renderBanner - banner onerro"), r("banner-image")
            })
            ...
            var r = "<html><head></head><body>" + t + "</body></html>", s = function () {
            ...
            return o || this.track.doError("Seznam-helper didnt create iframe"), o
            ...
            if (navigator.plugins && navigator.plugins.length) for (t = 0; t < navigator.plugins.length; t++) {
                ...
                i.push(n.description), i.push(n.filename);
                ...
                for (e in d) {
                    try {
                        o = new ActiveXObject(e), i.push(e)
                    } catch (t) {
                        continue
                    }
                    try {
                        a = d[e].call(o), i.push(a)
                    } catch (t) {
                        i.push("[unavail]")
                    }
                }
            }
            var c = i.join("").toLowerCase(), h = [0, 0, 0, 0], l = 0;
            for (t = 0; t < c.length; t++) h[l] = (h[l] + c.charCodeAt(t)) % 65535, l = (l + 1) % h.length;
            return h.join("")
        }, generatePvId: function () {
            var t = new Date;
            t = t.toUTCString();
            var e = document.location.href, i = Math.random().toString();
    ...
    AdTrack.SmartHelper = function (t, e, i) {
        ...
        bid: function (t, e, i) {
            ...
            for (var e = [{
                w: this.chd.width,
                h: this.chd.height
            }], i = this.chd.sizes ? this.chd.sizes : [], n = 0; n < i.length; n++) 2 === i[n].length && e.push({
                w: i[n][0],
                h: i[n][1]
            });
            var r = t.split("-");
            ...
            var s = {};
            AdTrack.CMP && (s = AdTrack.CMP.getConsentData("never", !1)), s && this.track.evBidConsent(this.definition, this.chd);
            var o = AdTrack.Utils.simpleStringGenerator(14), a = AdTrack.Utils.simpleStringGenerator(14), d = {
                siteid: r[0],
                pageid: r[1],
                formatid: r[2],
                currencyCode: "EUR",
            ...
            if (c && (d.schain = c), AdTrack.UserID) {
    ...
    AdTrack.MgidHelper = function (t, e, i) {
        this.track = t, this.definition = e, this.chd = i, this.floorPrice = null
        ...
        setFloorPrice: function (t) {
            ...
            if (r) {
                var s = AdTrack.Utils.getLocalStorageItem("mgMuidn"), o = "https://prebid.mgid.com/prebid/" + r;
                null != s && "string" == typeof s && s.length > 0 && (o += "?muid=" + s);
                var a = this.createData(e, i), d = this;
                AdTrack.Ajax.request({
                    label: "Mgid bid",
                    url: o,
                    method: "POST",
                    ...
                    if (e && e.seatbid && e.seatbid[0] && e.seatbid[0].bid && e.seatbid[0].bid[0]) {
                        ...
                        i = AdTrack.Price.create(r.price, AdTrack.Price.USD), t.setCreativeId(r.crid), t.setPrice(i), t.setWidth(r.w ? r.w : d.chd.width), t.setHeight(r.h ? r.h : d.chd.height)
                    }
                    d.response = e, n && n(i, e)
                })).fail((function (t, e) {
                    e ? d.track.evBidTimeout(d.definition, d.chd) : d.track.evBidError(d.definition, d.chd), n && n(null, null)
                })).send()
            } else this.track.doError("MGID accountId not defined. " + this.chd.tag)
        }, createData: function (t, e) {
            var i = AdTrack.Utils.simpleStringGenerator(14), n = AdTrack.Utils.simpleStringGenerator(14),
                r = "https:" === window.location.protocol ? 1 : 0, s = "";
            try {
                s = this.track.getDomainName(window.top.location.hostname)
            } catch (t) {
                s = this.track.getDomainName(window.location.hostname)
            }
            var o = {}, a = {}, d = {id: i, tagid: "" + t, secure: r};
            if (e) {
                d.native = {
                    request: {
                        plcmtcnt: 1,
                        assets: [{required: 1, id: 3, img: {wmin: 600, hmin: 314, type: 3}}, {
                            required: 0,
                            id: 2,
                            img: {wmin: 16, hmin: 16, type: 1}
                        }, {required: 1, id: 0, title: {len: 300}}, {required: 1, id: 4, data: {type: 2}}, {
                            required: 0,
                            id: 5,
                            data: {type: 1}
                        }, {required: 0, id: 1, data: {type: 12}}]
                    }
                }, d.bidfloor = this.floorPrice ? this.floorPrice : 0
            } else {
                var c = this.chd.sizes, h = [];
                if (h.push({
                    w: this.chd.width,
                    h: this.chd.height
                }), c && c.length > 0) for (var l = 0; l < c.length; l++) 2 === c[l].length && h.push({
                    w: c[l][0],
                    h: c[l][1]
                });
                d.banner = {w: this.chd.width, h: this.chd.height, format: h}
            }
            var u = null;
            return AdTrack.CMP && (u = AdTrack.CMP.getConsentData("never", !1)), u && (this.track.evBidConsent(this.definition, this.chd), o.ext = {consent: u.consentString ? u.consentString : ""}, a.ext = {gdpr: u.gdprApplies ? 1 : 0}), {
                id: n,
                cur: ["USD"],
                device: {
                ...
                site: {domain: s, page: AdTrack.url},
    ...
    AdTrack.PubmaticHelper = function (t, e, i, n) {
        this.track = t, this.definition = e, this.chd = i, this.accountId = n || AdTrack.Config.getAccountId("pubmatic"), this.external = this.accountId !== AdTrack.Config.getAccountId("pubmatic");
        var r = "";
        try {
        ...
        bid: function (t, e, i, n) {
            if (this.accountId) {
                var r = "https://openbid.pubmatic.com/translator?pubId=" + this.accountId, s = this.createData(e, i),
                    o = this;
                AdTrack.Ajax.request({
                    label: "Pubmatic bid",
                    url: r,
                    ...
                    var i = null;
                    if (e && e.seatbid && e.seatbid[0] && e.seatbid[0].bid && e.seatbid[0].bid[0]) {
                        var r = e.seatbid[0].bid[0], s = AdTrack.Utils.isBlackListedAds(r.adm);
                        if (!1 === s) i = AdTrack.Price.create(r.price, AdTrack.Price.USD), t.setCreativeId(r.crid), t.setPrice(i), t.setWidth(r.w), t.setHeight(r.h); else {
                            var a = "";
                            r.ext && r.ext.dspid && (a = r.ext.dspid), o.track.doError("Blocked Pubmatic creative (" + r.crid + ") with DSP ID (" + a + ") from " + s, "info"), o.chd.logs && o.chd.logs.blocked_creative && AdTrack.Utils.reportCreative(o.track.server, o.chd.logs.blocked_creative, o.chd.tag, r.crid || "", "", r.price, r.adm), n && n(null, null)
                        }
                    }
                    o.response = e, n && n(i, e)
                })).fail((function (t, e) {
                    e ? o.track.evBidTimeout(o.definition, o.chd) : o.track.evBidError(o.definition, o.chd), n && n(null, null)
                })).send()
            ...
            var n = i[0], r = i[1], s = AdTrack.Utils.uuid(), o = "https:" === window.location.protocol ? 1 : 0, a = "";
            try {
            ...
            var d = {}, c = {},
                h = {id: s, tagid: "" + r, secure: o, ext: {}, bidfloor: this.chd.bidFloor, bidfloorcur: "USD"};
            if (e) h.video = {
                ...
                linearity: 1,
                startdelay: 0,
                ext: {video_skippable: 1}
            }; else {
                var l = this.chd.sizes, u = [];
                if (u.push({
                    w: this.chd.width,
                    h: this.chd.height
                ...
                h.banner = {w: this.chd.width, h: this.chd.height, format: u}
            }
            if (AdTrack.UserID) {
            ...
            var g = null;
            AdTrack.CMP && (g = AdTrack.CMP.getConsentData("never", !1)), g && (this.track.evBidConsent(this.definition, this.chd), d.ext = {consent: g.consentString ? g.consentString : ""}, c.ext = {gdpr: g.gdprApplies ? 1 : 0});
            var m = {
                id: "" + (new Date).getTime(),
                at: 1,
                cur: ["USD"],
            ...
            return k && !this.external && (m.source = {ext: {schain: k}}), m
        }
    }, AdTrack.PubmaticCSync = AdTrack.PubmaticCSync || (i = !1, function (t, e, n, r) {
        if (!i) {
            var s = null;
            if (AdTrack.CMP && (s = AdTrack.CMP.getConsentData("never", !1)), s) var o = s.consentString || "",
                a = s.gdprApplies ? 1 : 0;
            var d = document.createElement("script");
            d.async = !0, d.defer = !0, d.type = "text/javascript", d.src = "https://ads.pubmatic.com/AdServer/js/userSync.js", d.onload = function () {
                PubMaticSync.sync({pubId: t, siteId: e, delay: 1e3, gdpr: a, gdprConsent: o})
            };
            var c = document.getElementsByTagName("script")[0];
            c.parentNode.insertBefore(d, c), i = !0
        }
    })
}, function (t, e) {
    AdTrack.AdagioHBChannel = function (t, e, i) {
        ...
        n.ADAGIO = n.ADAGIO || {}, n.ADAGIO.pageviewId = n.ADAGIO.pageviewId || AdTrack.Utils.uuid()
    }, AdTrack.AdagioHBChannel.prototype = {
        report: function () {
            return this.adData || ""
        }, bid: function (t, e) {
            var i = this.track.window, n = e.split(":");
            2 !== n.length && this.track.doError("Wrong format for key, should be: [site]:[placement]");
            for (var r = [[this.chd.width, this.chd.height]], s = this.chd.sizes ? this.chd.sizes : [], o = 0; o < s.length; o++) 2 === s[o].length && r.push(s[o]);
            var a, d, c = function () {
                try {
                    var t = this.track.definition.options.dom, e = t.selector || t.container,
                ...
                try {
                    ...
                    if (AdTrack.Utils.isSafeFrameWindow(this.track.window)) {
                        ...
                        var n = i.$sf.ext.geom();
                        return n && n.self ? (e.x = Math.round(n.t), e.y = Math.round(n.l), e.x + "x" + e.y) : ""
                    }
                    if (AdTrack.Utils.windowTopAccess() && t) {
                        var r = AdTrack.Utils.windowTopAccess() || this.track.window, s = this.track.window.document,
                            o = t.getBoundingClientRect(), a = s.documentElement, d = s.body,
                            h = s.clientTop || d.clientTop || 0, l = s.clientLeft || d.clientLeft || 0,
                ...
                adUnits: [],
                regs: {
                    gdpr: {apiVersion: 2, consentString: "", consentRequired: 1, allowAuctionWithoutConsent: 1},
                    coppa: {},
                    ccpa: {}
                },
                schain: {},
            ...
            if (u.adUnits.push({
                ...
                features: {
                    ...
                    device: "" + l(),
                    url: AdTrack.url,
                    browser: (a = i.navigator.userAgent, d = a.toLowerCase(), /Edge\/\d./i.test(a) ? "edge" : d.indexOf("chrome") > 0 ? "chrome" : d.indexOf("firefox") > 0 ? "firefox" : d.indexOf("safari") > 0 ? "safari" : d.indexOf("opera") > 0 ? "opera" : d.indexOf("msie") > 0 || i.MSStream ? "ie" : "unknow"),
                    os: function () {
                ...
                p && p.consentString && (this.track.evBidConsent(this.definition, this.chd), u.regs.gdpr = {
            ...
            var f = function (e) {
                if (this.response = e, e.data && e.data.user_syncs && e.data.user_syncs.length >= 1) {
                    var i = e.data.user_syncs, n = this;
                    setTimeout((function () {
                        try {
                            i.forEach((function (t) {
                                ...
                                if ("image" === t.type) {
                                    ...
                                    i.setAttribute("src", t.url), i.setAttribute("style", "position:absolute; display:none; height:0; width:0;"), e.body.appendChild(i)
                                } else if ("iframe" === t.type) {
                                    var r = e.createElement("iframe");
                                    r.setAttribute("src", t.url), r.setAttribute("width", "0"), r.setAttribute("height", "0"), r.setAttribute("scrolling", "no"), r.setAttribute("frameborder", "0"), r.setAttribute("style", "border: 0px; display:none;"), e.body.appendChild(r)
                                }
                            }))
                        } catch (t) {
                ...
                if (e.bids && e.bids.length > 0) if (e.bids[0]) {
                    var r = e.bids[0], s = AdTrack.Utils.isBlackListedAds(r.ad);
                    !1 === s ? r.cpm ? r.currency === this.chd.currency ? (this.price = AdTrack.Price.create(r.cpm, this.chd.currency), this.bidResponse.setPrice(this.price), this.bidResponse.setCreativeId(r.creativeId), r.width && r.height && (this.bidResponse.setWidth(r.width), this.bidResponse.setHeight(r.height)), t && t(this.price, this.response)) : (this.track.doError("Channel " + this.chd.tag + " responded with unsupported currency (" + r.currency + ")."), t && t(null, null)) : (this.track.doError("Channel " + this.chd.tag + " responded with empty currency."), t && t(null, null)) : (this.track.doError("Blocked Adagio creative (" + r.creativeId + ") from " + s, "info"), this.chd.logs && this.chd.logs.blocked_creative && AdTrack.Utils.reportCreative(this.track.server, this.chd.logs.blocked_creative, this.chd.tag, r.creativeId || "", "", r.cpm, r.ad), t && t(null, null))
                } else this.track.doError("Channel " + this.chd.tag + " responded with unknown response."), t && t(null, null); else t && t(null, null)
            }.bind(this), g = function (e, i) {
    ...
    AdTrack.AdformChannel = function (t, e, i) {
        ...
        report: function () {
            ...
            if (n) {
                var r = function (e) {
                    if (e) if ((e = e[0]).response && "banner" === e.response) {
                        if (this.adData = e.banner, "branding" === this.definition.renderer && this.track.settings.publisher && "mafra" === this.track.settings.publisher.tag) {
                            var n = AdTrack.Utils.windowTopAccess();
                            if (n && n.CPExSkinObject) {
                                var r = n.CPExSkinObject;
                                n.CPExSkinObject = function (t) {
                                    if (n.CPExSkinObject = r, !n.postscribe || !n.document.getElementById("branding")) throw new Error;
                                    postscribe("#branding", "<script>topWin.CPExSkinObject (" + JSON.stringify(t) + ")<\/script>")
                                }
                            }
                        }
                        var s = e.banner.match(/bn=([0-9]+);/);
                        if (s && s[1]) 12260744 == s[1] && t.setAttribute("rel", "//track.adform.net/C/?bn=12260744;adfibeg=0");
                        this.chd.width = e.width, this.chd.height = e.height;
                        var o = {chd: this.chd, width: e.width, height: e.height, ad: {}};
                        e.banner.match(/^<iframe/i) ? (o.ad.data = e.banner, o.ad.type = "iframe") : (o.ad.data = "<html><head><script>window.inDapIF=true;<\/script></head><body>" + e.banner + "</body></html>", o.ad.type = "content");
                        var a = new AdTrack.MediaTypes.Banner(o, this.track.errorReporting);
                        i(a)
                    } else this.track.passback(this.definition, this.chd); else this.track.passback(this.definition, this.chd)
                }.bind(this);
                this.price && this.response ? r(this.response) : this.bid((function (t, e) {
                    r(e)
                }), n)
    ...
    AdTrack.AdformNativeDSPChannel = function (t, e, i) {
        ...
        bid: function (t, e) {
            var i = this.createData(e), n = this;
            AdTrack.Ajax.request({
            ...
            var i = e.image.width, n = e.image.height;
            return !!(i >= 100 && n >= 100 && i / n >= 1) || (this.track.doError("Adform native - image has invalid dimension [" + i + ", " + n + "]", "debug"), !1)
        }, isAdValidForRender: function (t, e) {
            var i = e ? e.options.nativeOptions : this.definition.options.nativeOptions, n = t.title.length,
                r = t.description.length, s = t.image.width, o = t.image.height, a = s / o;
            if (i) {
                var d = i.maxTitleLength || i.maxTextLength, c = i.maxDescLength || i.maxTextLength;
                if (n > 80 && !d) return this.track.doError("Adform native - possible title overflow (" + n + "), style: " + e.name, "debug"), !1;
                if (r > 150 && !c) return this.track.doError("Adform native - possible description overflow (" + r + "), style: " + e.name, "debug"), !1;
                if (i.imgWidth && i.imgHeight) {
                    var h = i.imgWidth, l = i.imgHeight, u = h / l;
                    if (!(u < 1.5 ? a >= u / 1.1 && a <= u / .9 : a >= u / 1.15 && a <= u / .85)) return this.track.doError("Adform native - image not optimal, img [" + s + ", " + o + "], optimal [" + h + ", " + l + "], style: " + e.name, "debug"), !1
                }
            ...
            try {
                t.forEach((function (t) {
                    var i = {0: "title", 1: "data", 2: "img", 3: "img", 4: "data", 5: "data"}[t.id],
            ...
            if (!n || !n.assets || !n.link) return !1;
            var r = new AdTrack.AdSet;
            r.setStyle(i);
            var s = new AdTrack.AdChoices;
            s.setPromoClickUrl(this.chd.url), s.setPromoText(this.chd.title), s.setOptional(!0), r.addAdChoices(s);
            var o = new AdTrack.TextAd, a = n.link, d = n.imptrackers || void 0, c = this.parseAssets(n.assets);
            if (!this.isAdValidForRender(c, i)) return !1;
            var h = c.image, l = c.favicon;
            o.addText(c.title, c.description), h && o.addScreenshot(h.url, h.width, h.height, h.url);
            var u = c.cta ? c.cta : "Navštívit stránku", p = c.advertiser ? c.advertiser : "", f = "";
            l && l.url && (f = l.url);
            var g = !0 === this.definition.test ? "" : a.url;
            return o.setClickUrl(g), o.setVisibleUrl(""), o.setAdUrl(""), o.setCta(u), o.setFavicon(f), o.setCompanyName(p), o.done(), r.addAd(new AdTrack.AdformAd(r, o)), new AdTrack.TextChannel(this.track, this.definition, this.chd).renderAds(e, r), d && d.forEach((function (t) {
                (new Image).src = t
            })), !0
        }, createData: function (t) {
            var e = AdTrack.Utils.uuid(), i = AdTrack.Utils.uuid(), n = {}, r = {}, s = null;
            AdTrack.CMP && (s = AdTrack.CMP.getConsentData(this.track.cmpFallback, this.track.cookiesEnabled)), s && (this.track.evBidConsent(this.definition, this.chd), n.ext = {consent: s.consentString ? s.consentString : ""}, r.ext = {gdpr: s.gdprApplies ? 1 : 0});
            var o = {
                id: e,
                cur: ["EUR"],
                device: {ua: navigator.userAgent},
                site: {page: AdTrack.url},
                ext: {},
                imp: [{
                    ...
                    native: {
                        request: {
                            assets: [{required: 1, id: 3, img: {wmin: 1, hmin: 1, type: 3}}, {
                                required: 0,
                                id: 2,
                                img: {wmin: 1, hmin: 1, type: 1}
                            }, {required: 1, id: 0, title: {len: 300}}, {
                                required: 1,
                                id: 4,
                                data: {type: 2}
                            }, {required: 0, id: 5, data: {type: 1}}, {required: 0, id: 1, data: {type: 12}}]
                        }
                    }
                }],
                source: {tid: i, fd: 1},
    ...
    AdTrack.AdformHbbtvChannel = function (t, e, i) {
        this.track = t, this.definition = e, this.chd = i, this.adformUtils = new AdTrack._AdFormUtils, this.price = null, this.response = null, this.helper = new AdTrack.AdformHelper(t, e, i), this.bidResponse = new AdTrack.Bid
        ...
        bid: function (t, e) {
            ...
            this.container = t, e = e && e.normal ? e.normal : null;
            var i = this.track.getChannelKey(this.chd, e);
            if (i) {
                var n = AdTrack.Utils.objectValues(this.definition.options.blackListedBNs), r = function (r) {
                    var s = r[0];
                    if (s && s.outdoor) {
                        if (this.helper.isBlacklisted(s.outdoor.url, n) && (s.outdoor.clk = null), !this.definition.options.dom.noContainer) {
                            var o = this.track.window.document.createElement("img");
                            if (o.setAttribute("src", s.outdoor.url), o.setAttribute("alt", ""), null !== s.outdoor.clk) {
                                ...
                                } else a.setAttribute("href", s.outdoor.clk), this.track.setOnclick([a], function (t) {
                                    this.track.evClick(this.definition, this.chd, void 0, null, null, null, null, e)
                                }.bind(this), this.definition.options.newwindow);
                                a.appendChild(o), this.container.appendChild(a)
                            } else this.container.appendChild(o)
                        }
                        (new Image).src = s.outdoor.imp, this.track.loaded(this.definition, this.chd, 1, e, r)
                    } else this.chd.html5 && s && "banner" === s.response ? this.adformRender(t, s, e) : this.track.passback(this.definition, this.chd)
                }.bind(this);
                this.price && this.response ? r(this.response) : this.bid((function (t, e) {
                    r(e)
                }), i)
            ...
            n.id = "AdTrackIframeWrap", t.appendChild(n);
            var r = function () {
                this.track.evClick(this.definition, this.chd, void 0, null, null, null, null, i)
            }.bind(this);
            if (e.banner.match(/^<iframe/i)) AdTrack.iframeCreator.factory.createIframeFromHTML(t, e.banner, r); else {
    ...
    AdTrack.AdformJS3rdChannel = function (t, e, i) {
        ...
        bid: function (t, e) {
            ...
            var i = this.track.getChannelKey(this.chd, e);
            if (i) {
                var n = AdTrack.Utils.objectValues(this.definition.options.blackListedBNs), r = function (t) {
                    var e = t[0];
                    e && e.outdoor ? (this.helper.isBlacklisted(e.outdoor.url, n) && (e.outdoor.clk = null), (new Image).src = e.outdoor.imp, this.track.loaded(this.definition, this.chd, 1, null, t)) : this.track.passback(this.definition, this.chd)
                }.bind(this);
                this.price && this.response ? r(this.response) : this.bid((function (t, e) {
                    r(e)
                }), i)
    ...
    AdTrack.AdformJSVideChannel = function (t, e, i) {
        this.track = t, this.definition = e, this.chd = i, this.adformUtils = new AdTrack._AdFormUtils, this.price = null, this.response = null, this.helper = new AdTrack.AdformHelper(t, e, i), this.trackadProxyUrl = "http://" + this.track.server + "/video/proxy.php", this.bidResponse = new AdTrack.Bid, this.MTsupport = !0
            ...
            try {
                ...
                if (n) {
                    var r = function (t) {
                        var e = t[0];
                        if (e && e.response) {
                            if (this.adData = e[e.response], this.definition.options.videoProxy && e.vast_url) {
                                var n, r = e.vast_url;
                            ...
                            if (e.vast_content && this.definition.options.vastUrl) {
                                var s = "rid" + Math.round(1e7 * Math.random()), o = {vast: e.vast_content, rid: s},
                                    a = this, d = this.adformUtils.b2a(AdTrack.Utils.json2Url(o)).replace(/=+$/, "");
                                AdTrack.Ajax.request({
                                    ...
                                    e.vast_url = "http://" + a.track.server + "/vast.php?v=7&rid=" + s, e.response = "vast_url";
    ...
    AdTrack.AppNexusChannel = function (t, e, i) {
        this.track = t, this.definition = e, this.chd = i, this.id = "AdTrack_" + t.type + "_" + t.domain + "_" + t.group + "_" + t.position, this.price = null, this.response = null, this.style = null, this.bidResponse = new AdTrack.Bid, this.channelName = -1 !== this.chd.tag.indexOf("xandr") ? "xandr" : "appnexus", this.external = this.chd.accountId && this.chd.accountId !== AdTrack.Config.getAccountId(this.channelName), this.MTsupport = !0
        ...
        report: function () {
            ...
            if (i) {
                var n = "//ib.adnxs.com", r = this.createData(e, i);
                if (AdTrack.CMP) {
                    var s = AdTrack.CMP.getConsentData("never", !1);
                    s && (this.track.evBidConsent(this.definition, this.chd), r.gdpr_consent.consent_string = s.consentString ? s.consentString : "", r.gdpr_consent.consent_required = !!s.gdprApplies, s.purpose && s.purpose.consents && "boolean" == typeof s.purpose.consents[1] && !1 === s.purpose.consents[1] && (n = "//ib.adnxs-simple.com"))
                }
                var o = this;
                AdTrack.Ajax.request({
                    ...
                    if (e && e.tags && e.tags[0]) {
                        ...
                        if (i && i.cpm) {
                            if (o.price = AdTrack.Price.create(i.cpm, AdTrack.Price.USD, null), o.bidResponse.setPrice(o.price), o.bidResponse.setCreativeId(i.creative_id), "banner" === i.ad_type) {
                                var n = i.content_source;
                                if (n && i[n] && i[n][i.ad_type]) {
                                    var r = i[n][i.ad_type].content, s = AdTrack.Utils.isBlackListedAds(r);
                                    !1 === s ? (o.bidResponse.setWidth(i[n][i.ad_type] ? i[n][i.ad_type].width : o.chd.width), o.bidResponse.setHeight(i[n][i.ad_type] ? i[n][i.ad_type].height : o.chd.height)) : (o.track.doError("Blocked appnexus-xhr (" + o.chd.tag + ") creative (" + i.creative_id + ") by advertiser (" + i.advertiser_id + ") from " + s, "info"), o.chd.logs && o.chd.logs.blocked_creative && AdTrack.Utils.reportCreative(o.track.server, o.chd.logs.blocked_creative, o.chd.tag, i.creative_id || "", i.deal_id || "", i.cpm, r), o.price = null)
                                }
                            }
                        } else o.price = null
                    } else e && e.error && e.error.match("no bids"), o.price = null;
                    o.response = e, t && t(o.price, e)
                })).fail((function (e, i) {
                    i ? o.track.evBidTimeout(o.definition, o.chd) : o.track.evBidError(o.definition, o.chd), o.price = null, t && t(null, null)
                })).send()
            ...
            if (n) {
                var r = function (t) {
                    if (t && t.tags && t.tags[0]) {
                        ...
                        if (n) {
                            var r = n.content_source, s = n.ad_type;
                            if (r && n[r] && n[r][s]) {
                                var o = n[r][s];
                                this.adData = o.content, this.chd.width = this.bidResponse.getDimension().width, this.chd.height = this.bidResponse.getDimension().height;
                                var a = [];
                                try {
                                ...
                                if ("banner" === s) {
                                    var c = {
                                        ...
                                        width: this.bidResponse.getDimension().width,
                                        height: this.bidResponse.getDimension().height,
                                        ad: {data: o.content, type: "content"},
                                        impTrackers: a
                                    }, h = new AdTrack.MediaTypes.Banner(c, this.track.errorReporting);
                                    i(h)
                                } else if ("video" === s) if (this.definition.options.player && "default" === this.definition.options.player.type) {
                                    ...
                                    i(u)
                                } else this.track.doError(this.chd.tag + ": Not supported outstream without default player type"); else if ("native" === s) {
                                    this.adData = o;
                                    var p = null;
                                    o.main_img && (p = {
                                        url: o.main_img.url,
                                    ...
                                    if (o.icon && (f = {
                                        ...
                                        g.setStyle(e);
                                        var m = new AdTrack.AdChoices, k = o.privacy_link || this.chd.url;
                                        m.setPromoClickUrl(k), m.setPromoText(this.chd.title), m.setOptional(!0), g.addAdChoices(m);
                                        var v = new AdTrack.TextAd, b = o.ctatext || "Navštívit stránku",
                                            y = o.link.url;
                                        v.addScreenshot(p.url, p.w, p.h), v.addText(o.title, o.desc || ""), o.desc2 && v.addText(o.title, o.desc2), v.setCompanyName(o.sponsored), v.setVisibleUrl(o.displayurl), f && v.setFavicon(f.url), v.setClickTrackers(o.link.click_trackers), v.setClickUrl(y), v.setAdUrl(y), v.setCta(b), v.done(), g.addAd(new AdTrack.AppnexusAd(g, v));
                                        var A = new AdTrack.TextChannel(this.track, this.definition, this.chd), T = {
                                            chd: this.chd,
                                            ad: {type: "tcproxy", data: {adSet: g, tc: A}},
                                            style: e,
                                            count: 1,
                                        ...
                                        i(w)
                                    } else this.track.doError("[" + this.chd.tag + "] Insufficient data received (img:" + !!p + "|title:" + !!o.title + ")"), this.track.passback(this.definition, this.chd)
            ...
            }, n = [i], r = this.chd.sizes ? this.chd.sizes : [], s = 0; s < r.length; s++) 2 === r[s].length && n.push({
                width: r[s][0],
                height: r[s][1]
            });
            var o = AdTrack.Utils.simpleStringGenerator(32), a = {
                uuid: AdTrack.Utils.simpleStringGenerator(32),
                member_id: e,
                tags: [{uuid: o, id: Number(t), prebid: !0, primary_size: i, sizes: n, allow_smaller_sizes: !1}],
                gdpr_consent: {},
                user: {},
                sdk: {source: "pbjs", version: ""},
                referrer_detection: {rd_ref: AdTrack.url, rd_top: !!AdTrack.Utils.windowTopAccess()}
            };
            if ("xandr" === this.channelName && !this.external) {
                var d = this.track.getSupplyChain();
                d && (a.schain = d)
            }
            if ("xandr-native" === this.chd.tag && (a.ad_types = ["native"], a.native = {
                layouts: [{
                    title: {
                        required: !0,
                        len: 140
        ...
        report: function () {
            ...
            AdTrack.Ajax.request({
                ...
                if (e && e[0] && e[0].cpm && e[0].ad) {
                    var i = e[0];
                    i.currency && i.currency === AdTrack.Price.USD ? (n.price = AdTrack.Price.create(i.cpm, AdTrack.Price.USD, null), n.bidResponse.setPrice(n.price), n.bidResponse.setCreativeId(i.creativeid), n.bidResponse.setWidth(i.w ? i.w : n.chd.width), n.bidResponse.setHeight(i.h ? i.h : n.chd.height)) : n.track.doError("Channel " + n.chd.tag + " responsed with wrong currency: " + i.currency)
                } else n.price = null;
                n.response = e, t && t(n.price, e)
            })).fail((function (e, i) {
                i ? n.track.evBidTimeout(n.definition, n.chd) : n.track.evBidError(n.definition, n.chd), n.price = null, t && t(null, null)
            ...
            var e = AdTrack.Utils.simpleStringGenerator(14), i = AdTrack.Utils.simpleStringGenerator(14),
                n = AdTrack.Utils.simpleStringGenerator(14), r = new Date, s = [];
            ...
            if (AdTrack.CMP) var a = AdTrack.CMP.getConsentData("never", !1);
            return a && (this.track.evBidConsent(this.definition, this.chd), void 0 !== a.gdprApplies && o.push("gdprApplies=" + encodeURIComponent(!!a.gdprApplies)), void 0 !== a.consentString && o.push("consentString=" + encodeURIComponent(a.consentString))), o.join("&")
        }, getRr: function () {
            try {
    ...
    AdTrack.ConnectAdChannel = function (t, e, i) {
        this.track = t, this.definition = e, this.chd = i, this.price = null, this.response = null, this.track.shouldCsync("connectad") && setTimeout(function () {
            var t = {};
            AdTrack.CMP && (t = AdTrack.CMP.getConsentData("never", !1)), AdTrack.ConnectadCSync(t)
        }.bind(this), 5e3), this.bidId = Math.floor(1e14 * Math.random()), this.transactionId = AdTrack.Utils.uuid(), this.sizeMap = {
            "120x90": 1,
            "468x60": 3,
            "728x90": 4,
            "300x250": 5,
        ...
        report: function () {
            ...
            var i = "" + e, n = this.chd.width + "x" + this.chd.height, r = this.sizeMap[n];
            if (!r) return this.track.doError("Unsupported dimension (" + n + ") in connectad adapter"), void (t && t(null, null));
            for (var s = this.chd.sizes ? this.chd.sizes : [], o = [r], a = 0; a < s.length; a++) {
                var d = s[a][0] + "x" + s[a][1], c = this.sizeMap[d];
            ...
            if (AdTrack.CMP && (u = AdTrack.CMP.getConsentData("never", !1)), u ? (this.track.evBidConsent(this.definition, this.chd), l.ext = {
                consent: u.consentString ? u.consentString : "",
                gdpr: u.gdprApplies ? 1 : 0
            }) : l.ext = {gdpr: 1}, AdTrack.UserID) {
            ...
            AdTrack.Ajax.request({
                ...
                if (e.decisions && e.decisions[m.bidId]) {
                    var i = e.decisions[m.bidId], n = i.pricing && i.pricing.clearPrice ? i.pricing.clearPrice : null,
                        r = 0 != i.creativeId ? i.creativeId : i.adId;
                    m.price = n ? AdTrack.Price.create(n, AdTrack.Price.USD) : null, m.bidResponse.setCreativeId(r), m.bidResponse.setPrice(m.price);
                    var s = i.contents && i.contents[0] ? i.contents[0] : null;
                    if (s) {
                        var o = AdTrack.Utils.isBlackListedAds(s.body);
                        !1 === o ? (m.bidResponse.setWidth(s.width || s.data.width), m.bidResponse.setHeight(s.height || s.data.height)) : (m.track.doError("Blocked connectad creative from " + o + " with id " + i.creativeId, "info"), m.chd.logs && m.chd.logs.blocked_creative && AdTrack.Utils.reportCreative(m.track.server, m.chd.logs.blocked_creative, m.chd.tag, r || "", "", n, s.body), e = null, m.price = null)
                    }
                } else m.price = null;
                m.response = e, t && t(m.price, e)
            })).fail((function (e, i) {
                i ? m.track.evBidTimeout(m.definition, m.chd) : m.track.evBidError(m.definition, m.chd), m.price = null, t && t(null, null)
            })).send()
        }, render: function (t, e, i) {
            e = e.normal;
            var n = this.track.getChannelKey(this.chd, e);
            if (n) {
                var r = function (t) {
                    if (t.decisions && t.decisions[this.bidId]) {
                        var e = t.decisions[this.bidId], n = e.contents && e.contents[0] ? e.contents[0] : null;
                        if (n && n.body) {
                            this.adData = n.body, this.chd.width = this.bidResponse.getDimension().width, this.chd.height = this.bidResponse.getDimension().height;
                            var r = {
                                chd: this.chd,
                                width: this.bidResponse.getDimension().width,
                                height: this.bidResponse.getDimension().height,
                                ad: {data: n.body, type: "content"},
        ...
        if (!i) {
            var e = [];
            if (t) {
                e.push("gdpr=" + encodeURIComponent(t.gdprApplies ? 1 : 0)), e.push("gdpr_consent=" + encodeURIComponent(t.consentString ? t.consentString : ""));
                var n = "https://cdn.connectad.io/connectmyusers.php?" + e.join("&");
                AdTrack.Utils.csyncFrame(n), i = !0
            }
        }
    })
}, function (t, e) {
    AdTrack.CriteoHBChannel = function (t, e, i) {
        ...
        report: function () {
            ...
            this.profiling("bid start"), window.Criteo = window.Criteo || {}, window.Criteo.events = window.Criteo.events || [];
            var i = this.createPlacement(e), n = null;
            if (!i.zoneid) {
                n = AdTrack.Config.getAccountId("criteo");
                var r = [];
                this.chd.width && this.chd.height && r.push(this.chd.width + "x" + this.chd.height), this.chd.sizes && this.chd.sizes.length > 0 && this.chd.sizes.forEach((function (t) {
                    2 === t.length && r.push(t[0] + "x" + t[1])
                })), i.sizes = r
            }
            if (!i) return this.track.doError("Wrong format for key, should be either [zoneid]-[publisherSubid] or just zoneid"), void (t && t(this.price, this.response));
            var s = function () {
                var e = {placements: [i]};
            ...
            return function (t) {
                ...
                if (t && t.length > 0) {
                    ...
                    var n = i.width || this.chd.width, r = i.height || this.chd.height;
                    this.bidResponse.setWidth(n), this.bidResponse.setHeight(r)
                } else this.price = null;
                this.response = i, e && e(this.price, i)
            }.bind(this)
        }, createPlacement: function (t) {
            if (t) {
                var e = "", i = "", n = (t = "" + t).indexOf("-");
                if (n < 0 ? isNaN(t) ? i = t : e = t : (e = t.substr(0, n), i = t.substr(n + 1), isNaN(e) && (e = "", i = t)), !e && !i) return null;
                var r = {slotid: "ad-" + (e ? "-" + e : "") + (i ? "-" + i : "")};
    ...
    AdTrack.CriteoHBNativeChannel = function (t, e, i) {
        ...
        report: function () {
            ...
            if (this.adData = i, i.products) {
                var n = new AdTrack.AdSet;
                n.setStyle(e);
                var r = i.advertiser, s = new AdTrack.Shop;
                s.setShopLogo(r.logo.url), s.setShopUrl(r.logo_click_url), s.setShopName(r.description), s.setCleanShopUrl(r.domain), n.addShop(s);
                for (var o = i.products, a = 0; a < o.length; a++) {
                    var d = o[a], c = new AdTrack.ProductAd;
                    if (!d.image.url || !d.title) return this.track.doError("[" + this.chd.tag + "] Insufficient data received (img:" + !!d.image.url + "|title:" + !!d.title + ")"), void this.track.passback(this.definition, this.chd);
                    c.setClickUrl(d.click_url), c.setProductName(d.title);
                    var h = d.description;
                    h && h.length > 0 && (h = h[0].toUpperCase() + h.slice(1)), c.setProductDescription(h), d.price && c.setProductPrice(d.price), c.addScreenshot(d.image.url, 0, 0), c.done(), n.addAd(new AdTrack.CriteoProductAd(n, c))
                }
                this.chd.url = i.privacy.optout_click_url, this.chd.icon = i.privacy.optout_image_url;
                var l = new AdTrack.AdChoices;
                l.setPromoClickUrl(this.chd.url), l.setPromoIcon(this.chd.icon), l.setPromoText(this.chd.title), l.setOptional(!1), n.addAdChoices(l), new AdTrack.TextChannel(this.track, this.definition, this.chd).renderAds(t, n);
                for (var u = i.impression_pixels, p = 0; p < u.length; p++) {
                    var f = u[p], g = this.track.window.document.createElement("img");
                    g.setAttribute("src", f.url), g.setAttribute("style", "width: 0px; height: 0px; border-style: none; display: none;"), t.appendChild(g)
                }
            ...
            if (t) {
                ...
                if (n < 0) {
                    if (!(e = t)) return null
                } else if (e = t.substr(0, n), i = t.substr(n + 1), !e || !i) return null;
                var r = {
                    slotid: "ad-" + e + (i ? "-" + i : ""),
                    zoneid: e,
    ...
    AdTrack.CriteoHBXHRChannel = function (t, e, i) {
        ...
        report: function () {
            ...
            var i = [];
            this.chd.width && this.chd.height && i.push(this.chd.width + "x" + this.chd.height), this.chd.sizes && this.chd.sizes.length > 0 && this.chd.sizes.forEach((function (t) {
                2 === t.length && i.push(t[0] + "x" + t[1])
            }));
            var n = {};
            AdTrack.CMP && (n = AdTrack.CMP.getConsentData("never", !1));
            var r = AdTrack.Criteo.buildContext(n), s = AdTrack.Criteo.buildCdbUrl(r);
            ...
            if (!o) return this.track.doError("Wrong format for key, should be either [zoneid]-[publisherSubid] or just zoneid"), void (t && t(this.price, this.response));
            var a = JSON.stringify(o);
            try {
                var d;
                if ("classic_lidovky.cz_hb-premium_300x600" === this.track.unitID.getName()) if (e.match(/300x600/)) o.slots[0].impid.match(/300x600/) ? a.match(/impid":"[^"]*300x600/) ? a.match(/publishersubid":"[^"]*300x600/) || (d = a.match(/publishersubid":"[^"]*"/), this.track.doError("Corrupt criteo publishersubid in json string (" + (d && d[1] ? d[1] : "???") + ")", this.track.unitID, "debug")) : (d = a.match(/impid":"([^"]*)"/), this.track.doError("Corrupt criteo impid in json string (" + (d && d[1] ? d[1] : "???") + ")", this.track.unitID, "debug")) : this.track.doError("Corrupt criteo impid " + o.slots[0].impid, this.track.unitID, "debug"); else this.definition.waterfall.tiers[0].forEach(function (t) {
                    if (t.chd.tag === this.chd.tag && t.chd.flag === this.chd.flag) {
                        var i = !1;
                        for (var n in t.chd.keys) if (t.chd.keys.hasOwnProperty(n) && t.chd.keys[n] === e) {
                            i = !0;
                            break
                        }
            ...
            AdTrack.Ajax.request({
                ...
                if (e && e.slots) {
                    var i = e.slots[0];
                    i ? (c.price = AdTrack.Price.create(i.cpm, AdTrack.Price.EUR, null), c.bidResponse.setPrice(c.price), c.bidResponse.setWidth(i.width), c.bidResponse.setHeight(i.height)) : c.price = null
                } else c.price = null;
                c.response = e, t && t(c.price, e)
            })).fail((function (e, i) {
                i ? c.track.evBidTimeout(c.definition, c.chd) : c.track.evBidError(c.definition, c.chd), c.price = null, t && t(null, null)
            })).send()
        }, render: function (t, e, i) {
            this.container = t, e = e.normal;
            var n = this.track.getChannelKey(this.chd, e);
                    ...
                    if (t && t.slots && t.slots[0]) {
                        ...
                        if (e.creative) {
                            var n = {
                                ...
                                width: this.bidResponse.getDimension().width,
                                height: this.bidResponse.getDimension().height,
                                ad: {data: e.creative, type: "iframe"}
                            };
    ...
    AdTrack.CriteoHBXHRNativeChannel = function (t, e, i) {
        this.track = t, this.definition = e, this.chd = i, this.price = null, this.response = null, this.bidResponse = new AdTrack.Bid
        ...
        report: function () {
            ...
            AdTrack.Ajax.request({
                ...
                if (e && e.slots) {
                    var i = e.slots[0];
                    i ? (a.price = AdTrack.Price.create(i.cpm, AdTrack.Price.EUR, null), a.bidResponse.setPrice(a.price), a.bidResponse.setWidth(a.chd.width || i.width), a.bidResponse.setHeight(a.chd.height || i.height)) : a.price = null
                } else a.price = null;
    ...
    AdTrack.DecenterAdsHBChannel = function (t, e, i) {
        ...
        report: function () {
            ...
            AdTrack.CMP && (r = AdTrack.CMP.getConsentData("never", !1)), r && r.consentString && (this.track.evBidConsent(this.definition, this.chd), n.gdpr = r.gdprApplies ? 1 : 0, n.gdpr_consent = r.consentString), n.placements.push({
                ...
                var r = function (t) {
                    if (t && t[0] && t[0].ad) {
                        var e = {
                            ...
                            width: this.bidResponse.getDimension().width,
                            height: this.bidResponse.getDimension().height,
                            ad: {data: "<html><head></head><body>" + t[0].ad + "</body></html>", type: "content"}
                        };
                        this.adData = e.ad.data;
                        var n = new AdTrack.MediaTypes.Banner(e, this.track.errorReporting);
                        n.on("load", function () {
            ...
            if (n) {
                var r = function (t) {
                    if (t && t.seatbid && t.seatbid[0] && t.seatbid[0].bid && t.seatbid[0].bid[0]) {
                        var e = t.seatbid[0].bid[0], n = e.price.toFixed(2);
                        "" != e.nurl && (e.nurl = e.nurl.replace(/\$\{AUCTION_PRICE\}/, n), (new Image).src = e.nurl), "string" == typeof e.burl && e.burl.length > 0 && (e.adm = e.adm.replace(/\$\{AUCTION_PRICE\}/, n)), this.adData = e.adm, this.chd.width = this.bidResponse.getDimension().width, this.chd.height = this.bidResponse.getDimension().height;
                        var r = {
                            chd: this.chd,
                            width: this.bidResponse.getDimension().width,
                            height: this.bidResponse.getDimension().height,
                            ad: {data: e.adm, type: "content"}
                        }, s = new AdTrack.MediaTypes.Banner(r, this.track.errorReporting);
                        i(s)
                    } else this.track.passback(this.definition, this.chd)
                }.bind(this);
    ...
    AdTrack.MgidHBNativeChannel = function (t, e, i) {
        this.track = t, this.definition = e, this.chd = i, this.floorPrice = null, this.price = null, this.response = null, this.bidResponse = new AdTrack.Bid, this.helper = new AdTrack.MgidHelper(t, e, i)
        ...
        report: function () {
            ...
            this.floorPrice = t, this.helper.setFloorPrice(t)
        }, render: function (t, e) {
            var i = this.track.getChannelKey(this.chd, e);
            if (i) {
                var n = function (i) {
                    if (i && i.seatbid && i.seatbid[0] && i.seatbid[0].bid && i.seatbid[0].bid[0]) {
                        var n = i.seatbid[0].bid[0], r = n.price.toFixed(2);
                        "" != n.nurl && (n.nurl = n.nurl.replace(/\$\{AUCTION_PRICE\}/, r), (new Image).src = n.nurl), "string" == typeof n.burl && n.burl.length > 0 && (n.adm = n.adm.replace(/\$\{AUCTION_PRICE\}/, r)), this.adData = n;
                        try {
            ...
            if (i) {
                var d = i.maxTitleLength || i.maxTextLength, c = i.maxDescLength || i.maxTextLength;
                if (n > 80 && !d) return this.track.doError("mgid native - possible title overflow (" + n + "), style: " + e.name, "debug"), !1;
                if (r > 150 && !c) return this.track.doError("mgid native - possible description overflow (" + r + "), style: " + e.name, "debug"), !1;
                if (i.imgWidth && i.imgHeight) {
                    var h = i.imgWidth, l = i.imgHeight, u = h / l;
                    if (!(u < 1.5 ? a >= u / 1.1 && a <= u / .9 : a >= u / 1.15 && a <= u / .85)) return this.track.doError("mgid native - image not optimal, img [" + s + ", " + o + "], optimal [" + h + ", " + l + "], style: " + e.name, "debug"), !1
                }
            } else this.track.doError("No native options included, style: " + e.name);
            return !0
        }, parseAssets: function (t) {
            ...
            r.setStyle(i);
            var s = new AdTrack.AdChoices;
            s.setPromoClickUrl(this.chd.url), s.setPromoText(this.chd.title ? this.chd.title : "Reklama"), s.setOptional(!0), r.addAdChoices(s);
            var o = new AdTrack.TextAd, a = n.link, d = a.clicktrackers || void 0, c = n.imptrackers || void 0,
                h = this.parseAssets(n.assets);
            if (!this.isAdValidForRender(h, i)) return !1;
            var l = h.image, u = h.favicon;
            o.addText(h.title, h.description), l && o.addScreenshot(l.url, l.width, l.height, l.url);
            var p = h.cta ? h.cta : "Navštívit stránku", f = h.advertiser ? h.advertiser : "", g = "";
            u && u.url && (g = u.url);
            var m = !0 === this.definition.test ? "" : a.url;
            return o.setClickTrackers(d), o.setClickUrl(m), o.setVisibleUrl(""), o.setAdUrl(""), o.setCta(p), o.setFavicon(g), o.setCompanyName(f), o.done(), r.addAd(new AdTrack.MgidAd(r, o)), new AdTrack.TextChannel(this.track, this.definition, this.chd).renderAds(e, r), c && c.forEach((function (t) {
                (new Image).src = t
            })), !0
        }
    }
    ...
    AdTrack.OneTagChannel = function (t, e, i) {
        this.track = t, this.definition = e, this.chd = i, this.price = null, this.response = null, this.style = null, this.bidResponse = new AdTrack.Bid, this.MTsupport = !0, this.chd.sizes ? (this.sizes = this.chd.sizes, this.sizes.unshift([this.chd.width, this.chd.height])) : this.sizes = [[this.chd.width, this.chd.height]], AdTrack.CMP && (this.consent = AdTrack.CMP.getConsentData("never", !1)), this.track.shouldCsync("onetag") && setTimeout(function () {
        ...
        report: function () {
            ...
            if (i) {
                var n = this.createData(e, i), r = this;
                AdTrack.Ajax.request({
                    label: "Onetag bid",
                    ...
                    if (e && e.bids && e.bids[0] && e.bids[0].cpm && e.bids[0].ad) {
                        var i = e.bids[0];
                        e.currency && e.currency !== AdTrack.Price.EUR ? r.track.doError("Channel " + r.chd.tag + " responsed with wrong currency: " + e.currency) : (r.price = AdTrack.Price.create(i.cpm, AdTrack.Price.EUR, null), r.bidResponse.setPrice(r.price), r.bidResponse.setCreativeId(i.creativeId), r.bidResponse.setWidth(i.width ? i.width : r.chd.width), r.bidResponse.setHeight(i.height ? i.height : r.chd.height))
                    } else r.price = null;
            ...
            var i = AdTrack.Utils.simpleStringGenerator(14), n = AdTrack.Utils.simpleStringGenerator(14),
                r = AdTrack.Utils.simpleStringGenerator(14), s = AdTrack.Utils.simpleStringGenerator(14), o = new Date,
                a = [];
            for (let t = 0; t < this.sizes.length; t++) {
                const e = this.sizes[t];
                a.push({width: e[0], height: e[1]})
            }
            var d = {
                bids: [{
                    adUnitCode: t,
            ...
            return this.consent && (this.track.evBidConsent(this.definition, this.chd), d.gdprConsent = {
                consentString: this.consent.consentString,
                consentRequired: this.consent.gdprApplies
            }), d
        }
    }, AdTrack.OneTagCSync = AdTrack.OneTagCSync || (i = !1, function (t) {
        if (!i) {
            var e = "https://onetag-sys.com/usync/?cb=" + (new Date).getTime();
            t && (e += "&gdpr_consent=" + (t.consentString ? t.consentString : ""), e += "&gdpr=" + (t.gdprApplies ? 1 : 0));
            var n = document.createElement("iframe");
            n.src = e, n.style.display = "none", window.document.body.appendChild(n), i = !0
        }
    })
}, function (t, e) {
    ...
    AdTrack.PubmaticHBOutstreamChannel = function (t, e, i, n) {
        this.track = t, this.definition = e, this.chd = i, this.data = n, this.price = null, this.response = null, this.bidResponse = new AdTrack.Bid, this.helper = new AdTrack.PubmaticHelper(t, e, i), this.MTsupport = !0
    ...
    AdTrack.R2B2Channel = function (t, e, i) {
        this.track = t, this.definition = e, this.chd = i, this.delayTime = 1e3, this.cookieSync()
    }, AdTrack.R2B2Channel.prototype = {
        bid: function (t, e) {
            var i = this, n = this.createData(e);
            n ? AdTrack.Ajax.request({
                ...
                if (e.seatbid && e.seatbid[0] && e.seatbid[0].bid && e.seatbid[0].bid[0]) {
                    var n = e.seatbid[0].bid[0], r = e.seatbid[0].seat;
                    i.chd.flag = "-" + r, i.price = AdTrack.Price.create(n.price, AdTrack.Price.USD, n.dealid), "DID-811-92131" == n.dealid && i.track.doError("Deal ID (DID-811-92131) received directly from R2B2 channel with price " + n.price + " USD", "debug")
                } else i.price = null;
                ...
                n ? i.track.evBidTimeout(i.definition, i.chd) : i.track.evBidError(i.definition, i.chd), i.price = null, t && t(null, null)
            })).send() : t(null, null)
        }, render: function (t, e) {
            e = e && e.normal ? e.normal : null;
            var i = this.track.getChannelKey(this.chd, e);
            if (i) {
                var n = function (i) {
                    if (i && i.seatbid && i.seatbid[0] && i.seatbid[0].bid && i.seatbid[0].bid[0]) {
                        var n = i.seatbid[0].bid[0], r = n.adm, s = n.w, o = n.h;
                        n.ext.prebid.type;
                        this.chd.width = s, this.chd.height = o;
                        var a = function () {
                            this.track.evClick(this.definition, this.chd, void 0, null, null, null, null, e)
                        }.bind(this);
                        if (r.match(/^<iframe/i)) AdTrack.iframeCreator.factory.createIframeFromHTML(t, r, a); else {
                        ...
                        n.iurl && AdTrack.Utils.firePixel(n.iurl), this.track.loaded(this.definition, this.chd, 1, e, null)
                    } else this.track.passback(this.definition, this.chd)
                }.bind(this);
                this.price && this.response ? n(this.response) : this.bid((function (t, e) {
                    n(e)
            ...
            var e = AdTrack.Utils.uuid(), i = "AdTrack" + Math.round(1e9 * Math.random()), n = {}, r = {}, s = null;
            if (AdTrack.CMP && (s = AdTrack.CMP.getConsentData(this.track.cmpFallback, this.track.cookiesEnabled)), s && (this.track.evBidConsent(this.definition, this.chd), n.ext = {consent: s.consentString ? s.consentString : ""}, r.ext = {gdpr: s.gdprApplies ? 1 : 0}), "object" == typeof t && t.d && t.g && t.p && t.t) return t.m = t.m || 0, {
                id: e,
                user: n,
                regs: r,
                site: {page: AdTrack.url},
                imp: [{id: i, ext: {r2b2: t}, banner: {format: [{h: this.chd.height, w: this.chd.width}]}}],
                source: {tid: e},
                test: 1,
                tmax: this.delayTime
            };
            ...
            if (t.d && t.g && t.p && t.t) {
                t.m = t.m || 0;
                var e = [{d: t.d, g: t.g, p: t.p, m: t.m, t: t.t}],
    ...
    AdTrack.RubiconBannerHBChannel = function (t, e, i) {
        this.track = t, this.definition = e, this.chd = i, this.MTsupport = !0, this.price = null, this.response = null, this.track.shouldCsync("rubicon") && setTimeout(function () {
            AdTrack.RubiconCSync()
        }.bind(this), 5e3), this.accountId = this.chd.accountId || AdTrack.Config.getAccountId("rubicon"), this.external = this.accountId !== AdTrack.Config.getAccountId("rubicon"), this.bidResponse = new AdTrack.Bid, this.sizesMas = {
            "468x60": 1,
            "728x90": 2,
            "234x60": 3,
            "88x31": 4,
        ...
        report: function () {
            ...
            var i = "https:" === location.protocol ? "1" : "0",
                n = [window.screen.width, window.screen.height].join("x"), r = this.chd.width + "x" + this.chd.height,
                s = this.sizesMas[r];
            if (!s) return this.track.doError("Unsupported dimension (" + r + ") in rubicon adapter"), void (t && t(null, null));
            this.actualSizes[s] = [this.chd.width, this.chd.height];
            for (var o = this.chd.sizes ? this.chd.sizes : [], a = [], d = 0; d < o.length; d++) {
                var c = o[d][0] + "x" + o[d][1], h = this.sizesMas[c];
                h ? (a.push(h), this.actualSizes[h] = o[d]) : this.track.doError("Unsupported dimension (" + c + ") in rubicon adapter")
            }
            var l = e.split("-");
            ...
            if (p && !this.external && (u.rp_schain = p), AdTrack.UserID) for (var f = AdTrack.UserID.getAllUserIdsAsEids(), g = 0; g < f.length; g++) {
                var m = f[g];
            ...
            var v = {};
            AdTrack.CMP && (v = AdTrack.CMP.getConsentData("never", !1)), v && (this.track.evBidConsent(this.definition, this.chd), v.gdprApplies && (u.gdpr = v.gdprApplies ? 1 : 0), v.consentString && (u.gdpr_consent = v.consentString));
            ...
            AdTrack.Ajax.request({
                ...
                if ("ok" === e.status && e.ads && e.ads[0] && "ok" === e.ads[0].status) {
                    var i = e.ads[0], n = y.actualSizes[i.size_id];
                    if (!n) return y.track.doError("Unexpected size_id (" + i.size_id + ") in response (rubicon)"), void (t && t(null, e));
                    y.chd.width = n[0], y.chd.height = n[1], y.price = AdTrack.Price.create(i.cpm, AdTrack.Price.USD), y.bidResponse.setCreativeId(i.creative_id), y.bidResponse.setWidth(n[0]), y.bidResponse.setHeight(n[1]), y.bidResponse.setPrice(y.price)
                } else y.price = null;
                y.response = e, t && t(y.price, e)
            })).fail((function (e, i) {
                i ? y.track.evBidTimeout(y.definition, y.chd) : y.track.evBidError(y.definition, y.chd), y.price = null, t && t(null, null)
            })).send()
        }, render: function (t, e, i) {
            e = e.normal;
            var n = this.track.getChannelKey(this.chd, e);
            if (n) {
                var r = function (t) {
                    if (t && t.ads && t.ads[0] && "ok" === t.ads[0].status) {
                        var e = t.ads[0], n = Number(e.size_id), r = this.getCreative(e.script, e.impression_id), s = {
                            chd: this.chd,
                            width: this.bidResponse.getDimension().width,
                            height: this.bidResponse.getDimension().height,
                            ad: {type: "content", data: r}
                        };
    ...
    AdTrack.RubiconVideoHBChannel = function (t, e, i) {
        this.track = t, this.definition = e, this.chd = i, this.price = null, this.response = null, this.track.shouldCsync("rubicon") && setTimeout(function () {
            AdTrack.RubiconCSync()
        }.bind(this), 5e3), this.accountId = this.chd.accountId || AdTrack.Config.getAccountId("rubicon"), this.bidResponse = new AdTrack.Bid, this.MTsupport = !0
        ...
        report: function () {
            ...
            AdTrack.Ajax.request({
                ...
                if (e && e.seatbid && e.seatbid[0] && e.seatbid[0].bid && e.seatbid[0].bid[0]) {
                    ...
                    var r = e.seatbid[0].bid[0];
                    i = AdTrack.Price.create(r.price, e.cur || AdTrack.Price.USD, null), n.bidResponse.setPrice(i), n.bidResponse.setWidth(r.w || n.chd.width), n.bidResponse.setHeight(r.h || n.chd.height)
                }
                n.response = e, t && t(n.price, e)
            })).fail((function (e, i) {
                i ? n.track.evBidTimeout(n.definition, n.chd) : n.track.evBidError(n.definition, n.chd), n.price = null, t && t(null, null)
            ...
            if (n) {
                var r = function (t) {
                    if (t && t.seatbid && t.seatbid[0] && t.seatbid[0].bid && t.seatbid[0].bid[0]) {
                        var e = t.seatbid[0].bid[0], n = e.adm || "", r = e.nurl || "";
                        if (n || r) {
            ...
            var i = this.accountId, n = e[0], r = e[1], s = AdTrack.Utils.uuid(), o = "" + (new Date).getTime(), a = "";
            try {
                a = this.track.getDomainName(window.top.location.hostname)
            } catch (t) {
                a = this.track.getDomainName(window.location.hostname)
            ...
            if (AdTrack.CMP && (l = AdTrack.CMP.getConsentData("never", !1)), l && (this.track.evBidConsent(this.definition, this.chd), d.ext.consent = l.consentString ? l.consentString : "", c.ext.gdpr = l.gdprApplies ? 1 : 0), AdTrack.UserID) {
            ...
            return {
                ...
                imp: [h],
                ext: {},
                site: {domain: a, page: AdTrack.url, ref: AdTrack.url},
                device: {
                    ip: this.track.settings.ip ? this.track.settings.ip : "",
                    ua: navigator.userAgent,
                    js: 1,
    ...
    AdTrack.SeznamSspHbChannel = function (t, e, i) {
        this.track = t, this.definition = e, this.chd = i, this.delayTime = 1e3, this.destroyed = !1, this.helper = new AdTrack.SeznamHelper(t, e, i), this.trackServed = [], this.trackVisible = [], this.bidResponse = new AdTrack.Bid
        ...
        report: function () {
            ...
            AdTrack.Ajax.request({
                ...
                if (e.seatbid && e.seatbid[0] && e.seatbid[0].bid && e.seatbid[0].bid[0]) {
                    ...
                    e.cur && "CZK" === e.cur ? (i.price = AdTrack.Price.create(n.price, AdTrack.Price.CZK), i.bidResponse.setPrice(i.price), i.bidResponse.setWidth(n.w || i.width), i.bidResponse.setHeight(n.h || i.height)) : (i.price = null, i.track.doError("Unknown bid response currency '" + e.cur + "' passed to " + i.chd.tag))
                } else i.price = null;
            ...
            var i = function (i) {
                var n = this;
                if (!i.seatbid) return this.track.doError("[" + this.chd.tag + "] Empty response from Seznam SSP"), void this.track.passback(this.definition, n.chd);
                var r = i.seatbid[0].bid[0], s = "";
                if (r.adm && "" !== r.adm) try {
                    ...
                    return this.track.doError("[" + n.chd.tag + "] Unsupported adm response", t), void this.track.passback(this.definition, n.chd)
                } else s = i.seatbid[0].bid[0].nurl;
                var o = function (i) {
                    if (i && i.ads) if (n.response2 = i, i.ads) {
                        if (i.ads.length <= 0) return n.track.doError("[" + n.chd.tag + "] Empty response from Seznam SSP"), void n.track.passback(n.definition, n.chd);
                        var r = e && e.normal ? e.normal : null;
                        n.helper.isProductAd(i.ads) && (r = e && e.product ? e.product : null), n.adData = i.ads;
                        var s = function () {
                            n.trackServed.forEach((function (t) {
                                (new Image).src = t
                            })), n.track.renderer.on("impress", (function () {
                                (new Image).src = i.confirmImpUrl, n.trackVisible.forEach((function (t) {
                                    (new Image).src = t
                        ...
                        n.helper.isBranding(i.ads) ? (n.helper.renderBranding(i.ads, t, n.chd.width, n.chd.height), n.track.loaded(n.definition, n.chd, 1, r, null), s()) : n.helper.processResult(i.ads, t, r, (function (t, e) {
                            n.destroyed || (r = e || r, n.track.loaded(n.definition, n.chd, t, r, null), s())
                        }), (function () {
                            n.destroyed || n.track.passback(n.definition, n.chd)
                        }), "sssp-hb")
                    } else n.track.doError("[" + n.chd.tag + "] Unknown response from Seznam SSP"), n.track.passback(n.definition, n.chd); else n.track.passback(n.definition, n.chd)
                };
                void 0 === this.admJSON || "json_url" === this.admJSON.type ? AdTrack.Ajax.request({
                    ...
                    n.track.doError("[" + n.chd.tag + "] Request to 'nurl' failed: " + t), n.track.passback(n.definition, n.chd)
                })).send() : "json" === this.admJSON.type ? o(this.admJSON.data) : (this.track.doError("[" + n.chd.tag + "] Unsupported response type: " + this.admJSON.type), this.track.passback(n.definition, n.chd))
            }.bind(this);
            if (this.price && this.response1) i(this.response1); else {
            ...
            for (var e = function (t) {
                ...
                w: this.chd.width,
                h: this.chd.height
            }], r = this.chd.sizes ? this.chd.sizes : [], s = 0; s < r.length; s++) 2 === r[s].length && n.push({
                w: r[s][0],
                h: r[s][1]
            });
            return t ? {
                id: e,
                imp: [{id: i, tagid: t, banner: {format: n}}],
                site: {page: AdTrack.url},
                ext: {pvId: this.helper.generatePvId(), browserhash: this.helper.computeHash(), adblock: !1}
            } : (this.track.doError("[" + this.chd.tag + "] Key undefined"), {})
        }
    }
}, function (t, e) {
    AdTrack.SeznamSspHb2Channel = function (t, e, i) {
        (this.track = t, this.definition = e, this.chd = i, this.destroyed = !1, this.helper = new AdTrack.SeznamHelper(t, e, i), this.trackServed = [], this.trackVisible = [], this.bidResponse = new AdTrack.Bid, window.DOT || AdTrack.Libs.isDeployed("seznam-dot")) || AdTrack.Libs.deploy("seznam-dot", "https://h.seznam.cz/js/dot-small.js").onload((function () {
            DOT.cfg({service: "sklikp", load: !1, mousedown: !1})
        }))
        ...
        report: function () {
            ...
            AdTrack.Ajax.request({
                ...
                if (e.seatbid && e.seatbid[0] && e.seatbid[0].bid && e.seatbid[0].bid[0]) {
                    var n = e.seatbid[0].bid[0];
                    e.cur && "CZK" === e.cur ? (i.price = AdTrack.Price.create(n.price, AdTrack.Price.CZK), i.bidResponse.setPrice(i.price), i.bidResponse.setWidth(n.w || i.chd.width), i.bidResponse.setHeight(n.h || i.chd.height)) : (i.price = null, i.track.doError("Unknown bid response currency '" + e.cur + "' passed to " + i.chd.tag))
                } else i.price = null;
                i.response = e, t && t(i.price, e)
            })).fail((function (e, n) {
                n ? i.track.evBidTimeout(i.definition, i.chd) : i.track.evBidError(i.definition, i.chd), i.price = null, t && t(null, null)
            ...
            var i = function (i) {
                ...
                if (i.seatbid && i.seatbid[0] && i.seatbid[0].bid && i.seatbid[0].bid[0]) {
                    ...
                    var o = function (i) {
                        if (i && i.ads) if (n.adResponse = i, i.ads) {
                            if (i.ads.length <= 0) return n.track.doError("[" + n.chd.tag + "] Empty response from Seznam SSP"), void n.track.passback(n.definition, n.chd);
                            var r = e && e.normal ? e.normal : null;
                            n.helper.isProductAd(i.ads) && (r = e && e.product ? e.product : null), n.adData = i.ads;
                            var s = function () {
                ...
                } else this.track.doError("[" + n.chd.tag + "] Empty response from Seznam SSP"), this.track.passback(n.definition, n.chd)
            }.bind(this);
            if (this.price && this.response) i(this.response); else {
                var n = this.helper.getKeyBasedOnStyle(e, this.chd);
                n ? this.bid((function (t, e) {
                    i(e)
                }), n) : this.track.doError("Undefined key")
            ...
            for (var e = AdTrack.Utils.uuid(), i = "AdTrack" + Math.round(1e9 * Math.random()), n = AdTrack.Utils.getUrlWithoutSafeFrame(this.track), r = AdTrack.Utils.readCookie("sid"), s = [{
                w: this.chd.width,
                h: this.chd.height
            }], o = this.chd.sizes ? this.chd.sizes : [], a = 0; a < o.length; a++) 2 === o[a].length && s.push({
                w: o[a][0],
                h: o[a][1]
            });
            if (t) {
                var d = {
                    id: e,
                    imp: [{id: i, tagid: t, bidfloor: this.chd.bidFloor, bidfloorcur: "CZK", banner: {format: s}}],
                    site: {page: n},
                    user: {buyeruid: r},
                    ext: {pvId: this.helper.generatePvId(), adblock: !1, source: ""}
                }, c = null;
                return AdTrack.CMP && (c = AdTrack.CMP.getConsentData("never", !1)), c && (this.track.evBidConsent(this.definition, this.chd), d.user.ext = {}, d.user.ext.consent = c.consentString ? c.consentString : "", d.user.ext.gdpr = !!c.gdprApplies), d
            }
    ...
    AdTrack.SklikHBChannel = function (t, e, i) {
        (this.track = t, this.definition = e, this.chd = i, this.destroyed = !1, this.floorPrice = null, window.DOT || AdTrack.Libs.isDeployed("sklik")) || AdTrack.Libs.deploy("sklik", "https://h.imedia.cz/js/dot-small.js").onload((function () {
            DOT.cfg({service: "sklikp", load: !1, mousedown: !1})
        }))
        ...
        report: function () {
            ...
            var i = function (t, e) {
                return {result: t, r2: e}
            }, n = (Math.round(1e6 * Math.random()), function (e, n) {
                if (e && e.length > 0 && n) {
                    this.response = i(e, n);
                    var r = null;
                    this.floorPrice && (r = AdTrack.Price.create(this.floorPrice.value, this.floorPrice.currency), this.price = r)
                } else this.price = null, this.response = i(e, n);
                t && t(this.price, this.response)
            }.bind(this)), r = this.getTestAds();
            if (r) n(r, {confirmImpUrl: "https://trackad.cz/"}); else {
                var s = AdTrack.url,
            ...
            if (this.definition.options.noAsync) this.track.doError("Sync rendering not supported for " + this.chd.tag); else if (Object.keys(this.chd.keys).length > 0) {
                var i = !1, n = e && e.normal ? e.normal : null;
                e && e.product && (i = !0);
                var r = this.getKeyBasedOnStyle(e, this.chd);
                if (r) {
                    var s = function (r) {
                        if (r && r.result && r.result.length > 0 && r.r2) {
                            var s = r.result, o = r.r2;
                            i || "sklik-hb-banner" === this.chd.tag || this.track.doError("Undefined product style."), this.isProductAd(s) && (n = e && e.product ? e.product : null), this.processResult(s, t, n, o.confirmImpUrl) && (this.measureImpress(t, n, o.confirmImpUrl), this.track.loaded(this.definition, this.chd, this.count, n, null))
                        } else this.track.passback(this.definition, this.chd)
                    }.bind(this);
            ...
            } else this.track.doError("Ad count is lower or equal 0 (" + this.chd.tag + ")")
        }, getKeyBasedOnStyle: function (t, e) {
            var i, n = null, r = 0;
            return t && (t.product && (i = t.product.count ? t.product.count : 0), t.normal && (r = t.normal.count ? t.normal.count : 0), n = i || r ? this.track.getChannelKey(e, i > r ? t.product : t.normal) : this.track.getChannelKey(e, null)), n
        }, processResult: function (t, e, i, n) {
            var r, s;
            for (this.adData = t, this.count = t.length, this.style = i, s = 0; s < t.length; s++) "SHOP" == t[s].adType && (r = t[s], this.count--);
            var o = new AdTrack.AdSet;
            o.setStyle(i);
            var a = new AdTrack.AdChoices;
            for (a.setPromoClickUrl(this.chd.url ? this.chd.url : "https://napoveda.sklik.cz/cz/co-je-reklama-sklik.html"), a.setPromoText(this.chd.title), a.setOptional(!0), o.addAdChoices(a), s = 0; s < t.length; s++) {
                var d = t[s];
                if (d.cta = "Navštívit stránku", "BANNER" == d.adType || d.isBanner) return this.renderBanner(t, e, i, n), !1;
            ...
            return new AdTrack.TextChannel(this.track, this.definition, this.chd).renderAds(e, o), !0
        }, createTextAdCombined: function (t) {
            var e = new AdTrack.TextAd, i = t.adImageUrl + "?fl=res%2C600%2C%2C1|jpg%2C90",
                n = t.adSquareImageUrl + "?fl=res%2C600%2C%2C1|jpg%2C90",
                r = this.track.rhtmlspecialchars(t.shortHeadline).trim(),
                s = (this.track.rhtmlspecialchars(t.longHeadline).trim(), this.track.rhtmlspecialchars(t.description).trim()),
            ...
            return e.addScreenshot(i, 600, 314, i), e.addScreenshot(n, 600, 600, i), e.addText(r, s), e.setCompanyName(t.companyName), e.setLogoUrl(t.adLogoUrl), e.setSquareLogoUrl(t.adSquareLogoUrl), e.setClickUrl(d), e.setVisibleUrl(t.visibleUrl), e.setAdUrl(t.adUrl), e.setCta(o), e.setFavicon(a), e.done(), e
        }, createTextAd: function (t) {
            var e = new AdTrack.TextAd,
                i = "//fimg-resp.seznam.cz/?spec=ft160x110&fast&url=" + encodeURIComponent(t.adUrl),
                n = "//fimg-resp.seznam.cz/?spec=ft280x130&fast&url=" + encodeURIComponent(t.adUrl),
            ...
            n && r || (n = 220, r = 120);
            var s = t.imageUrl + "?w=" + n + "&h=" + r + "&m=rp", o = t.imageUrl + "?w=220&h=120&m=rp";
            this.style && this.style.options && this.style.options.backgroundImage && (s = t.imageUrl, o = t.imageUrl);
            var a = e && e.cleanShopUrl ? "https://fimg-resp.seznam.cz/?spec=fav16x16&url=" + encodeURIComponent(e.cleanShopUrl) : "",
                d = !0 === this.definition.test ? t.adUrl ? t.adUrl : this.track.noquerystring("//seznam.cz") : t.clickUrl,
                c = t.price + "&nbsp;Kč";
            return i.addScreenshot(s, n, r, o), i.setProductName(t.title), i.setProductPrice(c), i.setProductManufacturer(t.manufacturer), i.setProductCategory(t.category), i.setClickUrl(d), i.setFavicon(a), i.done(), i
        }, createShop: function (t) {
            var e = new AdTrack.Shop, i = t.cleanShopUrl, n = i.split("//");
            return n.length > 1 ? e.setCleanShopUrl(n[1]) : e.setCleanShopUrl(i), e.setShopName(t.shopName), e.setShopUrl(t.shopUrl), e.setShopLogo(t.shopLogoUrl), e.setLogoutUrl(""), e
        }, isProductAd: function (t) {
            return t.length > 0 && ("DRTG" == t[0].adType || "SHOP" == t[0].adType)
        }, isBanner: function (t) {
            return t.length > 0 && (t[0].isBanner || "BANNER" == t[0].adType)
            ...
            this.definition.options.hideHref ? d.href = "#" : d.href = s, a.appendChild(d);
            var c, h, l, u = this.track.document.createElement("img");
            if (u.src = r.bannerUrl, u.style.width = "auto", u.style.height = "auto", u.style.border = "solid 1px #d0d0d0", d.appendChild(u), d.onclick = (c = 0, h = "banner", l = s, function (t) {
                var e = t.pageX || t.clientX + this.track.document.body.scrollLeft,
                    n = t.pageY || t.clientY + this.track.document.body.scrollTop;
                this.track.evClick(this.definition, this.chd, e, n, c, h, l, i), this.definition.options.newwindow || (t.preventDefault ? t.preventDefault() : t.returnValue = !1)
            }).bind(this), this.definition.options.newwindow ? d.setAttribute("target", "_blank") : d.setAttribute("target", "_top"), !this.definition.options.noBannerPromo && ("sklik" == this.chd.tag || "sklik-banner" == this.chd.tag)) {
                var p = this.track.document.createElement("a");
                p.style.position = "absolute", p.style.bottom = "0px", p.style.right = "0px", p.style.background = "transparent", p.href = this.chd.url;
                var f = this.track.document.createElement("img");
                f.alt = f.title = this.chd.title, f.style.width = "auto", f.style.height = "auto", p.appendChild(f);
            ...
            var m = function (t, e, i, n) {
                this.destroyed || (e && e.options && (e.options.width = n.width, e.options.height = n.height), this.measureImpress(t, e, i), this.track.loaded(this.definition, this.chd, this.count, e, null))
            }.bind(this);
            if (u.complete) m(e, i, n, u); else {
    ...
    AdTrack.SmartAdServerHBNativeChannel = function (t, e, i) {
        this.track = t, this.definition = e, this.chd = i, this.price = null, this.response = null, this.bidResponse = new AdTrack.Bid, this.helper = new AdTrack.SmartHelper(t, e, i)
        ...
        report: function () {
            ...
            if (i) {
                var n = function (i) {
                    if (i && i.ad) {
                        this.chd.width = i.width ? i.width : this.chd.width, this.chd.height = i.height ? i.height : this.chd.height;
                        try {
                            var n = i.ad.indexOf("{"), r = JSON.parse(i.ad.substr(n).replace(/,(\s)?]/g, "]"))
                        } catch (t) {
                            r = !1, this.chd.logs && this.chd.logs.creative && AdTrack.Utils.reportCreative(this.track.server, this.chd.logs.creative, this.chd.tag, i.creativeId || "", "", i.cpm, i.ad)
                        }
                        if (r) if (r.imgUrl && r.title) {
                            this.adData = r;
                            var s = new AdTrack.AdSet;
                            s.setStyle(e);
                            var o = r.privacy ? r.privacy : "", a = new AdTrack.AdChoices;
                            a.setPromoClickUrl(o || this.chd.url), o && a.setPromoIcon("//" + this.track.server + "/icon/oba.png"), a.setPromoText(this.chd.title), a.setOptional(!o), s.addAdChoices(a);
                            var d = new AdTrack.TextAd, c = i.adUrl ? i.adUrl : "";
                            d.addScreenshot(r.imgUrl), d.addText(r.title, r.data), d.setClickUrl(r.clickUrl), d.setAdUrl(c), d.setCta("Navštívit stránku"), d.done(), s.addAd(new AdTrack.SmartAd(s, d)), this.textChannel = new AdTrack.TextChannel(this.track, this.definition, this.chd), this.textChannel.renderAds(t, s), this.track.loaded(this.definition, this.chd, 1, e, null), this.track.measureImpress(t, function (t, i) {
                                this.track.evImpress(this.definition, this.chd, e, i), r.eventTrackers && r.eventTrackers.length > 0 && r.eventTrackers.forEach(function (t) {
                                    if (t.event && t.method && t.url) if (t.event > 4 || t.method > 2) this.track.doError("Cant handle custom tracker - event: " + t.method.event + ", method: " + t.method); else if (1 === t.method && ((new Image).src = t.url), 2 === t.method) {
                                        ...
                                        document.querySelector("head").appendChild(e), e.src = t.url
                                    }
                                }.bind(this))
                            }.bind(this)), r.impPixel && r.impPixel.forEach((function (t) {
                                (new Image).src = t
                            }))
                        } else this.track.doError("[" + this.chd.tag + "] Insufficient data received (img:" + !!r.imgUrl + "|title:" + !!r.title + ")"), this.track.passback(this.definition, this.chd); else this.track.doError("[" + this.chd.tag + "] Could not parse response"), this.track.passback(this.definition, this.chd)
                    } else this.track.passback(this.definition, this.chd)
                }.bind(this);
                this.price && this.response ? n(this.response) : this.bid((function (t, e) {
                    n(e)
    ...
    AdTrack.SmartHBOutstreamChannel = function (t, e, i) {
        ...
        report: function () {
            ...
            window[i] = function (e) {
                e && e.ad ? (this.response = e, e.currency === this.chd.currency ? (this.price = AdTrack.Price.create(e.cpm, this.chd.currency), this.bidResponse.setCreativeId(e.creativeId), this.bidResponse.setPrice(this.price), this.bidResponse.setWidth(e.width), this.bidResponse.setHeight(e.height)) : this.track.doError("Channel " + this.chd.tag + " responsed with wrong currency: " + e.currency)) : (this.price = null, this.response = e), t && t(this.price, this.response)
            }.bind(this);
            var n = this.generateBidUrl(e, i);
            if (this.definition.options.noAsync) document.write('<script src="' + n + '"><\/script>'); else {
                var r = document.createElement("script");
                r.onerror = function () {
                    this.price = null, this.response = {}, t && t(this.price, this.response)
                }.bind(this), r.setAttribute("src", n), document.getElementsByTagName("head")[0].appendChild(r)
            }
        }, render: function (t, e, i) {
            e = e.normal;
            var n = this.track.getChannelKey(this.chd, e);
            if (n) {
                var r = function (t) {
                    if (t && t.ad) {
                        ...
                        if (n) this.track.doError("Smart outstream already on page"), this.track.passback(this.definition, this.chd); else {
                            ...
                            var r = "<html><head><script>window.inDapIF=true;<\/script></head><body>" + t.ad + "</body></html>",
                                s = {chd: this.chd, ad: {type: "content", data: r}, externalRender: !0},
                                o = new AdTrack.MediaTypes.Video(s, this.track.errorReporting);
                            o.on("beforeRender", function (t) {
                                var i = t.ownerDocument || document;
                                (n = i.createElement("div")).setAttribute("id", "AdTrackOutstreamSmart"), t.appendChild(n), this.track.addEvent(this.track.window, "adBegin", function () {
            ...
            var a = {};
            AdTrack.CMP && (a = AdTrack.CMP.getConsentData("never", !1)), a && this.track.evBidConsent(this.definition, this.chd);
            var d = {
                pbjscbk: e,
                siteid: o[0],
                pgid: o[1],
    ...
    AdTrack.SmartyAdsHBChannel = function (t, e, i) {
        this.track = t, this.definition = e, this.chd = i, this.price = null, this.response = null, this.chd.sizes ? (this.sizes = this.chd.sizes, this.sizes.unshift([this.chd.width, this.chd.height])) : this.sizes = [[this.chd.width, this.chd.height]], this.bidResponse = new AdTrack.Bid, this.MTsupport = !0, this.track.shouldCsync("smartyads") && setTimeout(function () {
    ...
    AdTrack.StroeerChannel = function (t, e, i) {
        this.track = t, this.definition = e, this.chd = i, this.price = null, this.response = null, this.chd.sizes ? (this.sizes = this.chd.sizes, this.sizes.unshift([this.chd.width, this.chd.height])) : this.sizes = [[this.chd.width, this.chd.height]], this.bidResponse = new AdTrack.Bid, this.track.shouldCsync("stroeer") && setTimeout(function () {
            AdTrack.StroeerCSync()
        }.bind(this), 5e3), this.MTsupport = !0
        ...
        report: function () {
            ...
            n && (i.schain = n);
            var r = {};
            AdTrack.CMP && (r = AdTrack.CMP.getConsentData("never", !1)), r && (this.track.evBidConsent(this.definition, this.chd), i.gdpr = {
                consent: r.consentString,
                applies: !!r.gdprApplies
            }), i.bids.push({bid: AdTrack.Utils.randomString("AdTrack"), sid: e, siz: this.sizes, viz: !0});
            var s = function (e) {
                if (this.response = e, e.bids && e.bids.length > 0) if (e.bids[0]) {
                    var i = e.bids[0], n = AdTrack.Utils.isBlackListedAds(i.ad);
                    !1 === n ? i.ad.match("js.adscale.de/render.js") ? (this.track.doError("Channel " + this.chd.tag + " responded with custom renderer. CRID(" + i.crid + ")"), t && t(null, null)) : i.cpm || i.cpm2 ? (this.price = AdTrack.Price.create(i.cpm2 || i.cpm, this.chd.currency), this.bidResponse.setPrice(this.price), this.bidResponse.setCreativeId(i.crid), i.width && i.height && (this.bidResponse.setWidth(i.width), this.bidResponse.setHeight(i.height)), t && t(this.price, this.response)) : (this.track.doError("Channel " + this.chd.tag + " responded with empty currency."), t && t(null, null)) : (this.track.doError("Blocked Stroeer creative (" + i.crid + ") from " + n, "info"), this.chd.logs && this.chd.logs.blocked_creative && AdTrack.Utils.reportCreative(this.track.server, this.chd.logs.blocked_creative, this.chd.tag, i.crid || "", "", i.cpm, i.ad), t && t(null, null))
                } else this.track.doError("Channel " + this.chd.tag + " responded with unknown response."), t && t(null, null); else t && t(null, null)
            }.bind(this), o = function (e, i) {
                i ? this.track.evBidTimeout(this.definition, this.chd) : this.track.evBidError(this.definition, this.chd), this.price = null, t && t(null, null)
            }.bind(this);
                ...
                var r = function (t) {
                    if (t && t.bids && t.bids[0] && t.bids[0].ad) {
                        ...
                        var e = {
                            ...
                            width: this.bidResponse.getDimension().width,
                            height: this.bidResponse.getDimension().height,
                            ad: {data: t.bids[0].ad, type: "content"}
                        }, n = new AdTrack.MediaTypes.Banner(e, this.track.errorReporting);
                        i(n)
                    } else this.track.passback(this.definition, this.chd)
                }.bind(this);
    ...
    }, AdTrack.StroeerCSync = AdTrack.StroeerCSync || (i = !1, function () {
        if (!i) {
            var t = window.document.createElement("script");
            t.async = !0, t.defer = !0, t.type = "text/javascript", t.src = "https://js.adscale.de/userconnect.js", window.document.getElementsByTagName("head")[0].appendChild(t), i = !0
        }
    })
}, function (t, e) {
    var i;
    AdTrack.TeadsHBChannel = function (t, e, i) {
        ...
        try {
            ...
            this.pageId = n[0], this.placementId = n[1]
        } catch (t) {
        }
        ...
        report: function () {
            ...
            if (AdTrack.Utils.windowTopAccess()) {
                ...
                AdTrack.Ajax.request({
                    ...
                    if (e && e.responses && e.responses[0]) {
                        var r = e.responses[0];
                        if (r.cpm) if (r.currency && r.currency !== AdTrack.Price.EUR && r.currency !== AdTrack.Price.USD && "CHF" !== r.currency) n.track.doError("Channel " + n.chd.tag + " responsed with wrong currency: " + r.currency); else {
                            var s = r.cpm;
                            "CHF" === r.currency && (s *= .98), r.currency === AdTrack.Price.USD && (s *= .96), i = AdTrack.Price.create(s, AdTrack.Price.EUR), n.bidResponse.setCreativeId(r.creativeId), n.bidResponse.setPrice(i), n.bidResponse.setWidth(r.width), n.bidResponse.setHeight(r.height)
                        }
                    }
                    n.price = i, n.response = e, t && t(n.price, e)
                })).fail((function (e, i) {
                    i ? n.track.evBidTimeout(n.definition, n.chd) : n.track.evBidError(n.definition, n.chd), n.track.debug("Channel", "Teads request failed: " + e, AdTrack.Log.WARNING), n.price = null, t && t(null, null)
                })).send()
            ...
            if (n) {
                var r = function (t) {
                    if (t && t.responses && t.responses[0]) {
                        ...
                        var n = "<html><head></head><body>" + e.ad + "</body></html>", r = {
                            chd: this.chd,
                            width: 1,
                            height: 1,
                            ad: {type: "content", data: n},
                            wrapAd: !0,
                            externalRender: !0,
                            preload: {}
                        };
                        r.preload.func = function () {
                            var t = s.getElement();
                            if (t) {
                                var e = t.contentWindow, i = function () {
                                ...
                                var n = 0, r = function () {
                                    ...
                                    n < 20 ? (n++, setTimeout(r, 200)) : s.error()
                                }.bind(this);
                                r()
                            }
                        }.bind(this);
            ...
            h && (c.schain = h);
            var l = {};
            return AdTrack.CMP && (l = AdTrack.CMP.getConsentData("never", !1)), l && (this.track.evBidConsent(this.definition, this.chd), c.gdpr_iab = {
    ...
    }, AdTrack.TeadsCSync = AdTrack.TeadsCSync || (i = !1, function (t, e, n, r) {
        if (!i) {
            var s = null;
            AdTrack.CMP && (s = AdTrack.CMP.getConsentData("never", !1));
            let t = {hb_provider: "prebid", hb_version: "3.4"};
            if (s) {
                var o = s.consentString || "";
                let e = {status: s.gdprApplies ? 12 : 0, consent: o};
            ...
            AdTrack.Utils.csyncFrame("https://sync.teads.tv/iframe?" + a), i = !0
        }
    })
}, , , , , , , , , , , , , , , , , , , , , , , , , , , , , , function (t, e, i) {
    i(0), i(1), i(2), i(3), i(4), i(5), i(6), i(7), i(8), i(29), i(30), i(9), i(10), i(31), i(32), i(33), i(34), i(35), i(36), i(37), i(11), i(38), i(12), i(13), i(15), i(16), i(17), i(18), i(39), i(19), i(40), i(20), i(41), i(21), i(22), i(42), i(43), i(23), i(24), i(25), i(44), i(45), i(26), i(46), i(47), i(48), i(27), i(49), i(50), i(51), i(28), i(52), i(53), i(54), i(55), i(56), i(57), i(58), i(59), i(60), i(61), i(62), i(63), i(64), i(65), i(66), i(67), i(68), i(69), i(70), i(71), i(72), i(73), i(74), i(75), i(76), i(77), i(78), t.exports = i(79)
}]);

AdTrack.units["classic_pomo.csfd.cz_hb_120x600"] = new AdTrack.Dispatcher("classic", "pomo.csfd.cz", "hb", "120x600", {
    "renderer": "flexi", "options": {
        "dom": {"method": "container", "selectorForeign": "1"},
        "hb": {"currency": "USD", "onlyPrebid": true, "prebidAdUnitsPath": "pbjs.CPEX_adUnits", "targeting": []},
        "css": "#%%adUnit%% > iframe {display: block}",
        "noFPBNs": {
            "1": "36864793",
            "3": "35378918",
            "5": "38308494",
        ...
        "publisher": {"id": "121", "tag": "pomoMediaGroup"}
    }, "waterfall": {
        "tiers": [{
            "method": "hb",
            "channels": [{
                "chd": {
                    ...
                    "width": 120,
                    "height": 600
                }, "floor": 10, "factor": 23.113800018796145, "factorFixed": 24.397900019840375, "styles": []
            }, {
                "chd": {
                    "tag": "adform",
                ...
                "floor": 10,
                "factor": 25.682000020884605,
                "bfc": 1.1111111111111112,
                "factorFixed": 25.682000020884605,
                "styles": []
            }, {
                "chd": {
                    "tag": "connectad",
                    ...
                    "width": 120,
                    "height": 600,
                    "sizes": [[120, 240], [120, 90], [120, 60]]
                }, "floor": 10, "factor": 21.29695663209996, "factorFixed": 21.29695663209996, "styles": []
            }, {
                "chd": {
                    "tag": "appnexus",
                    "flag": "PublisherStandard",
                    ...
                    "width": 120,
                    "height": 600
                }, "floor": 10, "factor": 17.03756530567997, "factorFixed": 21.29695663209996, "styles": []
            }, {
                "chd": {
                    "tag": "xandr",
                    "flag": "PublisherStandard",
                ...
                "chd": {
                    "tag": "pubmatic-hb",
                    "flag": "PublisherStandard",
                    "keys": {"1": "784839-3386333"},
                    "unmaskedDomain": false,
                    "currency": "USD",
                    "priceType": "gross",
                    "width": 120,
                    "height": 600,
                    "sizes": [[120, 240], [60, 425], [120, 160]]
                }, "floor": 10, "factor": 17.676474004642966, "factorFixed": 18.741321836247966, "styles": []
            }, {
                "chd": {
                    "tag": "rubicon-banner-hb",
                    "flag": "PublisherStandard",
                    "keys": {"1": "357356-1922130"},
                    "unmaskedDomain": false,
                    "currency": "USD",
                    "priceType": "gross",
                    "width": 120,
                ...
                "floor": 10,
                "factor": 21.29695663209996,
                "bfc": 1.3333333333333333,
                "factorFixed": 21.29695663209996,
                "styles": []
            }, {
                "chd": {
                    "tag": "stroeer-banner",
                    "flag": "PublisherStandard",
                    "keys": {"1": "20448625-f3a8-4420-80f1-11c08c74dbfe"},
                    "unmaskedDomain": false,
                    "currency": "EUR",
                    "priceType": "gross",
                    "width": 120,
                    "height": 600
                }, "floor": 10, "factor": 25.682000020884605, "factorFixed": 25.682000020884605, "styles": []
            }]
        }]
    }, "currencies": {"EUR": 25.682000020884605, "USD": 21.29695663209996, "CZK": 1}, "excludes": [], "cls": {
...
AdTrack.units["classic_pomo.csfd.cz_hb_180x600_1"] = new AdTrack.Dispatcher("classic", "pomo.csfd.cz", "hb", "180x600_1", {
    "renderer": "flexi", "options": {
        "dom": {"method": "container", "selectorForeign": "1"},
        "hb": {"currency": "USD", "onlyPrebid": true, "prebidAdUnitsPath": "pbjs.CPEX_adUnits", "targeting": []},
        "css": "#%%adUnit%% > iframe {display: block}",
        ...
        "tiers": [{
            ...
            "channels": [{
                ...
                "chd": {
                    "tag": "criteo-hb-xhr",
                    "flag": "PublisherStandard",
                    "keys": {"1": "multiple_hb_180x600_1_(pomo.csfd.cz)\/PublisherStandard"},
                    "unmaskedDomain": false,
                    "currency": "EUR",
                    "priceType": "gross",
                    "width": 160,
                ...
                "chd": {
                    "tag": "rubicon-banner-hb",
                    "flag": "PublisherStandard",
                    "keys": {"1": "357356-1922128"},
                    "unmaskedDomain": false,
                    "currency": "USD",
                    "priceType": "gross",
                    "width": 160,
                    "height": 600,
                    "sizes": [[120, 600], [140, 350], [140, 260], [120, 240]]
                },
                "floor": 10,
                "factor": 21.29695663209996,
                "bfc": 1.3333333333333333,
                ...
                "chd": {
                    "tag": "stroeer-banner",
                    "flag": "PublisherStandard",
                    "keys": {"1": "d296658d-8537-453f-a118-ed585c8ee4ad"},
                    "unmaskedDomain": false,
                    "currency": "EUR",
                    "priceType": "gross",
                    "width": 160,
...
AdTrack.units["classic_pomo.csfd.cz_hb_180x600_2"] = new AdTrack.Dispatcher("classic", "pomo.csfd.cz", "hb", "180x600_2", {
    "renderer": "flexi", "options": {
        "dom": {"method": "container", "selectorForeign": "1"},
        "hb": {"currency": "USD", "onlyPrebid": true, "prebidAdUnitsPath": "pbjs.CPEX_adUnits", "targeting": []},
        "css": "#%%adUnit%% > iframe {display: block}",
        ...
        "tiers": [{
            ...
            "channels": [{
                ...
                "chd": {
                    "tag": "criteo-hb-xhr",
                    "flag": "PublisherStandard",
                    "keys": {"1": "multiple_hb_180x600_2_(pomo.csfd.cz)\/PublisherStandard"},
                    "unmaskedDomain": false,
                    "currency": "EUR",
                    "priceType": "gross",
                    "width": 160,
                ...
                "chd": {
                    "tag": "stroeer-banner",
                    "flag": "PublisherStandard",
                    "keys": {"1": "1184cf29-90e7-4aea-b891-3eb0d30cf925"},
                    "unmaskedDomain": false,
                    "currency": "EUR",
                    "priceType": "gross",
                    "width": 160,
...
AdTrack.units["classic_pomo.csfd.cz_hb_300x300"] = new AdTrack.Dispatcher("classic", "pomo.csfd.cz", "hb", "300x300", {
    "renderer": "flexi", "options": {
        "dom": {"method": "container", "selectorForeign": "1"},
        "hb": {"currency": "USD", "onlyPrebid": true, "prebidAdUnitsPath": "pbjs.CPEX_adUnits", "targeting": []},
        "css": "#%%adUnit%% > iframe {display: block}",
        ...
        "tiers": [{
            ...
            "channels": [{
                ...
                "chd": {
                    "tag": "criteo-hb-xhr",
                    "flag": "PublisherStandard",
                    "keys": {"1": "multiple_hb_300x300_(pomo.csfd.cz)\/PublisherStandard"},
                    "unmaskedDomain": false,
                    "currency": "EUR",
                    "priceType": "gross",
                    "width": 300,
                ...
                "chd": {
                    "tag": "stroeer-banner",
                    "flag": "PublisherStandard",
                    "keys": {"1": "47196900-65a7-4142-aee0-54a8147eec0e"},
                    "unmaskedDomain": false,
                    "currency": "EUR",
                    "priceType": "gross",
                    "width": 300,
...
AdTrack.units["classic_pomo.csfd.cz_hb_336x300_1"] = new AdTrack.Dispatcher("classic", "pomo.csfd.cz", "hb", "336x300_1", {
    "renderer": "flexi", "options": {
        "dom": {"method": "container", "selectorForeign": "1"},
        "hb": {"currency": "USD", "onlyPrebid": true, "prebidAdUnitsPath": "pbjs.CPEX_adUnits", "targeting": []},
        "css": "#%%adUnit%% > iframe {display: block}",
        ...
        "tiers": [{
            ...
            "channels": [{
                "chd": {
                    ...
                    "width": 336,
                    "height": 300,
                    "sizes": [[300, 300], [336, 280], [300, 250], [250, 250]]
                }, "floor": 10, "factor": 23.113800018796145, "factorFixed": 24.397900019840375, "styles": []
            }, {
                "chd": {
                    "tag": "adform",
                ...
                "chd": {
                    "tag": "criteo-hb-xhr",
                    "flag": "PublisherStandard",
                    "keys": {"1": "multiple_hb_336x300_1_(pomo.csfd.cz)\/PublisherStandard"},
                    "unmaskedDomain": false,
                    "currency": "EUR",
                    "priceType": "gross",
                    "width": 300,
                ...
                "chd": {
                    "tag": "smart-hb",
                    "flag": "PublisherStandard",
                    "keys": {"1": "386820-1334928-96821"},
                    "unmaskedDomain": false,
                    "currency": "EUR",
                    "priceType": "gross",
                    "width": 336,
                    "height": 300,
                    "sizes": [[300, 300], [336, 280], [320, 250], [300, 250], [250, 250]]
                },
                "floor": 10,
                "factor": 25.682000020884605,
                "bfc": 1.1111111111111112,
                ...
                "chd": {
                    "tag": "stroeer-banner",
                    "flag": "PublisherStandard",
                    "keys": {"1": "c0784665-be59-4d7a-94b8-bca5c6c39373"},
                    "unmaskedDomain": false,
                    "currency": "EUR",
                    "priceType": "gross",
                    "width": 336,
...
AdTrack.units["classic_pomo.csfd.cz_hb_336x300_2"] = new AdTrack.Dispatcher("classic", "pomo.csfd.cz", "hb", "336x300_2", {
    "renderer": "flexi", "options": {
        "dom": {"method": "container", "selectorForeign": "1"},
        "hb": {"currency": "USD", "onlyPrebid": true, "prebidAdUnitsPath": "pbjs.CPEX_adUnits", "targeting": []},
        "css": "#%%adUnit%% > iframe {display: block}",
        ...
        "tiers": [{
            ...
            "channels": [{
                ...
                "chd": {
                    "tag": "criteo-hb-xhr",
                    "flag": "PublisherStandard",
                    "keys": {"1": "multiple_hb_336x300_2_(pomo.csfd.cz)\/PublisherStandard"},
                    "unmaskedDomain": false,
                    "currency": "EUR",
                    "priceType": "gross",
                    "width": 300,
                ...
                "chd": {
                    "tag": "stroeer-banner",
                    "flag": "PublisherStandard",
                    "keys": {"1": "fd9bee8b-ba88-4dba-b51c-6fbcd8dcc110"},
                    "unmaskedDomain": false,
                    "currency": "EUR",
                    "priceType": "gross",
                    "width": 336,
...
AdTrack.units["classic_pomo.csfd.cz_hb_336x300_3"] = new AdTrack.Dispatcher("classic", "pomo.csfd.cz", "hb", "336x300_3", {
    "renderer": "flexi", "options": {
        "dom": {"method": "container", "selectorForeign": "1"},
        "hb": {"currency": "USD", "onlyPrebid": true, "prebidAdUnitsPath": "pbjs.CPEX_adUnits", "targeting": []},
        "css": "#%%adUnit%% > iframe {display: block}",
        ...
        "tiers": [{
            ...
            "channels": [{
                ...
                "chd": {
                    "tag": "criteo-hb-xhr",
                    "flag": "PublisherStandard",
                    "keys": {"1": "multiple_hb_336x300_3_(pomo.csfd.cz)\/PublisherStandard"},
                    "unmaskedDomain": false,
                    "currency": "EUR",
                    "priceType": "gross",
                    "width": 300,
                ...
                "chd": {
                    "tag": "stroeer-banner",
                    "flag": "PublisherStandard",
                    "keys": {"1": "b84d6c6c-1afe-4894-97b8-931ec39989ed"},
                    "unmaskedDomain": false,
                    "currency": "EUR",
                    "priceType": "gross",
                    "width": 336,
...
AdTrack.units["classic_pomo.csfd.cz_hb_336x300_4"] = new AdTrack.Dispatcher("classic", "pomo.csfd.cz", "hb", "336x300_4", {
    "renderer": "flexi", "options": {
        "dom": {"method": "container", "selectorForeign": "1"},
        "hb": {"currency": "USD", "onlyPrebid": true, "prebidAdUnitsPath": "pbjs.CPEX_adUnits", "targeting": []},
        "css": "#%%adUnit%% > iframe {display: block}",
        ...
        "tiers": [{
            ...
            "channels": [{
                ...
                "chd": {
                    "tag": "criteo-hb-xhr",
                    "flag": "PublisherStandard",
                    "keys": {"1": "multiple_hb_336x300_4_(pomo.csfd.cz)\/PublisherStandard"},
                    "unmaskedDomain": false,
                    "currency": "EUR",
                    "priceType": "gross",
                    "width": 300,
                ...
                "chd": {
                    "tag": "stroeer-banner",
                    "flag": "PublisherStandard",
                    "keys": {"1": "973def26-b1c4-494c-a18c-7f3a6ba4f5ad"},
                    "unmaskedDomain": false,
                    "currency": "EUR",
                    "priceType": "gross",
                    "width": 336,
...
AdTrack.units["classic_pomo.csfd.cz_hb_336x300_5"] = new AdTrack.Dispatcher("classic", "pomo.csfd.cz", "hb", "336x300_5", {
    "renderer": "flexi", "options": {
        "dom": {"method": "container", "selectorForeign": "1"},
        "hb": {"currency": "USD", "onlyPrebid": true, "prebidAdUnitsPath": "pbjs.CPEX_adUnits", "targeting": []},
        "css": "#%%adUnit%% > iframe {display: block}",
        ...
        "tiers": [{
            ...
            "channels": [{
                ...
                "chd": {
                    "tag": "criteo-hb-xhr",
                    "flag": "PublisherStandard",
                    "keys": {"1": "multiple_hb_336x300_5_(pomo.csfd.cz)\/PublisherStandard"},
                    "unmaskedDomain": false,
                    "currency": "EUR",
                    "priceType": "gross",
                    "width": 300,
                ...
                "chd": {
                    "tag": "stroeer-banner",
                    "flag": "PublisherStandard",
                    "keys": {"1": "d2865041-9bee-49fa-a443-07697a73e06b"},
                    "unmaskedDomain": false,
                    "currency": "EUR",
                    "priceType": "gross",
                    "width": 336,
...
AdTrack.units["classic_pomo.csfd.cz_hb_300x250"] = new AdTrack.Dispatcher("classic", "pomo.csfd.cz", "hb", "300x250", {
    "renderer": "flexi", "options": {
        "dom": {"method": "container", "selectorForeign": "1"},
        "hb": {"currency": "USD", "onlyPrebid": true, "prebidAdUnitsPath": "pbjs.CPEX_adUnits", "targeting": []},
        "css": "#%%adUnit%% > iframe {display: block}",
        ...
        "tiers": [{
            ...
            "channels": [{
                "chd": {
                    ...
                    "width": 300,
                    "height": 250,
                    "sizes": [[250, 250], [200, 200], [300, 50], [180, 150]]
                }, "floor": 10, "factor": 23.113800018796145, "factorFixed": 24.397900019840375, "styles": []
            }, {
                "chd": {
                    "tag": "adform",
                ...
                "chd": {
                    "tag": "criteo-hb-xhr",
                    "flag": "PublisherStandard",
                    "keys": {"1": "multiple_hb_300x250_(pomo.csfd.cz)\/PublisherStandard"},
                    "unmaskedDomain": false,
                    "currency": "EUR",
                    "priceType": "gross",
                    "width": 300,
                    "height": 250,
                    "sizes": [[300, 210], [250, 250], [200, 200], [300, 100]]
                }, "floor": 10, "factor": 25.682000020884605, "factorFixed": 25.682000020884605, "styles": []
            }, {
                "chd": {
                    "tag": "smart-hb",
                    "flag": "PublisherStandard",
                    "keys": {"1": "386820-1334928-96816"},
                    "unmaskedDomain": false,
                    "currency": "EUR",
                    "priceType": "gross",
                    "width": 300,
                    "height": 250,
                    "sizes": [[250, 250], [300, 150], [200, 200], [300, 100], [300, 75], [300, 50], [300, 168]]
                },
                "floor": 10,
                "factor": 25.682000020884605,
                "bfc": 1.1111111111111112,
                ...
                "chd": {
                    ...
                    "width": 300,
                    "height": 250,
                    "sizes": [[250, 250], [220, 250], [300, 125], [300, 100], [300, 50]]
                }, "floor": 10, "factor": 21.29695663209996, "factorFixed": 21.29695663209996, "styles": []
            }, {
                "chd": {
                    "tag": "appnexus",
                ...
                "chd": {
                    "tag": "rubicon-banner-hb",
                    "flag": "PublisherStandard",
                    "keys": {"1": "357356-1922112"},
                    "unmaskedDomain": false,
                    "currency": "USD",
                    "priceType": "gross",
                    "width": 300,
                    "height": 250,
                    "sizes": [[250, 250], [240, 200], [200, 200], [300, 100]]
                },
                "floor": 10,
                "factor": 21.29695663209996,
                "bfc": 1.3333333333333333,
                ...
                "chd": {
                    "tag": "stroeer-banner",
                    "flag": "PublisherStandard",
                    "keys": {"1": "e35e162f-2aba-4512-b9c2-a003a7718077"},
                    "unmaskedDomain": false,
                    "currency": "EUR",
                    "priceType": "gross",
                    "width": 300,
                    "height": 250,
                    "sizes": [[250, 250], [300, 150], [200, 200], [300, 75], [300, 50], [234, 60]]
                }, "floor": 10, "factor": 25.682000020884605, "factorFixed": 25.682000020884605, "styles": []
            }]
        }]
    }, "currencies": {"EUR": 25.682000020884605, "USD": 21.29695663209996, "CZK": 1}, "excludes": [], "cls": {
...
AdTrack.units["classic_pomo.csfd.cz_hb_480x300_1"] = new AdTrack.Dispatcher("classic", "pomo.csfd.cz", "hb", "480x300_1", {
    "renderer": "flexi", "options": {
        "dom": {"method": "container", "selectorForeign": "1"},
        "hb": {"currency": "USD", "onlyPrebid": true, "prebidAdUnitsPath": "pbjs.CPEX_adUnits", "targeting": []},
        "css": "#%%adUnit%% > iframe {display: block}",
        ...
        "tiers": [{
            ...
            "channels": [{
                ...
                "chd": {
                    "tag": "criteo-hb-xhr",
                    "flag": "PublisherStandard",
                    "keys": {"1": "multiple_hb_480x300_1_(pomo.csfd.cz)\/PublisherStandard"},
                    "unmaskedDomain": false,
                    "currency": "EUR",
                    "priceType": "gross",
                    "width": 480,
                ...
                "chd": {
                    "tag": "stroeer-banner",
                    "flag": "PublisherStandard",
                    "keys": {"1": "3fd4db54-40a5-4d6d-95f5-fd0d72b88e3c"},
                    "unmaskedDomain": false,
                    "currency": "EUR",
                    "priceType": "gross",
                    "width": 480,
...
AdTrack.units["classic_pomo.csfd.cz_hb_480x300_2"] = new AdTrack.Dispatcher("classic", "pomo.csfd.cz", "hb", "480x300_2", {
    "renderer": "flexi", "options": {
        "dom": {"method": "container", "selectorForeign": "1"},
        "hb": {"currency": "USD", "onlyPrebid": true, "prebidAdUnitsPath": "pbjs.CPEX_adUnits", "targeting": []},
        "css": "#%%adUnit%% > iframe {display: block}",
        ...
        "tiers": [{
            ...
            "channels": [{
                ...
                "chd": {
                    "tag": "criteo-hb-xhr",
                    "flag": "PublisherStandard",
                    "keys": {"1": "multiple_hb_480x300_2_(pomo.csfd.cz)\/PublisherStandard"},
                    "unmaskedDomain": false,
                    "currency": "EUR",
                    "priceType": "gross",
                    "width": 480,
                ...
                "chd": {
                    "tag": "stroeer-banner",
                    "flag": "PublisherStandard",
                    "keys": {"1": "eb264726-a785-42fc-9351-4d5dde59181d"},
                    "unmaskedDomain": false,
                    "currency": "EUR",
                    "priceType": "gross",
                    "width": 480,
...
AdTrack.units["classic_pomo.csfd.cz_hb_300x600"] = new AdTrack.Dispatcher("classic", "pomo.csfd.cz", "hb", "300x600", {
    "renderer": "flexi",
    "options": {
        "dom": {"method": "container", "selectorForeign": "1"},
        "hb": {"currency": "USD", "onlyPrebid": true, "prebidAdUnitsPath": "pbjs.CPEX_adUnits", "targeting": []},
        ...
        "tiers": [{
            ...
            "channels": [{
                "chd": {
                    ...
                    "height": 600,
                    "sizes": [[160, 600]]
                }, "floor": 10, "factor": 22.84669865204478, "factorFixed": 24.115959688269488, "styles": []
            }, {
                "chd": {
                    "tag": "adform",
                    "flag": "PublisherStandard",
                ...
                "chd": {
                    "tag": "criteo-hb-xhr",
                    "flag": "PublisherStandard",
                    "keys": {"1": "multiple_hb_300x600_(pomo.csfd.cz)\/PublisherStandard"},
                    "unmaskedDomain": false,
                    "currency": "EUR",
                    "priceType": "gross",
                    "width": 300,
                    "height": 600,
                    "sizes": [[160, 600]]
                }, "floor": 10, "factor": 25.3852207244942, "factorFixed": 25.3852207244942, "styles": []
            }, {
                "chd": {
                    "tag": "smart-hb",
                    "flag": "PublisherStandard",
                    "keys": {"1": "386820-1334928-87187"},
                    "unmaskedDomain": false,
                    "currency": "EUR",
                    "priceType": "gross",
                    "width": 300,
                ...
                "floor": 10,
                "factor": 25.3852207244942,
                "bfc": 1.1111111111111112,
                "factorFixed": 25.3852207244942,
                "styles": []
            }, {
                "chd": {
                    "tag": "connectad",
                    ...
                    "height": 600,
                    "sizes": [[160, 600]]
                }, "floor": 10, "factor": 21.67175953015625, "factorFixed": 21.67175953015625, "styles": []
            }, {
                "chd": {
                    "tag": "appnexus",
                    "flag": "PublisherStandard",
                    ...
                    "height": 600,
                    "sizes": [[160, 600]]
                }, "floor": 10, "factor": 17.337407624125003, "factorFixed": 21.67175953015625, "styles": []
            }, {
                "chd": {
                    "tag": "xandr",
                    "flag": "PublisherStandard",
                ...
                "chd": {
                    ...
                    "height": 600,
                    "sizes": [[160, 600]]
                }, "floor": 10, "factor": 17.987560410029687, "factorFixed": 19.0711483865375, "styles": []
            }, {
                "chd": {
                    "tag": "rubicon-banner-hb",
                    "flag": "PublisherStandard",
                    "keys": {"1": "357356-1922106"},
                    "unmaskedDomain": false,
                    "currency": "USD",
                    "priceType": "gross",
                    "width": 300,
                ...
                "floor": 10,
                "factor": 21.67175953015625,
                "bfc": 1.3333333333333333,
                "factorFixed": 21.67175953015625,
                "styles": []
            }, {
                "chd": {
                    "tag": "stroeer-banner",
                    "flag": "PublisherStandard",
                    "keys": {"1": "fd557194-fd1d-4716-9846-e49beb34b9d7"},
                    "unmaskedDomain": false,
                    "currency": "EUR",
                    "priceType": "gross",
                    "width": 300,
                ...
                "chd": {
                    ...
                    "flag": "PublisherStandard",
                    "title": "Reklama",
                    "keys": {"1": "1387199-hb_300x600_(pomo.csfd.cz)\/Native_6_PublisherStandard"},
                    "unmaskedDomain": false,
                    "currency": "EUR",
                    "priceType": "gross",
                    "width": 300,
                    ...
                    "normal": {
                        "name": "n-j-1-halfpage-single_default-55627", "count": 1, "options": {
                            "dom": {"method": "container", "selectorForeign": "1"},
                            "hb": {
                                "currency": "USD",
                                "onlyPrebid": true,
                                "prebidAdUnitsPath": "pbjs.CPEX_adUnits",
                                "targeting": []
                            },
                            "css": "",
                        ...
                        "name": "p-j-1-halfpage-single_default-55627", "count": 1, "options": {
                            "dom": {"method": "container", "selectorForeign": "1"},
                            "hb": {
                                "currency": "USD",
                                "onlyPrebid": true,
                ...
                "chd": {
                    ...
                    "width": 1,
                    "height": 1
                }, "floor": 12.02, "factor": 17.337407624125003, "factorFixed": 21.67175953015625, "styles": {
                    "normal": {
                        "name": "n-j-1-halfpage-single_default-55627", "count": 1, "options": {
                            "dom": {"method": "container", "selectorForeign": "1"},
                            "hb": {
    ...
    "info": null,
    "currencies": {"EUR": 25.3852207244942, "USD": 21.67175953015625, "CZK": 1},
    "excludes": [],
    "cls": {
        "headline": "AdTrack-headline",
        "description": "AdTrack-description",
...
AdTrack.units["classic_pomo.csfd.cz_hb_300x600_1"] = new AdTrack.Dispatcher("classic", "pomo.csfd.cz", "hb", "300x600_1", {
    "renderer": "flexi", "options": {
        "dom": {"method": "container", "selectorForeign": "1"},
        "hb": {"currency": "USD", "onlyPrebid": true, "prebidAdUnitsPath": "pbjs.CPEX_adUnits", "targeting": []},
        "css": "#%%adUnit%% > iframe {display: block}",
        ...
        "tiers": [{
            ...
            "channels": [{
                ...
                "chd": {
                    "tag": "criteo-hb-xhr",
                    "flag": "PublisherStandard",
                    "keys": {"1": "multiple_hb_300x600_1_(pomo.csfd.cz)\/PublisherStandard"},
                    "unmaskedDomain": false,
                    "currency": "EUR",
                    "priceType": "gross",
                    "width": 300,
                ...
                "chd": {
                    ...
                    "width": 300,
                    "height": 600,
                    "sizes": [[160, 600], [240, 400], [300, 250], [120, 600], [250, 250], [220, 250]]
                }, "floor": 10, "factor": 21.29695663209996, "factorFixed": 21.29695663209996, "styles": []
            }, {
                "chd": {
                    "tag": "appnexus",
                ...
                "chd": {
                    "tag": "rubicon-banner-hb",
                    "flag": "PublisherStandard",
                    "keys": {"1": "357356-1922104"},
                    "unmaskedDomain": false,
                    "currency": "USD",
                    "priceType": "gross",
                    "width": 300,
                    "height": 600,
                    "sizes": [[250, 600], [160, 600], [300, 300], [120, 600]]
                },
                "floor": 10,
                "factor": 21.29695663209996,
                "bfc": 1.3333333333333333,
                ...
                "chd": {
                    "tag": "stroeer-banner",
                    "flag": "PublisherStandard",
                    "keys": {"1": "d961ae3a-5b91-4ba3-a23c-1b6c6d2818d7"},
                    "unmaskedDomain": false,
                    "currency": "EUR",
                    "priceType": "gross",
                    "width": 300,
                    "height": 600,
                    "sizes": [[200, 600], [160, 600], [300, 300], [300, 250], [120, 600], [250, 250]]
                }, "floor": 10, "factor": 25.682000020884605, "factorFixed": 25.682000020884605, "styles": []
            }]
        }]
    }, "currencies": {"EUR": 25.682000020884605, "USD": 21.29695663209996, "CZK": 1}, "excludes": [], "cls": {
...
AdTrack.units["classic_pomo.csfd.cz_hb_300x600_2"] = new AdTrack.Dispatcher("classic", "pomo.csfd.cz", "hb", "300x600_2", {
    "renderer": "flexi", "options": {
        "dom": {"method": "container", "selectorForeign": "1"},
        "hb": {"currency": "USD", "onlyPrebid": true, "prebidAdUnitsPath": "pbjs.CPEX_adUnits", "targeting": []},
        "css": "#%%adUnit%% > iframe {display: block}",
        ...
        "tiers": [{
            ...
            "channels": [{
                ...
                "chd": {
                    "tag": "criteo-hb-xhr",
                    "flag": "PublisherStandard",
                    "keys": {"1": "multiple_hb_300x600_2_(pomo.csfd.cz)\/PublisherStandard"},
                    "unmaskedDomain": false,
                    "currency": "EUR",
                    "priceType": "gross",
                    "width": 300,
                ...
                "chd": {
                    "tag": "stroeer-banner",
                    "flag": "PublisherStandard",
                    "keys": {"1": "a2a4e4ca-b807-4968-b748-909275d03f76"},
                    "unmaskedDomain": false,
                    "currency": "EUR",
                    "priceType": "gross",
                    "width": 300,
...
AdTrack.units["classic_pomo.csfd.cz_hb_branding"] = new AdTrack.Dispatcher("classic", "pomo.csfd.cz", "hb", "branding", {
    "renderer": "branding",
    "options": {
        "dom": {"method": "create", "container": "body"},
        "hb": {"currency": "USD", "onlyPrebid": true, "prebidAdUnitsPath": "pbjs.CPEX_adUnits", "targeting": []},
        "main": "div#page-wrapper",
        "mainMarginTop": "220",
        "mainZIndex": "2",
        "css": "#leaderboard-wrapper{\n    display: none !important;\n}",
        "noFPBNs": {
            "1": "36864793",
            "3": "35378918",
            "5": "38308494",
        ...
        "tiers": [{
            ...
            "channels": [{
                "chd": {
                    ...
                    "width": 2000,
                    "height": 1400
                }, "floor": 100, "factor": 22.850759152998528, "factorFixed": 24.120245772609557, "styles": []
            }, {
                "chd": {
                    "tag": "adform",
                    "flag": "PublisherStandard",
                ...
                "chd": {
                    "tag": "pubmatic-hb",
                    "flag": "PublisherStandard",
                    "keys": {"1": "784839-3386314"},
                    "unmaskedDomain": false,
                    "currency": "USD",
                    "priceType": "gross",
                    "width": 2000,
                    "height": 1400
                }, "floor": 100, "factor": 17.831822283332617, "factorFixed": 18.906028444979164, "styles": []
            }, {
                "chd": {
                    "tag": "rubicon-banner-hb",
                    "flag": "PublisherStandard",
                    "keys": {"1": "357356-1922100"},
                    "unmaskedDomain": false,
                    "currency": "USD",
                    "priceType": "gross",
                    "width": 2000,
                ...
                "floor": 100,
                "factor": 21.484123232930866,
                "bfc": 1.3333333333333333,
                "factorFixed": 21.484123232930866,
                "styles": []
            }, {
                "chd": {
                    "tag": "smart-hb",
                    "flag": "PublisherStandard",
                    "keys": {"1": "386820-1334928-93600"},
                    "unmaskedDomain": false,
                    "currency": "EUR",
                    "priceType": "gross",
                    "width": 2000,
                ...
                "floor": 100,
                "factor": 25.389732392220587,
                "bfc": 1.1111111111111112,
                "factorFixed": 25.389732392220587,
                "styles": []
            }, {
                "chd": {
                    "tag": "xandr",
                    ...
                    "width": 2000,
                    "height": 1400
                }, "floor": 100, "factor": 21.484123232930866, "factorFixed": 21.484123232930866, "styles": []
            }, {
                "chd": {
                    "tag": "appnexus",
                    "flag": "PublisherStandard",
                    ...
                    "width": 2000,
                    "height": 1400
                }, "floor": 100, "factor": 17.187298586344692, "factorFixed": 21.484123232930866, "styles": []
            }, {
                "chd": {
                    "tag": "seznam-ssp-branding-hb",
                    "flag": "Standard",
                    "keys": {"1": "249761"},
                    "unmaskedDomain": false,
                    "currency": "CZK",
                    ...
                    "width": 2000,
                    "height": 1400
                }, "floor": 70.53, "factor": 1, "factorFixed": 1, "styles": []
            }]
        }]
    },
    "info": null,
    "currencies": {"EUR": 25.389732392220587, "USD": 21.484123232930866, "CZK": 1},
    "excludes": [],
    "cls": {
        "headline": "AdTrack-headline",
        "description": "AdTrack-description",
...
AdTrack.units["classic_pomo.csfd.cz_hb_1000x210"] = new AdTrack.Dispatcher("classic", "pomo.csfd.cz", "hb", "1000x210", {
    "renderer": "flexi", "options": {
        "dom": {"method": "container", "selectorForeign": "1"},
        "hb": {"currency": "USD", "onlyPrebid": true, "prebidAdUnitsPath": "pbjs.CPEX_adUnits", "targeting": []},
        "css": "#%%adUnit%% > iframe {display: block}",
        ...
        "tiers": [{
            ...
            "channels": [{
                "chd": {
                    ...
                    "width": 1000,
                    "height": 200,
                    "sizes": [[998, 200], [980, 200], [970, 200], [960, 200], [930, 200], [930, 180], [750, 200], [980, 120], [990, 100], [970, 100], [970, 90], [750, 100], [745, 100], [750, 90], [728, 90]]
                }, "floor": 10, "factor": 23.113800018796145, "factorFixed": 24.397900019840375, "styles": []
            }, {
                "chd": {
                    "tag": "adform",
                ...
                "chd": {
                    "tag": "criteo-hb-xhr",
                    "flag": "PublisherStandard",
                    "keys": {"1": "multiple_hb_1000x210_(pomo.csfd.cz)\/PublisherStandard"},
                    "unmaskedDomain": false,
                    "currency": "EUR",
                    "priceType": "gross",
                    "width": 970,
                ...
                "chd": {
                    "tag": "smart-hb",
                    "flag": "PublisherStandard",
                    "keys": {"1": "386820-1334928-96810"},
                    "unmaskedDomain": false,
                    "currency": "EUR",
                    "priceType": "gross",
                    "width": 1000,
                    "height": 210,
                    "sizes": [[970, 210], [1000, 200], [995, 200], [980, 200], [970, 200], [950, 200], [995, 180], [930, 180], [750, 200], [980, 120], [1000, 100], [1000, 90], [990, 90], [980, 90], [970, 90], [960, 90], [950, 90], [750, 100], [780, 90], [768, 90], [728, 90]]
                },
                "floor": 10,
                "factor": 25.682000020884605,
                "bfc": 1.1111111111111112,
                ...
                "chd": {
                    "tag": "pubmatic-hb",
                    "flag": "PublisherStandard",
                    "keys": {"1": "784839-3386313"},
                    "unmaskedDomain": false,
                    "currency": "USD",
                    "priceType": "gross",
                    "width": 1000,
                    "height": 200,
                    "sizes": [[998, 200], [728, 90], [750, 100], [950, 200]]
                }, "floor": 10, "factor": 17.676474004642966, "factorFixed": 18.741321836247966, "styles": []
            }, {
                "chd": {
                    "tag": "rubicon-banner-hb",
                    "flag": "PublisherStandard",
                    "keys": {"1": "357356-1922098"},
                    "unmaskedDomain": false,
                    "currency": "USD",
                    "priceType": "gross",
                    "width": 998,
                    "height": 200,
                    "sizes": [[950, 200], [930, 180], [980, 150], [970, 150]]
                },
                "floor": 10,
                "factor": 21.29695663209996,
                "bfc": 1.3333333333333333,
                ...
                "chd": {
                    "tag": "stroeer-banner",
                    "flag": "PublisherStandard",
                    "keys": {"1": "35d752a0-9a35-46c0-a72d-191d334fbb7c"},
                    "unmaskedDomain": false,
                    "currency": "EUR",
                    "priceType": "gross",
                    "width": 998,
                    "height": 200,
                    "sizes": [[970, 200], [750, 200], [1000, 100], [990, 100], [970, 100], [750, 100], [745, 100], [728, 90]]
                }, "floor": 10, "factor": 25.682000020884605, "factorFixed": 25.682000020884605, "styles": []
            }]
        }]
    }, "currencies": {"EUR": 25.682000020884605, "USD": 21.29695663209996, "CZK": 1}, "excludes": [], "cls": {
...
AdTrack.units["classic_pomo.csfd.cz_hb_1000x310"] = new AdTrack.Dispatcher("classic", "pomo.csfd.cz", "hb", "1000x310", {
    "renderer": "flexi", "options": {
        "dom": {"method": "container", "selectorForeign": "1"},
        "hb": {"currency": "USD", "onlyPrebid": true, "prebidAdUnitsPath": "pbjs.CPEX_adUnits", "targeting": []},
        "css": "#%%adUnit%% > iframe {display: block}",
        ...
        "tiers": [{
            ...
            "channels": [{
                "chd": {
                    ...
                    "width": 1000,
                    "height": 310,
                    "sizes": [[970, 310], [998, 200], [970, 250], [970, 210], [800, 250], [970, 200], [960, 200], [930, 200], [930, 180], [750, 200], [600, 190], [970, 100], [970, 90], [750, 100], [745, 100], [750, 90], [728, 90]]
                }, "floor": 10, "factor": 23.113800018796145, "factorFixed": 24.397900019840375, "styles": []
            }, {
                "chd": {
                    "tag": "adform",
                ...
                "chd": {
                    "tag": "criteo-hb-xhr",
                    "flag": "PublisherStandard",
                    "keys": {"1": "multiple_hb_1000x310_(pomo.csfd.cz)\/PublisherStandard"},
                    "unmaskedDomain": false,
                    "currency": "EUR",
                    "priceType": "gross",
                    "width": 1000,
                    "height": 310,
                    "sizes": [[998, 310], [970, 310], [1000, 300], [950, 300], [1000, 250], [980, 250], [970, 250], [998, 210], [970, 210], [1000, 200], [998, 200], [995, 200], [970, 200], [960, 200], [930, 200], [930, 180], [750, 200], [745, 200], [600, 200], [980, 120], [1000, 100], [990, 100], [970, 100]]
                }, "floor": 10, "factor": 25.682000020884605, "factorFixed": 25.682000020884605, "styles": []
            }, {
                "chd": {
                    "tag": "smart-hb",
                    "flag": "PublisherStandard",
                    "keys": {"1": "386820-1334928-96809"},
                    "unmaskedDomain": false,
                    "currency": "EUR",
                    "priceType": "gross",
                    "width": 1000,
                    "height": 310,
                    "sizes": [[998, 200], [994, 250], [970, 300], [950, 300], [970, 250], [950, 250], [750, 300], [900, 250], [800, 250], [970, 200], [950, 200], [930, 180], [750, 200], [970, 90], [960, 90], [950, 90], [750, 100], [780, 90], [768, 90], [728, 90]]
                },
                "floor": 10,
                "factor": 25.682000020884605,
                "bfc": 1.1111111111111112,
                ...
                "chd": {
                    ...
                    "width": 1000,
                    "height": 310,
                    "sizes": [[998, 200], [994, 250], [970, 310], [970, 250], [728, 90]]
                }, "floor": 10, "factor": 17.03756530567997, "factorFixed": 21.29695663209996, "styles": []
            }, {
                "chd": {
                    "tag": "xandr",
                ...
                "chd": {
                    "tag": "pubmatic-hb",
                    "flag": "PublisherStandard",
                    "keys": {"1": "784839-3386311"},
                    "unmaskedDomain": false,
                    "currency": "USD",
                    "priceType": "gross",
                    "width": 970,
                    "height": 310,
                    "sizes": [[970, 250], [998, 200], [950, 300], [728, 90]]
                }, "floor": 10, "factor": 17.676474004642966, "factorFixed": 18.741321836247966, "styles": []
            }, {
                "chd": {
                    "tag": "rubicon-banner-hb",
                    "flag": "PublisherStandard",
                    "keys": {"1": "357356-1922096"},
                    "unmaskedDomain": false,
                    "currency": "USD",
                    "priceType": "gross",
                    "width": 1000,
                    "height": 300,
                    "sizes": [[1000, 250], [970, 250], [970, 210], [998, 200]]
                },
                "floor": 10,
                "factor": 21.29695663209996,
                "bfc": 1.3333333333333333,
                ...
                "chd": {
                    "tag": "stroeer-banner",
                    "flag": "PublisherStandard",
                    "keys": {"1": "de7a9e02-7fe6-44e1-b7ff-00b0870c1e95"},
                    "unmaskedDomain": false,
                    "currency": "EUR",
                    "priceType": "gross",
                    "width": 970,
                    "height": 310,
                    "sizes": [[970, 250], [970, 210], [960, 210], [800, 250], [998, 200], [970, 200], [770, 250], [750, 200], [1000, 100], [990, 100], [970, 100], [750, 100], [745, 100], [728, 90]]
                }, "floor": 10, "factor": 25.682000020884605, "factorFixed": 25.682000020884605, "styles": []
            }]
        }]
    }, "currencies": {"EUR": 25.682000020884605, "USD": 21.29695663209996, "CZK": 1}, "excludes": [], "cls": {
